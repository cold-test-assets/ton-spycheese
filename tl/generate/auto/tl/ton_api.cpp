...
#define FAIL(error) p.set_error(error); return nullptr;
  ...
  switch (constructor) {
    ...
    case adnl_address_reverse::ID:
      return adnl_address_reverse::fetch(p);
    ...
    case dht_requestReversePingCont::ID:
      return dht_requestReversePingCont::fetch(p);
    case dht_clientNotFound::ID:
      return dht_clientNotFound::fetch(p);
    case dht_reversePingOk::ID:
      return dht_reversePingOk::fetch(p);
    case dht_stored::ID:
    ...
    case dht_config_global_v2::ID:
      return dht_config_global_v2::fetch(p);
    ...
    case engine_validator_fullNodeConfig::ID:
      return engine_validator_fullNodeConfig::fetch(p);
    ...
    case engine_validator_onePerfTimerStat::ID:
      return engine_validator_onePerfTimerStat::fetch(p);
    case engine_validator_oneStat::ID:
      return engine_validator_oneStat::fetch(p);
    case engine_validator_overlayStats::ID:
      return engine_validator_overlayStats::fetch(p);
    case engine_validator_overlayStatsNode::ID:
      return engine_validator_overlayStatsNode::fetch(p);
    case engine_validator_overlaysStats::ID:
      return engine_validator_overlaysStats::fetch(p);
    case engine_validator_perfTimerStats::ID:
      return engine_validator_perfTimerStats::fetch(p);
    case engine_validator_perfTimerStatsByName::ID:
      return engine_validator_perfTimerStatsByName::fetch(p);
    case engine_validator_proposalVote::ID:
      return engine_validator_proposalVote::fetch(p);
    case engine_validator_shardOutQueueSize::ID:
      return engine_validator_shardOutQueueSize::fetch(p);
    ...
    case http_proxy_capabilities::ID:
      return http_proxy_capabilities::fetch(p);
    ...
    case overlay_certificateV2::ID:
      return overlay_certificateV2::fetch(p);
    ...
    case overlay_certificateIdV2::ID:
      return overlay_certificateIdV2::fetch(p);
    ...
    case storage_priorityAction_all::ID:
      return storage_priorityAction_all::fetch(p);
    case storage_priorityAction_idx::ID:
      return storage_priorityAction_idx::fetch(p);
    case storage_priorityAction_name::ID:
      return storage_priorityAction_name::fetch(p);
    case storage_state::ID:
      return storage_state::fetch(p);
    case storage_torrentInfo::ID:
      return storage_torrentInfo::fetch(p);
    ...
    case storage_daemon_contractInfo::ID:
      return storage_daemon_contractInfo::fetch(p);
    case storage_daemon_fileInfo::ID:
      return storage_daemon_fileInfo::fetch(p);
    case storage_daemon_filePiecesInfo::ID:
      return storage_daemon_filePiecesInfo::fetch(p);
    case storage_daemon_keyHash::ID:
      return storage_daemon_keyHash::fetch(p);
    case storage_daemon_newContractMessage::ID:
      return storage_daemon_newContractMessage::fetch(p);
    case storage_daemon_newContractParams::ID:
      return storage_daemon_newContractParams::fetch(p);
    case storage_daemon_newContractParamsAuto::ID:
      return storage_daemon_newContractParamsAuto::fetch(p);
    case storage_daemon_peer::ID:
      return storage_daemon_peer::fetch(p);
    case storage_daemon_peerList::ID:
      return storage_daemon_peerList::fetch(p);
    case storage_daemon_providerAddress::ID:
      return storage_daemon_providerAddress::fetch(p);
    case storage_daemon_providerConfig::ID:
      return storage_daemon_providerConfig::fetch(p);
    case storage_daemon_providerInfo::ID:
      return storage_daemon_providerInfo::fetch(p);
    case storage_daemon_queryError::ID:
      return storage_daemon_queryError::fetch(p);
    case storage_daemon_prioritySet::ID:
      return storage_daemon_prioritySet::fetch(p);
    case storage_daemon_priorityPending::ID:
      return storage_daemon_priorityPending::fetch(p);
    case storage_daemon_speedLimits::ID:
      return storage_daemon_speedLimits::fetch(p);
    case storage_daemon_success::ID:
      return storage_daemon_success::fetch(p);
    case storage_daemon_torrent::ID:
      return storage_daemon_torrent::fetch(p);
    case storage_daemon_torrentFull::ID:
      return storage_daemon_torrentFull::fetch(p);
    case storage_daemon_torrentList::ID:
      return storage_daemon_torrentList::fetch(p);
    case storage_daemon_torrentMeta::ID:
      return storage_daemon_torrentMeta::fetch(p);
    case storage_daemon_torrentPiecesInfo::ID:
      return storage_daemon_torrentPiecesInfo::fetch(p);
    case storage_daemon_config::ID:
      return storage_daemon_config::fetch(p);
    case storage_daemon_provider_params::ID:
      return storage_daemon_provider_params::fetch(p);
    case storage_db_config::ID:
      return storage_db_config::fetch(p);
    case storage_provider_db_contractAddress::ID:
      return storage_provider_db_contractAddress::fetch(p);
    case storage_provider_db_contractList::ID:
      return storage_provider_db_contractList::fetch(p);
    case storage_db_piecesInDb::ID:
      return storage_db_piecesInDb::fetch(p);
    case storage_db_priorities::ID:
      return storage_db_priorities::fetch(p);
    case storage_db_torrentList::ID:
      return storage_db_torrentList::fetch(p);
    case storage_db_torrent::ID:
      return storage_db_torrent::fetch(p);
    case storage_db_torrentV2::ID:
      return storage_db_torrentV2::fetch(p);
    case storage_db_key_config::ID:
      return storage_db_key_config::fetch(p);
    case storage_db_key_pieceInDb::ID:
      return storage_db_key_pieceInDb::fetch(p);
    case storage_db_key_piecesInDb::ID:
      return storage_db_key_piecesInDb::fetch(p);
    case storage_db_key_priorities::ID:
      return storage_db_key_priorities::fetch(p);
    case storage_db_key_torrentList::ID:
      return storage_db_key_torrentList::fetch(p);
    case storage_db_key_torrentMeta::ID:
      return storage_db_key_torrentMeta::fetch(p);
    case storage_db_key_torrent::ID:
      return storage_db_key_torrent::fetch(p);
    case storage_provider_db_microchunkTree::ID:
      return storage_provider_db_microchunkTree::fetch(p);
    case storage_provider_db_state::ID:
      return storage_provider_db_state::fetch(p);
    case storage_provider_db_storageContract::ID:
      return storage_provider_db_storageContract::fetch(p);
    case storage_provider_db_key_contractList::ID:
      return storage_provider_db_key_contractList::fetch(p);
    case storage_provider_db_key_microchunkTree::ID:
      return storage_provider_db_key_microchunkTree::fetch(p);
    case storage_provider_db_key_providerConfig::ID:
      return storage_provider_db_key_providerConfig::fetch(p);
    case storage_provider_db_key_state::ID:
      return storage_provider_db_key_state::fetch(p);
    case storage_provider_db_key_storageContract::ID:
      return storage_provider_db_key_storageContract::fetch(p);
    ...
    case tonNode_privateBlockOverlayId::ID:
      return tonNode_privateBlockOverlayId::fetch(p);
    ...
    case validatorSession_catchainOptions::ID:
      return validatorSession_catchainOptions::fetch(p);
    ...
    case validatorSession_configVersioned::ID:
      return validatorSession_configVersioned::fetch(p);
    case validatorSession_configVersionedV2::ID:
      return validatorSession_configVersionedV2::fetch(p);
    ...
    case validatorSession_stats::ID:
      return validatorSession_stats::fetch(p);
    case validatorSession_statsProducer::ID:
      return validatorSession_statsProducer::fetch(p);
    case validatorSession_statsRound::ID:
      return validatorSession_statsRound::fetch(p);
...
#define FAIL(error) p.set_error(error); return nullptr;
  ...
  switch (constructor) {
    ...
    case dht_registerReverseConnection::ID:
      return dht_registerReverseConnection::fetch(p);
    case dht_requestReversePing::ID:
      return dht_requestReversePing::fetch(p);
    case dht_store::ID:
    ...
    case engine_validator_getOverlaysStats::ID:
      return engine_validator_getOverlaysStats::fetch(p);
    case engine_validator_getPerfTimerStats::ID:
      return engine_validator_getPerfTimerStats::fetch(p);
    case engine_validator_getShardOutQueueSize::ID:
      return engine_validator_getShardOutQueueSize::fetch(p);
    ...
    case engine_validator_importCertificate::ID:
      return engine_validator_importCertificate::fetch(p);
    ...
    case engine_validator_importShardOverlayCertificate::ID:
      return engine_validator_importShardOverlayCertificate::fetch(p);
    case engine_validator_setExtMessagesBroadcastDisabled::ID:
      return engine_validator_setExtMessagesBroadcastDisabled::fetch(p);
    ...
    case engine_validator_signShardOverlayCertificate::ID:
      return engine_validator_signShardOverlayCertificate::fetch(p);
    ...
    case http_proxy_getCapabilities::ID:
      return http_proxy_getCapabilities::fetch(p);
    ...
    case storage_daemon_addByHash::ID:
      return storage_daemon_addByHash::fetch(p);
    case storage_daemon_addByMeta::ID:
      return storage_daemon_addByMeta::fetch(p);
    case storage_daemon_closeStorageContract::ID:
      return storage_daemon_closeStorageContract::fetch(p);
    case storage_daemon_createTorrent::ID:
      return storage_daemon_createTorrent::fetch(p);
    case storage_daemon_deployProvider::ID:
      return storage_daemon_deployProvider::fetch(p);
    case storage_daemon_getNewContractMessage::ID:
      return storage_daemon_getNewContractMessage::fetch(p);
    case storage_daemon_getProviderInfo::ID:
      return storage_daemon_getProviderInfo::fetch(p);
    case storage_daemon_getProviderParams::ID:
      return storage_daemon_getProviderParams::fetch(p);
    case storage_daemon_getSpeedLimits::ID:
      return storage_daemon_getSpeedLimits::fetch(p);
    case storage_daemon_getTorrentFull::ID:
      return storage_daemon_getTorrentFull::fetch(p);
    case storage_daemon_getTorrentMeta::ID:
      return storage_daemon_getTorrentMeta::fetch(p);
    case storage_daemon_getTorrentPeers::ID:
      return storage_daemon_getTorrentPeers::fetch(p);
    case storage_daemon_getTorrentPiecesInfo::ID:
      return storage_daemon_getTorrentPiecesInfo::fetch(p);
    case storage_daemon_getTorrents::ID:
      return storage_daemon_getTorrents::fetch(p);
    case storage_daemon_importPrivateKey::ID:
      return storage_daemon_importPrivateKey::fetch(p);
    case storage_daemon_initProvider::ID:
      return storage_daemon_initProvider::fetch(p);
    case storage_daemon_loadFrom::ID:
      return storage_daemon_loadFrom::fetch(p);
    case storage_daemon_removeStorageProvider::ID:
      return storage_daemon_removeStorageProvider::fetch(p);
    case storage_daemon_removeTorrent::ID:
      return storage_daemon_removeTorrent::fetch(p);
    case storage_daemon_sendCoins::ID:
      return storage_daemon_sendCoins::fetch(p);
    case storage_daemon_setActiveDownload::ID:
      return storage_daemon_setActiveDownload::fetch(p);
    case storage_daemon_setActiveUpload::ID:
      return storage_daemon_setActiveUpload::fetch(p);
    case storage_daemon_setFilePriorityAll::ID:
      return storage_daemon_setFilePriorityAll::fetch(p);
    case storage_daemon_setFilePriorityByIdx::ID:
      return storage_daemon_setFilePriorityByIdx::fetch(p);
    case storage_daemon_setFilePriorityByName::ID:
      return storage_daemon_setFilePriorityByName::fetch(p);
    case storage_daemon_setProviderConfig::ID:
      return storage_daemon_setProviderConfig::fetch(p);
    case storage_daemon_setProviderParams::ID:
      return storage_daemon_setProviderParams::fetch(p);
    case storage_daemon_setSpeedLimits::ID:
      return storage_daemon_setSpeedLimits::fetch(p);
    case storage_daemon_setVerbosity::ID:
      return storage_daemon_setVerbosity::fetch(p);
    case storage_daemon_withdraw::ID:
      return storage_daemon_withdraw::fetch(p);
    case storage_getPiece::ID:
      return storage_getPiece::fetch(p);
    case storage_getTorrentInfo::ID:
      return storage_getTorrentInfo::fetch(p);
...
adnl_address_reverse::adnl_address_reverse() {
}

const std::int32_t adnl_address_reverse::ID;

object_ptr<adnl_Address> adnl_address_reverse::fetch(td::TlParser &p) {
  return make_object<adnl_address_reverse>(p);
}

adnl_address_reverse::adnl_address_reverse(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void adnl_address_reverse::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void adnl_address_reverse::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void adnl_address_reverse::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "adnl_address_reverse");
    s.store_class_end();
  }
}
...
void config_global::store(td::TlStorerCalcLength &s) const {
  ...
  TlStoreBoxedUnknown<TlStoreObject>::store(dht_, s);
...
dht_requestReversePingCont::dht_requestReversePingCont()
  : target_()
  , signature_()
  , client_()
{}

dht_requestReversePingCont::dht_requestReversePingCont(object_ptr<adnl_node> &&target_, td::BufferSlice &&signature_, td::Bits256 const &client_)
  : target_(std::move(target_))
  , signature_(std::move(signature_))
  , client_(client_)
{}

const std::int32_t dht_requestReversePingCont::ID;

object_ptr<dht_requestReversePingCont> dht_requestReversePingCont::fetch(td::TlParser &p) {
  return make_object<dht_requestReversePingCont>(p);
}

dht_requestReversePingCont::dht_requestReversePingCont(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : target_(TlFetchBoxed<TlFetchObject<adnl_node>, 1800802949>::parse(p))
  , signature_(TlFetchBytes<td::BufferSlice>::parse(p))
  , client_(TlFetchInt256::parse(p))
#undef FAIL
{}

void dht_requestReversePingCont::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBoxed<TlStoreObject, 1800802949>::store(target_, s);
  TlStoreString::store(signature_, s);
  TlStoreBinary::store(client_, s);
}

void dht_requestReversePingCont::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBoxed<TlStoreObject, 1800802949>::store(target_, s);
  TlStoreString::store(signature_, s);
  TlStoreBinary::store(client_, s);
...
void dht_requestReversePingCont::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_requestReversePingCont");
    if (target_ == nullptr) { s.store_field("target", "null"); } else { target_->store(s, "target"); }
    s.store_bytes_field("signature", signature_);
    s.store_field("client", client_);
    s.store_class_end();
  }
}

object_ptr<dht_ReversePingResult> dht_ReversePingResult::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  int constructor = p.fetch_int();
  switch (constructor) {
    case dht_clientNotFound::ID:
...
dht_clientNotFound::dht_clientNotFound()
  : nodes_()
{}

dht_clientNotFound::dht_clientNotFound(object_ptr<dht_nodes> &&nodes_)
  : nodes_(std::move(nodes_))
{}

const std::int32_t dht_clientNotFound::ID;

object_ptr<dht_ReversePingResult> dht_clientNotFound::fetch(td::TlParser &p) {
  return make_object<dht_clientNotFound>(p);
}

dht_clientNotFound::dht_clientNotFound(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : nodes_(TlFetchObject<dht_nodes>::parse(p))
#undef FAIL
{}

void dht_clientNotFound::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(nodes_, s);
}

void dht_clientNotFound::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(nodes_, s);
}

void dht_clientNotFound::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_clientNotFound");
    if (nodes_ == nullptr) { s.store_field("nodes", "null"); } else { nodes_->store(s, "nodes"); }
    s.store_class_end();
  }
}

dht_reversePingOk::dht_reversePingOk() {
}

const std::int32_t dht_reversePingOk::ID;

object_ptr<dht_ReversePingResult> dht_reversePingOk::fetch(td::TlParser &p) {
  return make_object<dht_reversePingOk>(p);
}

dht_reversePingOk::dht_reversePingOk(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void dht_reversePingOk::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void dht_reversePingOk::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void dht_reversePingOk::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_reversePingOk");
    s.store_class_end();
  }
}
...
dht_config_global_v2::dht_config_global_v2()
  : static_nodes_()
  , k_()
  , a_()
  , network_id_()
...
dht_config_global_v2::dht_config_global_v2(object_ptr<dht_nodes> &&static_nodes_, std::int32_t k_, std::int32_t a_, std::int32_t network_id_)
  : static_nodes_(std::move(static_nodes_))
  , k_(k_)
  , a_(a_)
...
const std::int32_t dht_config_global_v2::ID;

object_ptr<dht_config_Global> dht_config_global_v2::fetch(td::TlParser &p) {
  return make_object<dht_config_global_v2>(p);
}

dht_config_global_v2::dht_config_global_v2(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : static_nodes_(TlFetchObject<dht_nodes>::parse(p))
  , k_(TlFetchInt::parse(p))
  , a_(TlFetchInt::parse(p))
  , network_id_(TlFetchInt::parse(p))
#undef FAIL
{}

void dht_config_global_v2::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(static_nodes_, s);
  TlStoreBinary::store(k_, s);
  TlStoreBinary::store(a_, s);
  TlStoreBinary::store(network_id_, s);
}

void dht_config_global_v2::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(static_nodes_, s);
  TlStoreBinary::store(k_, s);
  TlStoreBinary::store(a_, s);
...
void dht_config_global_v2::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_config_global_v2");
    if (static_nodes_ == nullptr) { s.store_field("static_nodes", "null"); } else { static_nodes_->store(s, "static_nodes"); }
    s.store_field("k", k_);
    s.store_field("a", a_);
    s.store_field("network_id", network_id_);
    s.store_class_end();
  }
}
...
engine_validator_config::engine_validator_config(std::int32_t out_port_, std::vector<object_ptr<engine_Addr>> &&addrs_, std::vector<object_ptr<engine_adnl>> &&adnl_, std::vector<object_ptr<engine_dht>> &&dht_, std::vector<object_ptr<engine_validator>> &&validators_, td::Bits256 const &fullnode_, std::vector<object_ptr<engine_validator_fullNodeSlave>> &&fullnodeslaves_, std::vector<object_ptr<engine_validator_fullNodeMaster>> &&fullnodemasters_, object_ptr<engine_validator_fullNodeConfig> &&fullnodeconfig_, std::vector<object_ptr<engine_liteServer>> &&liteservers_, std::vector<object_ptr<engine_controlInterface>> &&control_, object_ptr<engine_gc> &&gc_)
  ...
  , fullnodeconfig_(std::move(fullnodeconfig_))
  , liteservers_(std::move(liteservers_))
  , control_(std::move(control_))
  , gc_(std::move(gc_))
{}
...
#define FAIL(error) p.set_error(error)
  ...
  , fullnodeconfig_(TlFetchObject<engine_validator_fullNodeConfig>::parse(p))
...
void engine_validator_config::store(td::TlStorerCalcLength &s) const {
  ...
  TlStoreObject::store(fullnodeconfig_, s);
...
void engine_validator_config::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    ...
    if (fullnodeconfig_ == nullptr) { s.store_field("fullnodeconfig", "null"); } else { fullnodeconfig_->store(s, "fullnodeconfig"); }
...
engine_validator_fullNodeConfig::engine_validator_fullNodeConfig()
  : ext_messages_broadcast_disabled_()
{}

engine_validator_fullNodeConfig::engine_validator_fullNodeConfig(bool ext_messages_broadcast_disabled_)
  : ext_messages_broadcast_disabled_(ext_messages_broadcast_disabled_)
{}

const std::int32_t engine_validator_fullNodeConfig::ID;

object_ptr<engine_validator_fullNodeConfig> engine_validator_fullNodeConfig::fetch(td::TlParser &p) {
  return make_object<engine_validator_fullNodeConfig>(p);
}

engine_validator_fullNodeConfig::engine_validator_fullNodeConfig(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : ext_messages_broadcast_disabled_(TlFetchBool::parse(p))
#undef FAIL
{}

void engine_validator_fullNodeConfig::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBool::store(ext_messages_broadcast_disabled_, s);
}

void engine_validator_fullNodeConfig::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBool::store(ext_messages_broadcast_disabled_, s);
}

void engine_validator_fullNodeConfig::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_fullNodeConfig");
    s.store_field("ext_messages_broadcast_disabled", ext_messages_broadcast_disabled_);
    s.store_class_end();
  }
}
...
engine_validator_onePerfTimerStat::engine_validator_onePerfTimerStat()
  : time_()
  , min_()
  , avg_()
  , max_()
...
engine_validator_onePerfTimerStat::engine_validator_onePerfTimerStat(std::int32_t time_, double min_, double avg_, double max_)
  : time_(time_)
  , min_(min_)
  , avg_(avg_)
  , max_(max_)
...
const std::int32_t engine_validator_onePerfTimerStat::ID;

object_ptr<engine_validator_onePerfTimerStat> engine_validator_onePerfTimerStat::fetch(td::TlParser &p) {
  return make_object<engine_validator_onePerfTimerStat>(p);
}

engine_validator_onePerfTimerStat::engine_validator_onePerfTimerStat(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : time_(TlFetchInt::parse(p))
  , min_(TlFetchDouble::parse(p))
  , avg_(TlFetchDouble::parse(p))
  , max_(TlFetchDouble::parse(p))
#undef FAIL
{}

void engine_validator_onePerfTimerStat::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(time_, s);
  TlStoreBinary::store(min_, s);
  TlStoreBinary::store(avg_, s);
  TlStoreBinary::store(max_, s);
}

void engine_validator_onePerfTimerStat::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(time_, s);
  TlStoreBinary::store(min_, s);
  TlStoreBinary::store(avg_, s);
...
void engine_validator_onePerfTimerStat::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_onePerfTimerStat");
    s.store_field("time", time_);
    s.store_field("min", min_);
    s.store_field("avg", avg_);
    s.store_field("max", max_);
    s.store_class_end();
  }
}
...
engine_validator_overlayStats::engine_validator_overlayStats()
  : overlay_id_()
  , overlay_id_full_()
  , adnl_id_()
  , scope_()
...
engine_validator_overlayStats::engine_validator_overlayStats(td::Bits256 const &overlay_id_, object_ptr<PublicKey> &&overlay_id_full_, td::Bits256 const &adnl_id_, std::string const &scope_, std::vector<object_ptr<engine_validator_overlayStatsNode>> &&nodes_, std::vector<object_ptr<engine_validator_oneStat>> &&stats_)
  : overlay_id_(overlay_id_)
  , overlay_id_full_(std::move(overlay_id_full_))
  , adnl_id_(adnl_id_)
...
const std::int32_t engine_validator_overlayStats::ID;

object_ptr<engine_validator_overlayStats> engine_validator_overlayStats::fetch(td::TlParser &p) {
  return make_object<engine_validator_overlayStats>(p);
}

engine_validator_overlayStats::engine_validator_overlayStats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : overlay_id_(TlFetchInt256::parse(p))
  , overlay_id_full_(TlFetchObject<PublicKey>::parse(p))
  , adnl_id_(TlFetchInt256::parse(p))
  , scope_(TlFetchString<std::string>::parse(p))
  , nodes_(TlFetchVector<TlFetchObject<engine_validator_overlayStatsNode>>::parse(p))
  , stats_(TlFetchVector<TlFetchObject<engine_validator_oneStat>>::parse(p))
#undef FAIL
{}

void engine_validator_overlayStats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(overlay_id_full_, s);
...
void engine_validator_overlayStats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(overlay_id_full_, s);
  TlStoreBinary::store(adnl_id_, s);
...
void engine_validator_overlayStats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_overlayStats");
    s.store_field("overlay_id", overlay_id_);
    if (overlay_id_full_ == nullptr) { s.store_field("overlay_id_full", "null"); } else { overlay_id_full_->store(s, "overlay_id_full"); }
    s.store_field("adnl_id", adnl_id_);
    s.store_field("scope", scope_);
    { const std::vector<object_ptr<engine_validator_overlayStatsNode>> &v = nodes_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("nodes", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
...
engine_validator_overlayStatsNode::engine_validator_overlayStatsNode()
  : adnl_id_()
  , ip_addr_()
  , bdcst_errors_()
  , fec_bdcst_errors_()
...
engine_validator_overlayStatsNode::engine_validator_overlayStatsNode(td::Bits256 const &adnl_id_, std::string const &ip_addr_, std::int32_t bdcst_errors_, std::int32_t fec_bdcst_errors_, std::int32_t last_in_query_, std::int32_t last_out_query_, std::int32_t t_out_bytes_, std::int32_t t_in_bytes_, std::int32_t t_out_pckts_, std::int32_t t_in_pckts_)
  : adnl_id_(adnl_id_)
  , ip_addr_(std::move(ip_addr_))
  , bdcst_errors_(bdcst_errors_)
  , fec_bdcst_errors_(fec_bdcst_errors_)
  , last_in_query_(last_in_query_)
  , last_out_query_(last_out_query_)
  , t_out_bytes_(t_out_bytes_)
  , t_in_bytes_(t_in_bytes_)
  , t_out_pckts_(t_out_pckts_)
  , t_in_pckts_(t_in_pckts_)
{}

const std::int32_t engine_validator_overlayStatsNode::ID;

object_ptr<engine_validator_overlayStatsNode> engine_validator_overlayStatsNode::fetch(td::TlParser &p) {
  return make_object<engine_validator_overlayStatsNode>(p);
}

engine_validator_overlayStatsNode::engine_validator_overlayStatsNode(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : adnl_id_(TlFetchInt256::parse(p))
  , ip_addr_(TlFetchString<std::string>::parse(p))
  , bdcst_errors_(TlFetchInt::parse(p))
  , fec_bdcst_errors_(TlFetchInt::parse(p))
  , last_in_query_(TlFetchInt::parse(p))
  , last_out_query_(TlFetchInt::parse(p))
  , t_out_bytes_(TlFetchInt::parse(p))
  , t_in_bytes_(TlFetchInt::parse(p))
  , t_out_pckts_(TlFetchInt::parse(p))
  , t_in_pckts_(TlFetchInt::parse(p))
#undef FAIL
{}

void engine_validator_overlayStatsNode::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(adnl_id_, s);
  TlStoreString::store(ip_addr_, s);
  TlStoreBinary::store(bdcst_errors_, s);
  TlStoreBinary::store(fec_bdcst_errors_, s);
  TlStoreBinary::store(last_in_query_, s);
  TlStoreBinary::store(last_out_query_, s);
  TlStoreBinary::store(t_out_bytes_, s);
  TlStoreBinary::store(t_in_bytes_, s);
  TlStoreBinary::store(t_out_pckts_, s);
  TlStoreBinary::store(t_in_pckts_, s);
}

void engine_validator_overlayStatsNode::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(adnl_id_, s);
  TlStoreString::store(ip_addr_, s);
  TlStoreBinary::store(bdcst_errors_, s);
...
void engine_validator_overlayStatsNode::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_overlayStatsNode");
    s.store_field("adnl_id", adnl_id_);
    s.store_field("ip_addr", ip_addr_);
    s.store_field("bdcst_errors", bdcst_errors_);
    s.store_field("fec_bdcst_errors", fec_bdcst_errors_);
    s.store_field("last_in_query", last_in_query_);
    s.store_field("last_out_query", last_out_query_);
    s.store_field("t_out_bytes", t_out_bytes_);
    s.store_field("t_in_bytes", t_in_bytes_);
    s.store_field("t_out_pckts", t_out_pckts_);
    s.store_field("t_in_pckts", t_in_pckts_);
    s.store_class_end();
  }
}

engine_validator_overlaysStats::engine_validator_overlaysStats()
  : overlays_()
{}

engine_validator_overlaysStats::engine_validator_overlaysStats(std::vector<object_ptr<engine_validator_overlayStats>> &&overlays_)
  : overlays_(std::move(overlays_))
{}

const std::int32_t engine_validator_overlaysStats::ID;

object_ptr<engine_validator_overlaysStats> engine_validator_overlaysStats::fetch(td::TlParser &p) {
  return make_object<engine_validator_overlaysStats>(p);
}

engine_validator_overlaysStats::engine_validator_overlaysStats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : overlays_(TlFetchVector<TlFetchObject<engine_validator_overlayStats>>::parse(p))
#undef FAIL
{}

void engine_validator_overlaysStats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(overlays_, s);
}

void engine_validator_overlaysStats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(overlays_, s);
}

void engine_validator_overlaysStats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_overlaysStats");
    { const std::vector<object_ptr<engine_validator_overlayStats>> &v = overlays_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("overlays", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

engine_validator_perfTimerStats::engine_validator_perfTimerStats()
  : stats_()
{}

engine_validator_perfTimerStats::engine_validator_perfTimerStats(std::vector<object_ptr<engine_validator_perfTimerStatsByName>> &&stats_)
  : stats_(std::move(stats_))
{}

const std::int32_t engine_validator_perfTimerStats::ID;

object_ptr<engine_validator_perfTimerStats> engine_validator_perfTimerStats::fetch(td::TlParser &p) {
  return make_object<engine_validator_perfTimerStats>(p);
}

engine_validator_perfTimerStats::engine_validator_perfTimerStats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : stats_(TlFetchVector<TlFetchBoxed<TlFetchObject<engine_validator_perfTimerStatsByName>, -2101686812>>::parse(p))
#undef FAIL
{}

void engine_validator_perfTimerStats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBoxed<TlStoreObject, -2101686812>>::store(stats_, s);
}

void engine_validator_perfTimerStats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBoxed<TlStoreObject, -2101686812>>::store(stats_, s);
}

void engine_validator_perfTimerStats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_perfTimerStats");
    { const std::vector<object_ptr<engine_validator_perfTimerStatsByName>> &v = stats_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("stats", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

engine_validator_perfTimerStatsByName::engine_validator_perfTimerStatsByName()
  : name_()
  , stats_()
{}

engine_validator_perfTimerStatsByName::engine_validator_perfTimerStatsByName(std::string const &name_, std::vector<object_ptr<engine_validator_onePerfTimerStat>> &&stats_)
  : name_(std::move(name_))
  , stats_(std::move(stats_))
{}

const std::int32_t engine_validator_perfTimerStatsByName::ID;

object_ptr<engine_validator_perfTimerStatsByName> engine_validator_perfTimerStatsByName::fetch(td::TlParser &p) {
  return make_object<engine_validator_perfTimerStatsByName>(p);
}

engine_validator_perfTimerStatsByName::engine_validator_perfTimerStatsByName(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : name_(TlFetchString<std::string>::parse(p))
  , stats_(TlFetchVector<TlFetchBoxed<TlFetchObject<engine_validator_onePerfTimerStat>, -1859935384>>::parse(p))
#undef FAIL
{}

void engine_validator_perfTimerStatsByName::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreVector<TlStoreBoxed<TlStoreObject, -1859935384>>::store(stats_, s);
}

void engine_validator_perfTimerStatsByName::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreVector<TlStoreBoxed<TlStoreObject, -1859935384>>::store(stats_, s);
}

void engine_validator_perfTimerStatsByName::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_perfTimerStatsByName");
    s.store_field("name", name_);
    { const std::vector<object_ptr<engine_validator_onePerfTimerStat>> &v = stats_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("stats", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}
...
engine_validator_shardOutQueueSize::engine_validator_shardOutQueueSize()
  : size_()
{}

engine_validator_shardOutQueueSize::engine_validator_shardOutQueueSize(std::int32_t size_)
  : size_(size_)
{}

const std::int32_t engine_validator_shardOutQueueSize::ID;

object_ptr<engine_validator_shardOutQueueSize> engine_validator_shardOutQueueSize::fetch(td::TlParser &p) {
  return make_object<engine_validator_shardOutQueueSize>(p);
}

engine_validator_shardOutQueueSize::engine_validator_shardOutQueueSize(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : size_(TlFetchInt::parse(p))
#undef FAIL
{}

void engine_validator_shardOutQueueSize::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(size_, s);
}

void engine_validator_shardOutQueueSize::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(size_, s);
}

void engine_validator_shardOutQueueSize::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_shardOutQueueSize");
...
http_response::http_response(std::string const &http_version_, std::int32_t status_code_, std::string const &reason_, std::vector<object_ptr<http_header>> &&headers_, bool no_payload_)
  : http_version_(std::move(http_version_))
  , status_code_(status_code_)
  , reason_(std::move(reason_))
  , headers_(std::move(headers_))
  , no_payload_(no_payload_)
{}
...
#define FAIL(error) p.set_error(error)
  ...
  , no_payload_(TlFetchBool::parse(p))
#undef FAIL
{}
...
void http_response::store(td::TlStorerCalcLength &s) const {
  ...
  TlStoreBool::store(no_payload_, s);
}
...
void http_response::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    ...
    s.store_field("no_payload", no_payload_);
    s.store_class_end();
  }
}

http_proxy_capabilities::http_proxy_capabilities()
  : capabilities_()
{}

http_proxy_capabilities::http_proxy_capabilities(std::int64_t capabilities_)
  : capabilities_(capabilities_)
{}

const std::int32_t http_proxy_capabilities::ID;

object_ptr<http_proxy_capabilities> http_proxy_capabilities::fetch(td::TlParser &p) {
  return make_object<http_proxy_capabilities>(p);
}

http_proxy_capabilities::http_proxy_capabilities(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : capabilities_(TlFetchLong::parse(p))
#undef FAIL
{}

void http_proxy_capabilities::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(capabilities_, s);
}

void http_proxy_capabilities::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(capabilities_, s);
}

void http_proxy_capabilities::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "http_proxy_capabilities");
...
overlay_certificateV2::overlay_certificateV2()
  : issued_by_()
  , expire_at_()
  , max_size_()
  , flags_()
...
overlay_certificateV2::overlay_certificateV2(object_ptr<PublicKey> &&issued_by_, std::int32_t expire_at_, std::int32_t max_size_, std::int32_t flags_, td::BufferSlice &&signature_)
  : issued_by_(std::move(issued_by_))
  , expire_at_(expire_at_)
  , max_size_(max_size_)
  , flags_(flags_)
...
const std::int32_t overlay_certificateV2::ID;

object_ptr<overlay_Certificate> overlay_certificateV2::fetch(td::TlParser &p) {
  return make_object<overlay_certificateV2>(p);
}

overlay_certificateV2::overlay_certificateV2(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : issued_by_(TlFetchObject<PublicKey>::parse(p))
  , expire_at_(TlFetchInt::parse(p))
  , max_size_(TlFetchInt::parse(p))
...
void overlay_certificateV2::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBoxedUnknown<TlStoreObject>::store(issued_by_, s);
  TlStoreBinary::store(expire_at_, s);
  TlStoreBinary::store(max_size_, s);
...
void overlay_certificateV2::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBoxedUnknown<TlStoreObject>::store(issued_by_, s);
  TlStoreBinary::store(expire_at_, s);
  TlStoreBinary::store(max_size_, s);
...
void overlay_certificateV2::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "overlay_certificateV2");
    if (issued_by_ == nullptr) { s.store_field("issued_by", "null"); } else { issued_by_->store(s, "issued_by"); }
    s.store_field("expire_at", expire_at_);
    s.store_field("max_size", max_size_);
    s.store_field("flags", flags_);
...
overlay_certificateIdV2::overlay_certificateIdV2()
  : overlay_id_()
  , node_()
  , expire_at_()
  , max_size_()
...
overlay_certificateIdV2::overlay_certificateIdV2(td::Bits256 const &overlay_id_, td::Bits256 const &node_, std::int32_t expire_at_, std::int32_t max_size_, std::int32_t flags_)
  : overlay_id_(overlay_id_)
  , node_(node_)
  , expire_at_(expire_at_)
  , max_size_(max_size_)
...
const std::int32_t overlay_certificateIdV2::ID;

object_ptr<overlay_CertificateId> overlay_certificateIdV2::fetch(td::TlParser &p) {
  return make_object<overlay_certificateIdV2>(p);
}

overlay_certificateIdV2::overlay_certificateIdV2(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : overlay_id_(TlFetchInt256::parse(p))
  , node_(TlFetchInt256::parse(p))
  , expire_at_(TlFetchInt::parse(p))
...
void overlay_certificateIdV2::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreBinary::store(node_, s);
  TlStoreBinary::store(expire_at_, s);
...
void overlay_certificateIdV2::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreBinary::store(node_, s);
  TlStoreBinary::store(expire_at_, s);
...
void overlay_certificateIdV2::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "overlay_certificateIdV2");
    s.store_field("overlay_id", overlay_id_);
    s.store_field("node", node_);
    s.store_field("expire_at", expire_at_);
    s.store_field("max_size", max_size_);
...
object_ptr<storage_PriorityAction> storage_PriorityAction::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  int constructor = p.fetch_int();
  switch (constructor) {
    case storage_priorityAction_all::ID:
...
storage_priorityAction_all::storage_priorityAction_all()
  : priority_()
{}

storage_priorityAction_all::storage_priorityAction_all(std::int32_t priority_)
  : priority_(priority_)
{}

const std::int32_t storage_priorityAction_all::ID;

object_ptr<storage_PriorityAction> storage_priorityAction_all::fetch(td::TlParser &p) {
  return make_object<storage_priorityAction_all>(p);
}

storage_priorityAction_all::storage_priorityAction_all(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : priority_(TlFetchInt::parse(p))
#undef FAIL
{}

void storage_priorityAction_all::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_all::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_all::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_priorityAction_all");
    s.store_field("priority", priority_);
    s.store_class_end();
  }
}

storage_priorityAction_idx::storage_priorityAction_idx()
  : idx_()
  , priority_()
{}

storage_priorityAction_idx::storage_priorityAction_idx(std::int64_t idx_, std::int32_t priority_)
  : idx_(idx_)
  , priority_(priority_)
{}

const std::int32_t storage_priorityAction_idx::ID;

object_ptr<storage_PriorityAction> storage_priorityAction_idx::fetch(td::TlParser &p) {
  return make_object<storage_priorityAction_idx>(p);
}

storage_priorityAction_idx::storage_priorityAction_idx(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : idx_(TlFetchLong::parse(p))
  , priority_(TlFetchInt::parse(p))
#undef FAIL
{}

void storage_priorityAction_idx::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(idx_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_idx::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(idx_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_idx::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_priorityAction_idx");
    s.store_field("idx", idx_);
    s.store_field("priority", priority_);
    s.store_class_end();
  }
...
storage_priorityAction_name::storage_priorityAction_name()
  : name_()
  , priority_()
{}

storage_priorityAction_name::storage_priorityAction_name(std::string const &name_, std::int32_t priority_)
  : name_(std::move(name_))
  , priority_(priority_)
{}

const std::int32_t storage_priorityAction_name::ID;

object_ptr<storage_PriorityAction> storage_priorityAction_name::fetch(td::TlParser &p) {
  return make_object<storage_priorityAction_name>(p);
}

storage_priorityAction_name::storage_priorityAction_name(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : name_(TlFetchString<std::string>::parse(p))
  , priority_(TlFetchInt::parse(p))
#undef FAIL
...
void storage_priorityAction_name::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_name::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_priorityAction_name::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_priorityAction_name");
    s.store_field("name", name_);
    s.store_field("priority", priority_);
    s.store_class_end();
  }
...
storage_torrentInfo::storage_torrentInfo()
  : data_()
{}

storage_torrentInfo::storage_torrentInfo(td::BufferSlice &&data_)
  : data_(std::move(data_))
{}

const std::int32_t storage_torrentInfo::ID;

object_ptr<storage_torrentInfo> storage_torrentInfo::fetch(td::TlParser &p) {
  return make_object<storage_torrentInfo>(p);
}

storage_torrentInfo::storage_torrentInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : data_(TlFetchBytes<td::BufferSlice>::parse(p))
#undef FAIL
{}

void storage_torrentInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(data_, s);
}

void storage_torrentInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(data_, s);
}

void storage_torrentInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_torrentInfo");
    s.store_bytes_field("data", data_);
    s.store_class_end();
  }
}
...
storage_updateInit::storage_updateInit(td::BufferSlice &&have_pieces_, std::int32_t have_pieces_offset_, object_ptr<storage_state> &&state_)
  : have_pieces_(std::move(have_pieces_))
  , have_pieces_offset_(have_pieces_offset_)
...
#define FAIL(error) p.set_error(error)
  ...
  , have_pieces_offset_(TlFetchInt::parse(p))
...
void storage_updateInit::store(td::TlStorerCalcLength &s) const {
  ...
  TlStoreBinary::store(have_pieces_offset_, s);
...
void storage_updateInit::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    ...
    s.store_field("have_pieces_offset", have_pieces_offset_);
...
storage_daemon_contractInfo::storage_daemon_contractInfo()
  : address_()
  , state_()
  , torrent_()
  , created_time_()
...
storage_daemon_contractInfo::storage_daemon_contractInfo(std::string const &address_, std::int32_t state_, td::Bits256 const &torrent_, std::int32_t created_time_, std::int64_t file_size_, std::int64_t downloaded_size_, std::string const &rate_, std::int32_t max_span_, std::string const &client_balance_, std::string const &contract_balance_)
  : address_(std::move(address_))
  , state_(state_)
  , torrent_(torrent_)
  ...
  , rate_(std::move(rate_))
  , max_span_(max_span_)
  , client_balance_(std::move(client_balance_))
  , contract_balance_(std::move(contract_balance_))
{}

const std::int32_t storage_daemon_contractInfo::ID;

object_ptr<storage_daemon_contractInfo> storage_daemon_contractInfo::fetch(td::TlParser &p) {
  return make_object<storage_daemon_contractInfo>(p);
}

storage_daemon_contractInfo::storage_daemon_contractInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
  , state_(TlFetchInt::parse(p))
  , torrent_(TlFetchInt256::parse(p))
  , created_time_(TlFetchInt::parse(p))
  , file_size_(TlFetchLong::parse(p))
  , downloaded_size_(TlFetchLong::parse(p))
  , rate_(TlFetchString<std::string>::parse(p))
  , max_span_(TlFetchInt::parse(p))
  , client_balance_(TlFetchString<std::string>::parse(p))
  , contract_balance_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_contractInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
  TlStoreBinary::store(state_, s);
  TlStoreBinary::store(torrent_, s);
  TlStoreBinary::store(created_time_, s);
  TlStoreBinary::store(file_size_, s);
  TlStoreBinary::store(downloaded_size_, s);
  TlStoreString::store(rate_, s);
  TlStoreBinary::store(max_span_, s);
  TlStoreString::store(client_balance_, s);
  TlStoreString::store(contract_balance_, s);
}

void storage_daemon_contractInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
  TlStoreBinary::store(state_, s);
  TlStoreBinary::store(torrent_, s);
...
void storage_daemon_contractInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_contractInfo");
    s.store_field("address", address_);
    s.store_field("state", state_);
    s.store_field("torrent", torrent_);
    s.store_field("created_time", created_time_);
    s.store_field("file_size", file_size_);
    s.store_field("downloaded_size", downloaded_size_);
    s.store_field("rate", rate_);
    s.store_field("max_span", max_span_);
    s.store_field("client_balance", client_balance_);
    s.store_field("contract_balance", contract_balance_);
    s.store_class_end();
  }
}

storage_daemon_fileInfo::storage_daemon_fileInfo()
  : name_()
  , size_()
  , flags_()
  , priority_()
...
storage_daemon_fileInfo::storage_daemon_fileInfo(std::string const &name_, std::int64_t size_, std::int32_t flags_, std::int32_t priority_, std::int64_t downloaded_size_)
  : name_(std::move(name_))
  , size_(size_)
  , flags_(flags_)
  , priority_(priority_)
...
const std::int32_t storage_daemon_fileInfo::ID;

object_ptr<storage_daemon_fileInfo> storage_daemon_fileInfo::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_fileInfo> res = make_object<storage_daemon_fileInfo>();
  std::int32_t var0;
  res->name_ = TlFetchString<std::string>::parse(p);
  res->size_ = TlFetchLong::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->priority_ = TlFetchInt::parse(p);
  res->downloaded_size_ = TlFetchLong::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_daemon_fileInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreString::store(name_, s);
  TlStoreBinary::store(size_, s);
...
void storage_daemon_fileInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreString::store(name_, s);
  TlStoreBinary::store(size_, s);
...
void storage_daemon_fileInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_fileInfo");
  std::int32_t var0;
    s.store_field("name", name_);
    s.store_field("size", size_);
    s.store_field("flags", (var0 = flags_));
...
storage_daemon_filePiecesInfo::storage_daemon_filePiecesInfo()
  : name_()
  , range_l_()
  , range_r_()
{}

storage_daemon_filePiecesInfo::storage_daemon_filePiecesInfo(std::string const &name_, std::int64_t range_l_, std::int64_t range_r_)
  : name_(std::move(name_))
  , range_l_(range_l_)
  , range_r_(range_r_)
{}

const std::int32_t storage_daemon_filePiecesInfo::ID;

object_ptr<storage_daemon_filePiecesInfo> storage_daemon_filePiecesInfo::fetch(td::TlParser &p) {
  return make_object<storage_daemon_filePiecesInfo>(p);
}

storage_daemon_filePiecesInfo::storage_daemon_filePiecesInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : name_(TlFetchString<std::string>::parse(p))
  , range_l_(TlFetchLong::parse(p))
  , range_r_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_daemon_filePiecesInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreBinary::store(range_l_, s);
  TlStoreBinary::store(range_r_, s);
}

void storage_daemon_filePiecesInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(name_, s);
  TlStoreBinary::store(range_l_, s);
  TlStoreBinary::store(range_r_, s);
...
void storage_daemon_filePiecesInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_filePiecesInfo");
    s.store_field("name", name_);
    s.store_field("range_l", range_l_);
    s.store_field("range_r", range_r_);
    s.store_class_end();
  }
}

storage_daemon_keyHash::storage_daemon_keyHash()
  : key_hash_()
{}

storage_daemon_keyHash::storage_daemon_keyHash(td::Bits256 const &key_hash_)
  : key_hash_(key_hash_)
{}

const std::int32_t storage_daemon_keyHash::ID;

object_ptr<storage_daemon_keyHash> storage_daemon_keyHash::fetch(td::TlParser &p) {
  return make_object<storage_daemon_keyHash>(p);
}

storage_daemon_keyHash::storage_daemon_keyHash(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : key_hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_daemon_keyHash::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(key_hash_, s);
}

void storage_daemon_keyHash::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(key_hash_, s);
}

void storage_daemon_keyHash::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_keyHash");
    s.store_field("key_hash", key_hash_);
    s.store_class_end();
  }
}

storage_daemon_newContractMessage::storage_daemon_newContractMessage()
  : body_()
  , rate_()
  , max_span_()
{}

storage_daemon_newContractMessage::storage_daemon_newContractMessage(td::BufferSlice &&body_, std::string const &rate_, std::int32_t max_span_)
  : body_(std::move(body_))
  , rate_(std::move(rate_))
  , max_span_(max_span_)
{}

const std::int32_t storage_daemon_newContractMessage::ID;

object_ptr<storage_daemon_newContractMessage> storage_daemon_newContractMessage::fetch(td::TlParser &p) {
  return make_object<storage_daemon_newContractMessage>(p);
}

storage_daemon_newContractMessage::storage_daemon_newContractMessage(td::TlParser &p)
#define FAIL(error) p.set_error(error)
...
void storage_daemon_newContractMessage::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
...
void storage_daemon_newContractMessage::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(body_, s);
  TlStoreString::store(rate_, s);
  TlStoreBinary::store(max_span_, s);
...
void storage_daemon_newContractMessage::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_newContractMessage");
...
object_ptr<storage_daemon_NewContractParams> storage_daemon_NewContractParams::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  int constructor = p.fetch_int();
  switch (constructor) {
    case storage_daemon_newContractParams::ID:
...
storage_daemon_newContractParams::storage_daemon_newContractParams()
  : rate_()
  , max_span_()
{}

storage_daemon_newContractParams::storage_daemon_newContractParams(std::string const &rate_, std::int32_t max_span_)
  : rate_(std::move(rate_))
  , max_span_(max_span_)
{}

const std::int32_t storage_daemon_newContractParams::ID;

object_ptr<storage_daemon_NewContractParams> storage_daemon_newContractParams::fetch(td::TlParser &p) {
  return make_object<storage_daemon_newContractParams>(p);
}

storage_daemon_newContractParams::storage_daemon_newContractParams(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : rate_(TlFetchString<std::string>::parse(p))
  , max_span_(TlFetchInt::parse(p))
#undef FAIL
...
void storage_daemon_newContractParams::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(rate_, s);
  TlStoreBinary::store(max_span_, s);
}

void storage_daemon_newContractParams::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(rate_, s);
  TlStoreBinary::store(max_span_, s);
}

void storage_daemon_newContractParams::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_newContractParams");
    s.store_field("rate", rate_);
    s.store_field("max_span", max_span_);
    s.store_class_end();
  }
...
storage_daemon_newContractParamsAuto::storage_daemon_newContractParamsAuto()
  : provider_address_()
{}

storage_daemon_newContractParamsAuto::storage_daemon_newContractParamsAuto(std::string const &provider_address_)
  : provider_address_(std::move(provider_address_))
{}

const std::int32_t storage_daemon_newContractParamsAuto::ID;

object_ptr<storage_daemon_NewContractParams> storage_daemon_newContractParamsAuto::fetch(td::TlParser &p) {
  return make_object<storage_daemon_newContractParamsAuto>(p);
}

storage_daemon_newContractParamsAuto::storage_daemon_newContractParamsAuto(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : provider_address_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_newContractParamsAuto::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(provider_address_, s);
}

void storage_daemon_newContractParamsAuto::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(provider_address_, s);
}

void storage_daemon_newContractParamsAuto::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_newContractParamsAuto");
    s.store_field("provider_address", provider_address_);
    s.store_class_end();
  }
}

storage_daemon_peer::storage_daemon_peer()
  : adnl_id_()
  , ip_str_()
  , download_speed_()
  , upload_speed_()
...
storage_daemon_peer::storage_daemon_peer(td::Bits256 const &adnl_id_, std::string const &ip_str_, double download_speed_, double upload_speed_, std::int64_t ready_parts_)
  : adnl_id_(adnl_id_)
  , ip_str_(std::move(ip_str_))
  , download_speed_(download_speed_)
  , upload_speed_(upload_speed_)
  , ready_parts_(ready_parts_)
{}

const std::int32_t storage_daemon_peer::ID;

object_ptr<storage_daemon_peer> storage_daemon_peer::fetch(td::TlParser &p) {
  return make_object<storage_daemon_peer>(p);
}

storage_daemon_peer::storage_daemon_peer(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : adnl_id_(TlFetchInt256::parse(p))
  , ip_str_(TlFetchString<std::string>::parse(p))
  , download_speed_(TlFetchDouble::parse(p))
  , upload_speed_(TlFetchDouble::parse(p))
  , ready_parts_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_daemon_peer::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(adnl_id_, s);
  TlStoreString::store(ip_str_, s);
  TlStoreBinary::store(download_speed_, s);
  TlStoreBinary::store(upload_speed_, s);
  TlStoreBinary::store(ready_parts_, s);
}

void storage_daemon_peer::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(adnl_id_, s);
  TlStoreString::store(ip_str_, s);
  TlStoreBinary::store(download_speed_, s);
...
void storage_daemon_peer::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_peer");
    s.store_field("adnl_id", adnl_id_);
    s.store_field("ip_str", ip_str_);
    s.store_field("download_speed", download_speed_);
    s.store_field("upload_speed", upload_speed_);
    s.store_field("ready_parts", ready_parts_);
    s.store_class_end();
  }
}

storage_daemon_peerList::storage_daemon_peerList()
  : peers_()
  , download_speed_()
  , upload_speed_()
  , total_parts_()
...
storage_daemon_peerList::storage_daemon_peerList(std::vector<object_ptr<storage_daemon_peer>> &&peers_, double download_speed_, double upload_speed_, std::int64_t total_parts_)
  : peers_(std::move(peers_))
  , download_speed_(download_speed_)
  , upload_speed_(upload_speed_)
  , total_parts_(total_parts_)
{}

const std::int32_t storage_daemon_peerList::ID;

object_ptr<storage_daemon_peerList> storage_daemon_peerList::fetch(td::TlParser &p) {
  return make_object<storage_daemon_peerList>(p);
}

storage_daemon_peerList::storage_daemon_peerList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : peers_(TlFetchVector<TlFetchObject<storage_daemon_peer>>::parse(p))
  , download_speed_(TlFetchDouble::parse(p))
  , upload_speed_(TlFetchDouble::parse(p))
  , total_parts_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_daemon_peerList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(peers_, s);
  TlStoreBinary::store(download_speed_, s);
  TlStoreBinary::store(upload_speed_, s);
  TlStoreBinary::store(total_parts_, s);
}

void storage_daemon_peerList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(peers_, s);
  TlStoreBinary::store(download_speed_, s);
  TlStoreBinary::store(upload_speed_, s);
...
void storage_daemon_peerList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_peerList");
    { const std::vector<object_ptr<storage_daemon_peer>> &v = peers_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("peers", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_field("download_speed", download_speed_);
    s.store_field("upload_speed", upload_speed_);
    s.store_field("total_parts", total_parts_);
    s.store_class_end();
  }
}

storage_daemon_providerAddress::storage_daemon_providerAddress()
  : address_()
{}

storage_daemon_providerAddress::storage_daemon_providerAddress(std::string const &address_)
  : address_(std::move(address_))
{}

const std::int32_t storage_daemon_providerAddress::ID;

object_ptr<storage_daemon_providerAddress> storage_daemon_providerAddress::fetch(td::TlParser &p) {
  return make_object<storage_daemon_providerAddress>(p);
}

storage_daemon_providerAddress::storage_daemon_providerAddress(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_providerAddress::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
}

void storage_daemon_providerAddress::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
}

void storage_daemon_providerAddress::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_providerAddress");
    s.store_field("address", address_);
    s.store_class_end();
  }
}

storage_daemon_providerConfig::storage_daemon_providerConfig()
  : max_contracts_()
  , max_total_size_()
{}

storage_daemon_providerConfig::storage_daemon_providerConfig(std::int32_t max_contracts_, std::int64_t max_total_size_)
  : max_contracts_(max_contracts_)
  , max_total_size_(max_total_size_)
{}

const std::int32_t storage_daemon_providerConfig::ID;

object_ptr<storage_daemon_providerConfig> storage_daemon_providerConfig::fetch(td::TlParser &p) {
  return make_object<storage_daemon_providerConfig>(p);
}

storage_daemon_providerConfig::storage_daemon_providerConfig(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : max_contracts_(TlFetchInt::parse(p))
  , max_total_size_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_daemon_providerConfig::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(max_contracts_, s);
  TlStoreBinary::store(max_total_size_, s);
}

void storage_daemon_providerConfig::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(max_contracts_, s);
  TlStoreBinary::store(max_total_size_, s);
}

void storage_daemon_providerConfig::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_providerConfig");
    s.store_field("max_contracts", max_contracts_);
    s.store_field("max_total_size", max_total_size_);
    s.store_class_end();
  }
}

storage_daemon_providerInfo::storage_daemon_providerInfo()
  : address_()
  , balance_()
  , config_()
  , contracts_count_()
  , contracts_total_size_()
  , contracts_()
{}

storage_daemon_providerInfo::storage_daemon_providerInfo(std::string const &address_, std::string const &balance_, object_ptr<storage_daemon_providerConfig> &&config_, std::int32_t contracts_count_, std::int64_t contracts_total_size_, std::vector<object_ptr<storage_daemon_contractInfo>> &&contracts_)
  : address_(std::move(address_))
  , balance_(std::move(balance_))
  , config_(std::move(config_))
  , contracts_count_(contracts_count_)
  , contracts_total_size_(contracts_total_size_)
  , contracts_(std::move(contracts_))
{}

const std::int32_t storage_daemon_providerInfo::ID;

object_ptr<storage_daemon_providerInfo> storage_daemon_providerInfo::fetch(td::TlParser &p) {
  return make_object<storage_daemon_providerInfo>(p);
}

storage_daemon_providerInfo::storage_daemon_providerInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
  , balance_(TlFetchString<std::string>::parse(p))
  , config_(TlFetchObject<storage_daemon_providerConfig>::parse(p))
  , contracts_count_(TlFetchInt::parse(p))
  , contracts_total_size_(TlFetchLong::parse(p))
  , contracts_(TlFetchVector<TlFetchObject<storage_daemon_contractInfo>>::parse(p))
#undef FAIL
{}

void storage_daemon_providerInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
  TlStoreString::store(balance_, s);
  TlStoreObject::store(config_, s);
  TlStoreBinary::store(contracts_count_, s);
  TlStoreBinary::store(contracts_total_size_, s);
  TlStoreVector<TlStoreObject>::store(contracts_, s);
}

void storage_daemon_providerInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(address_, s);
  TlStoreString::store(balance_, s);
  TlStoreObject::store(config_, s);
...
void storage_daemon_providerInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_providerInfo");
    s.store_field("address", address_);
    s.store_field("balance", balance_);
    if (config_ == nullptr) { s.store_field("config", "null"); } else { config_->store(s, "config"); }
    s.store_field("contracts_count", contracts_count_);
    s.store_field("contracts_total_size", contracts_total_size_);
    { const std::vector<object_ptr<storage_daemon_contractInfo>> &v = contracts_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("contracts", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_daemon_queryError::storage_daemon_queryError()
  : message_()
{}

storage_daemon_queryError::storage_daemon_queryError(std::string const &message_)
  : message_(std::move(message_))
{}

const std::int32_t storage_daemon_queryError::ID;

object_ptr<storage_daemon_queryError> storage_daemon_queryError::fetch(td::TlParser &p) {
  return make_object<storage_daemon_queryError>(p);
}

storage_daemon_queryError::storage_daemon_queryError(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : message_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_queryError::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(message_, s);
}

void storage_daemon_queryError::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(message_, s);
}

void storage_daemon_queryError::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_queryError");
    s.store_field("message", message_);
    s.store_class_end();
  }
}

object_ptr<storage_daemon_SetPriorityStatus> storage_daemon_SetPriorityStatus::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  int constructor = p.fetch_int();
  switch (constructor) {
    case storage_daemon_prioritySet::ID:
...
storage_daemon_prioritySet::storage_daemon_prioritySet() {
}

const std::int32_t storage_daemon_prioritySet::ID;

object_ptr<storage_daemon_SetPriorityStatus> storage_daemon_prioritySet::fetch(td::TlParser &p) {
  return make_object<storage_daemon_prioritySet>(p);
}

storage_daemon_prioritySet::storage_daemon_prioritySet(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_daemon_prioritySet::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_daemon_prioritySet::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_daemon_prioritySet::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_prioritySet");
    s.store_class_end();
  }
}

storage_daemon_priorityPending::storage_daemon_priorityPending() {
}

const std::int32_t storage_daemon_priorityPending::ID;

object_ptr<storage_daemon_SetPriorityStatus> storage_daemon_priorityPending::fetch(td::TlParser &p) {
  return make_object<storage_daemon_priorityPending>(p);
}

storage_daemon_priorityPending::storage_daemon_priorityPending(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_daemon_priorityPending::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_daemon_priorityPending::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_daemon_priorityPending::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_priorityPending");
    s.store_class_end();
  }
}

storage_daemon_speedLimits::storage_daemon_speedLimits()
  : download_()
  , upload_()
{}

storage_daemon_speedLimits::storage_daemon_speedLimits(double download_, double upload_)
  : download_(download_)
  , upload_(upload_)
{}

const std::int32_t storage_daemon_speedLimits::ID;

object_ptr<storage_daemon_speedLimits> storage_daemon_speedLimits::fetch(td::TlParser &p) {
  return make_object<storage_daemon_speedLimits>(p);
}

storage_daemon_speedLimits::storage_daemon_speedLimits(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : download_(TlFetchDouble::parse(p))
  , upload_(TlFetchDouble::parse(p))
#undef FAIL
{}

void storage_daemon_speedLimits::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(download_, s);
  TlStoreBinary::store(upload_, s);
}

void storage_daemon_speedLimits::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(download_, s);
  TlStoreBinary::store(upload_, s);
}

void storage_daemon_speedLimits::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_speedLimits");
    s.store_field("download", download_);
    s.store_field("upload", upload_);
    s.store_class_end();
  }
}

storage_daemon_success::storage_daemon_success() {
}

const std::int32_t storage_daemon_success::ID;

object_ptr<storage_daemon_success> storage_daemon_success::fetch(td::TlParser &p) {
  return make_object<storage_daemon_success>(p);
}

storage_daemon_success::storage_daemon_success(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_daemon_success::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_daemon_success::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_daemon_success::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_success");
    s.store_class_end();
  }
}

storage_daemon_torrent::storage_daemon_torrent()
  : hash_()
  , flags_()
  , total_size_()
  , description_()
...
storage_daemon_torrent::storage_daemon_torrent(td::Bits256 const &hash_, std::int32_t flags_, std::int64_t total_size_, std::string const &description_, std::int64_t files_count_, std::int64_t included_size_, std::string const &dir_name_, std::int64_t downloaded_size_, std::int32_t added_at_, std::string const &root_dir_, bool active_download_, bool active_upload_, bool completed_, double download_speed_, double upload_speed_, std::string const &fatal_error_)
  : hash_(hash_)
  , flags_(flags_)
  , total_size_(total_size_)
  , description_(std::move(description_))
  , files_count_(files_count_)
  , included_size_(included_size_)
  , dir_name_(std::move(dir_name_))
  , downloaded_size_(downloaded_size_)
  , added_at_(added_at_)
  , root_dir_(std::move(root_dir_))
  , active_download_(active_download_)
  , active_upload_(active_upload_)
  , completed_(completed_)
  , download_speed_(download_speed_)
  , upload_speed_(upload_speed_)
  , fatal_error_(std::move(fatal_error_))
{}

const std::int32_t storage_daemon_torrent::ID;

object_ptr<storage_daemon_torrent> storage_daemon_torrent::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_torrent> res = make_object<storage_daemon_torrent>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (var0 & 1) { res->total_size_ = TlFetchLong::parse(p); }
  if (var0 & 1) { res->description_ = TlFetchString<std::string>::parse(p); }
  if (var0 & 2) { res->files_count_ = TlFetchLong::parse(p); }
  if (var0 & 2) { res->included_size_ = TlFetchLong::parse(p); }
  if (var0 & 2) { res->dir_name_ = TlFetchString<std::string>::parse(p); }
  res->downloaded_size_ = TlFetchLong::parse(p);
  res->added_at_ = TlFetchInt::parse(p);
  res->root_dir_ = TlFetchString<std::string>::parse(p);
  res->active_download_ = TlFetchBool::parse(p);
  res->active_upload_ = TlFetchBool::parse(p);
  res->completed_ = TlFetchBool::parse(p);
  res->download_speed_ = TlFetchDouble::parse(p);
  res->upload_speed_ = TlFetchDouble::parse(p);
  if (var0 & 4) { res->fatal_error_ = TlFetchString<std::string>::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_daemon_torrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
  if (var0 & 1) { TlStoreBinary::store(total_size_, s); }
  if (var0 & 1) { TlStoreString::store(description_, s); }
  if (var0 & 2) { TlStoreBinary::store(files_count_, s); }
  if (var0 & 2) { TlStoreBinary::store(included_size_, s); }
  if (var0 & 2) { TlStoreString::store(dir_name_, s); }
  TlStoreBinary::store(downloaded_size_, s);
  TlStoreBinary::store(added_at_, s);
  TlStoreString::store(root_dir_, s);
  TlStoreBool::store(active_download_, s);
  TlStoreBool::store(active_upload_, s);
  TlStoreBool::store(completed_, s);
  TlStoreBinary::store(download_speed_, s);
  TlStoreBinary::store(upload_speed_, s);
  if (var0 & 4) { TlStoreString::store(fatal_error_, s); }
}

void storage_daemon_torrent::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_torrent::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_torrent");
  std::int32_t var0;
    s.store_field("hash", hash_);
    s.store_field("flags", (var0 = flags_));
    if (var0 & 1) { s.store_field("total_size", total_size_); }
    if (var0 & 1) { s.store_field("description", description_); }
    if (var0 & 2) { s.store_field("files_count", files_count_); }
    if (var0 & 2) { s.store_field("included_size", included_size_); }
    if (var0 & 2) { s.store_field("dir_name", dir_name_); }
    s.store_field("downloaded_size", downloaded_size_);
    s.store_field("added_at", added_at_);
    s.store_field("root_dir", root_dir_);
    s.store_field("active_download", active_download_);
    s.store_field("active_upload", active_upload_);
    s.store_field("completed", completed_);
    s.store_field("download_speed", download_speed_);
    s.store_field("upload_speed", upload_speed_);
    if (var0 & 4) { s.store_field("fatal_error", fatal_error_); }
    s.store_class_end();
  }
}

storage_daemon_torrentFull::storage_daemon_torrentFull()
  : torrent_()
  , files_()
{}

storage_daemon_torrentFull::storage_daemon_torrentFull(object_ptr<storage_daemon_torrent> &&torrent_, std::vector<object_ptr<storage_daemon_fileInfo>> &&files_)
  : torrent_(std::move(torrent_))
  , files_(std::move(files_))
{}

const std::int32_t storage_daemon_torrentFull::ID;

object_ptr<storage_daemon_torrentFull> storage_daemon_torrentFull::fetch(td::TlParser &p) {
  return make_object<storage_daemon_torrentFull>(p);
}

storage_daemon_torrentFull::storage_daemon_torrentFull(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : torrent_(TlFetchObject<storage_daemon_torrent>::parse(p))
  , files_(TlFetchVector<TlFetchObject<storage_daemon_fileInfo>>::parse(p))
#undef FAIL
{}

void storage_daemon_torrentFull::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(torrent_, s);
  TlStoreVector<TlStoreObject>::store(files_, s);
}

void storage_daemon_torrentFull::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(torrent_, s);
  TlStoreVector<TlStoreObject>::store(files_, s);
}

void storage_daemon_torrentFull::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_torrentFull");
    if (torrent_ == nullptr) { s.store_field("torrent", "null"); } else { torrent_->store(s, "torrent"); }
    { const std::vector<object_ptr<storage_daemon_fileInfo>> &v = files_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("files", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_daemon_torrentList::storage_daemon_torrentList()
  : torrents_()
{}

storage_daemon_torrentList::storage_daemon_torrentList(std::vector<object_ptr<storage_daemon_torrent>> &&torrents_)
  : torrents_(std::move(torrents_))
{}

const std::int32_t storage_daemon_torrentList::ID;

object_ptr<storage_daemon_torrentList> storage_daemon_torrentList::fetch(td::TlParser &p) {
  return make_object<storage_daemon_torrentList>(p);
}

storage_daemon_torrentList::storage_daemon_torrentList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : torrents_(TlFetchVector<TlFetchObject<storage_daemon_torrent>>::parse(p))
#undef FAIL
{}

void storage_daemon_torrentList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(torrents_, s);
}

void storage_daemon_torrentList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(torrents_, s);
}

void storage_daemon_torrentList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_torrentList");
    { const std::vector<object_ptr<storage_daemon_torrent>> &v = torrents_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("torrents", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_daemon_torrentMeta::storage_daemon_torrentMeta()
  : meta_()
{}

storage_daemon_torrentMeta::storage_daemon_torrentMeta(td::BufferSlice &&meta_)
  : meta_(std::move(meta_))
{}

const std::int32_t storage_daemon_torrentMeta::ID;

object_ptr<storage_daemon_torrentMeta> storage_daemon_torrentMeta::fetch(td::TlParser &p) {
  return make_object<storage_daemon_torrentMeta>(p);
}

storage_daemon_torrentMeta::storage_daemon_torrentMeta(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : meta_(TlFetchBytes<td::BufferSlice>::parse(p))
#undef FAIL
{}

void storage_daemon_torrentMeta::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(meta_, s);
}

void storage_daemon_torrentMeta::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(meta_, s);
}

void storage_daemon_torrentMeta::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_torrentMeta");
    s.store_bytes_field("meta", meta_);
    s.store_class_end();
  }
}

storage_daemon_torrentPiecesInfo::storage_daemon_torrentPiecesInfo()
  : flags_()
  , total_pieces_()
  , piece_size_()
  , range_l_()
...
storage_daemon_torrentPiecesInfo::storage_daemon_torrentPiecesInfo(std::int32_t flags_, std::int64_t total_pieces_, std::int32_t piece_size_, std::int64_t range_l_, std::int64_t range_r_, td::BufferSlice &&piece_ready_bitset_, std::vector<object_ptr<storage_daemon_filePiecesInfo>> &&files_)
  : flags_(flags_)
  , total_pieces_(total_pieces_)
  , piece_size_(piece_size_)
  , range_l_(range_l_)
  , range_r_(range_r_)
  , piece_ready_bitset_(std::move(piece_ready_bitset_))
  , files_(std::move(files_))
{}

const std::int32_t storage_daemon_torrentPiecesInfo::ID;

object_ptr<storage_daemon_torrentPiecesInfo> storage_daemon_torrentPiecesInfo::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_torrentPiecesInfo> res = make_object<storage_daemon_torrentPiecesInfo>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->total_pieces_ = TlFetchLong::parse(p);
  res->piece_size_ = TlFetchInt::parse(p);
  res->range_l_ = TlFetchLong::parse(p);
  res->range_r_ = TlFetchLong::parse(p);
  res->piece_ready_bitset_ = TlFetchBytes<td::BufferSlice>::parse(p);
  if (var0 & 1) { res->files_ = TlFetchVector<TlFetchObject<storage_daemon_filePiecesInfo>>::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_daemon_torrentPiecesInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreBinary::store(total_pieces_, s);
  TlStoreBinary::store(piece_size_, s);
  TlStoreBinary::store(range_l_, s);
  TlStoreBinary::store(range_r_, s);
  TlStoreString::store(piece_ready_bitset_, s);
  if (var0 & 1) { TlStoreVector<TlStoreObject>::store(files_, s); }
}

void storage_daemon_torrentPiecesInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreBinary::store(total_pieces_, s);
...
void storage_daemon_torrentPiecesInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_torrentPiecesInfo");
  std::int32_t var0;
    s.store_field("flags", (var0 = flags_));
    s.store_field("total_pieces", total_pieces_);
    s.store_field("piece_size", piece_size_);
    s.store_field("range_l", range_l_);
    s.store_field("range_r", range_r_);
    s.store_bytes_field("piece_ready_bitset", piece_ready_bitset_);
    if (var0 & 1) { { const std::vector<object_ptr<storage_daemon_filePiecesInfo>> &v = files_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("files", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); } }
    s.store_class_end();
  }
}

storage_daemon_config::storage_daemon_config()
  : server_key_()
  , cli_key_hash_()
  , provider_address_()
  , adnl_id_()
...
storage_daemon_config::storage_daemon_config(object_ptr<PublicKey> &&server_key_, td::Bits256 const &cli_key_hash_, std::string const &provider_address_, object_ptr<PublicKey> &&adnl_id_, object_ptr<PublicKey> &&dht_id_)
  : server_key_(std::move(server_key_))
  , cli_key_hash_(cli_key_hash_)
  , provider_address_(std::move(provider_address_))
  , adnl_id_(std::move(adnl_id_))
  , dht_id_(std::move(dht_id_))
{}

const std::int32_t storage_daemon_config::ID;

object_ptr<storage_daemon_config> storage_daemon_config::fetch(td::TlParser &p) {
  return make_object<storage_daemon_config>(p);
}

storage_daemon_config::storage_daemon_config(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : server_key_(TlFetchObject<PublicKey>::parse(p))
  , cli_key_hash_(TlFetchInt256::parse(p))
  , provider_address_(TlFetchString<std::string>::parse(p))
  , adnl_id_(TlFetchObject<PublicKey>::parse(p))
  , dht_id_(TlFetchObject<PublicKey>::parse(p))
#undef FAIL
{}

void storage_daemon_config::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBoxedUnknown<TlStoreObject>::store(server_key_, s);
  TlStoreBinary::store(cli_key_hash_, s);
  TlStoreString::store(provider_address_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(adnl_id_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(dht_id_, s);
}

void storage_daemon_config::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBoxedUnknown<TlStoreObject>::store(server_key_, s);
  TlStoreBinary::store(cli_key_hash_, s);
  TlStoreString::store(provider_address_, s);
...
void storage_daemon_config::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_config");
    if (server_key_ == nullptr) { s.store_field("server_key", "null"); } else { server_key_->store(s, "server_key"); }
    s.store_field("cli_key_hash", cli_key_hash_);
    s.store_field("provider_address", provider_address_);
    if (adnl_id_ == nullptr) { s.store_field("adnl_id", "null"); } else { adnl_id_->store(s, "adnl_id"); }
    if (dht_id_ == nullptr) { s.store_field("dht_id", "null"); } else { dht_id_->store(s, "dht_id"); }
    s.store_class_end();
  }
}

storage_daemon_provider_params::storage_daemon_provider_params()
...
storage_daemon_provider_params::storage_daemon_provider_params(bool accept_new_contracts_, std::string const &rate_per_mb_day_, std::int32_t max_span_, std::int64_t minimal_file_size_, std::int64_t maximal_file_size_)
  : accept_new_contracts_(accept_new_contracts_)
  , rate_per_mb_day_(std::move(rate_per_mb_day_))
  , max_span_(max_span_)
  , minimal_file_size_(minimal_file_size_)
  , maximal_file_size_(maximal_file_size_)
{}

const std::int32_t storage_daemon_provider_params::ID;

object_ptr<storage_daemon_provider_params> storage_daemon_provider_params::fetch(td::TlParser &p) {
  return make_object<storage_daemon_provider_params>(p);
}

storage_daemon_provider_params::storage_daemon_provider_params(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : accept_new_contracts_(TlFetchBool::parse(p))
  , rate_per_mb_day_(TlFetchString<std::string>::parse(p))
  , max_span_(TlFetchInt::parse(p))
  , minimal_file_size_(TlFetchLong::parse(p))
  , maximal_file_size_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_daemon_provider_params::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBool::store(accept_new_contracts_, s);
  TlStoreString::store(rate_per_mb_day_, s);
  TlStoreBinary::store(max_span_, s);
  TlStoreBinary::store(minimal_file_size_, s);
  TlStoreBinary::store(maximal_file_size_, s);
}

void storage_daemon_provider_params::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBool::store(accept_new_contracts_, s);
  TlStoreString::store(rate_per_mb_day_, s);
  TlStoreBinary::store(max_span_, s);
...
void storage_daemon_provider_params::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_provider_params");
    s.store_field("accept_new_contracts", accept_new_contracts_);
    s.store_field("rate_per_mb_day", rate_per_mb_day_);
    s.store_field("max_span", max_span_);
    s.store_field("minimal_file_size", minimal_file_size_);
    s.store_field("maximal_file_size", maximal_file_size_);
    s.store_class_end();
  }
}

storage_db_config::storage_db_config()
  : flags_()
  , download_speed_limit_()
  , upload_speed_limit_()
{}

storage_db_config::storage_db_config(std::int32_t flags_, double download_speed_limit_, double upload_speed_limit_)
  : flags_(flags_)
  , download_speed_limit_(download_speed_limit_)
  , upload_speed_limit_(upload_speed_limit_)
{}

const std::int32_t storage_db_config::ID;

object_ptr<storage_db_config> storage_db_config::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_db_config> res = make_object<storage_db_config>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->download_speed_limit_ = TlFetchDouble::parse(p);
  res->upload_speed_limit_ = TlFetchDouble::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_db_config::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreBinary::store(download_speed_limit_, s);
  TlStoreBinary::store(upload_speed_limit_, s);
}

void storage_db_config::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreBinary::store(download_speed_limit_, s);
...
void storage_db_config::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_config");
  std::int32_t var0;
    s.store_field("flags", (var0 = flags_));
    s.store_field("download_speed_limit", download_speed_limit_);
    s.store_field("upload_speed_limit", upload_speed_limit_);
    s.store_class_end();
  }
}

storage_provider_db_contractAddress::storage_provider_db_contractAddress()
  : wc_()
  , addr_()
{}

storage_provider_db_contractAddress::storage_provider_db_contractAddress(std::int32_t wc_, td::Bits256 const &addr_)
  : wc_(wc_)
  , addr_(addr_)
{}

const std::int32_t storage_provider_db_contractAddress::ID;

object_ptr<storage_provider_db_contractAddress> storage_provider_db_contractAddress::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_contractAddress>(p);
}

storage_provider_db_contractAddress::storage_provider_db_contractAddress(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : wc_(TlFetchInt::parse(p))
  , addr_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_provider_db_contractAddress::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_contractAddress::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_contractAddress::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_contractAddress");
    s.store_field("wc", wc_);
    s.store_field("addr", addr_);
    s.store_class_end();
  }
}

storage_provider_db_contractList::storage_provider_db_contractList()
  : contracts_()
{}

storage_provider_db_contractList::storage_provider_db_contractList(std::vector<object_ptr<storage_provider_db_contractAddress>> &&contracts_)
  : contracts_(std::move(contracts_))
{}

const std::int32_t storage_provider_db_contractList::ID;

object_ptr<storage_provider_db_contractList> storage_provider_db_contractList::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_contractList>(p);
}

storage_provider_db_contractList::storage_provider_db_contractList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : contracts_(TlFetchVector<TlFetchObject<storage_provider_db_contractAddress>>::parse(p))
#undef FAIL
{}

void storage_provider_db_contractList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(contracts_, s);
}

void storage_provider_db_contractList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreObject>::store(contracts_, s);
}

void storage_provider_db_contractList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_contractList");
    { const std::vector<object_ptr<storage_provider_db_contractAddress>> &v = contracts_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("contracts", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_db_piecesInDb::storage_db_piecesInDb()
  : pieces_()
{}

storage_db_piecesInDb::storage_db_piecesInDb(std::vector<std::int64_t> &&pieces_)
  : pieces_(std::move(pieces_))
{}

const std::int32_t storage_db_piecesInDb::ID;

object_ptr<storage_db_piecesInDb> storage_db_piecesInDb::fetch(td::TlParser &p) {
  return make_object<storage_db_piecesInDb>(p);
}

storage_db_piecesInDb::storage_db_piecesInDb(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : pieces_(TlFetchVector<TlFetchLong>::parse(p))
#undef FAIL
{}

void storage_db_piecesInDb::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBinary>::store(pieces_, s);
}

void storage_db_piecesInDb::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBinary>::store(pieces_, s);
}

void storage_db_piecesInDb::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_piecesInDb");
    { const std::vector<std::int64_t> &v = pieces_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("pieces", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { s.store_field("", v[i]); } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_db_priorities::storage_db_priorities()
  : actions_()
{}

storage_db_priorities::storage_db_priorities(std::vector<object_ptr<storage_PriorityAction>> &&actions_)
  : actions_(std::move(actions_))
{}

const std::int32_t storage_db_priorities::ID;

object_ptr<storage_db_priorities> storage_db_priorities::fetch(td::TlParser &p) {
  return make_object<storage_db_priorities>(p);
}

storage_db_priorities::storage_db_priorities(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : actions_(TlFetchVector<TlFetchObject<storage_PriorityAction>>::parse(p))
#undef FAIL
{}

void storage_db_priorities::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBoxedUnknown<TlStoreObject>>::store(actions_, s);
}

void storage_db_priorities::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBoxedUnknown<TlStoreObject>>::store(actions_, s);
}

void storage_db_priorities::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_priorities");
    { const std::vector<object_ptr<storage_PriorityAction>> &v = actions_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("actions", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

storage_db_torrentList::storage_db_torrentList()
  : torrents_()
{}

storage_db_torrentList::storage_db_torrentList(std::vector<td::Bits256> &&torrents_)
  : torrents_(std::move(torrents_))
{}

const std::int32_t storage_db_torrentList::ID;

object_ptr<storage_db_torrentList> storage_db_torrentList::fetch(td::TlParser &p) {
  return make_object<storage_db_torrentList>(p);
}

storage_db_torrentList::storage_db_torrentList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : torrents_(TlFetchVector<TlFetchInt256>::parse(p))
#undef FAIL
{}

void storage_db_torrentList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBinary>::store(torrents_, s);
}

void storage_db_torrentList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreVector<TlStoreBinary>::store(torrents_, s);
}

void storage_db_torrentList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_torrentList");
    { const std::vector<td::Bits256> &v = torrents_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("torrents", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { s.store_field("", v[i]); } s.store_class_end(); }
    s.store_class_end();
  }
}

object_ptr<storage_db_TorrentShort> storage_db_TorrentShort::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  int constructor = p.fetch_int();
  switch (constructor) {
    case storage_db_torrent::ID:
...
storage_db_torrent::storage_db_torrent()
  : root_dir_()
  , active_download_()
  , active_upload_()
{}

storage_db_torrent::storage_db_torrent(std::string const &root_dir_, bool active_download_, bool active_upload_)
  : root_dir_(std::move(root_dir_))
  , active_download_(active_download_)
  , active_upload_(active_upload_)
{}

const std::int32_t storage_db_torrent::ID;

object_ptr<storage_db_TorrentShort> storage_db_torrent::fetch(td::TlParser &p) {
  return make_object<storage_db_torrent>(p);
}

storage_db_torrent::storage_db_torrent(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : root_dir_(TlFetchString<std::string>::parse(p))
  , active_download_(TlFetchBool::parse(p))
  , active_upload_(TlFetchBool::parse(p))
#undef FAIL
{}

void storage_db_torrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(root_dir_, s);
  TlStoreBool::store(active_download_, s);
  TlStoreBool::store(active_upload_, s);
...
void storage_db_torrent::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(root_dir_, s);
  TlStoreBool::store(active_download_, s);
  TlStoreBool::store(active_upload_, s);
...
void storage_db_torrent::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_torrent");
    s.store_field("root_dir", root_dir_);
    s.store_field("active_download", active_download_);
    s.store_field("active_upload", active_upload_);
    s.store_class_end();
...
storage_db_torrentV2::storage_db_torrentV2()
  : flags_()
  , root_dir_()
  , added_at_()
  , active_download_()
...
storage_db_torrentV2::storage_db_torrentV2(std::int32_t flags_, std::string const &root_dir_, std::int32_t added_at_, bool active_download_, bool active_upload_)
  : flags_(flags_)
  , root_dir_(std::move(root_dir_))
  , added_at_(added_at_)
  , active_download_(active_download_)
...
const std::int32_t storage_db_torrentV2::ID;

object_ptr<storage_db_TorrentShort> storage_db_torrentV2::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_db_torrentV2> res = make_object<storage_db_torrentV2>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->root_dir_ = TlFetchString<std::string>::parse(p);
  res->added_at_ = TlFetchInt::parse(p);
...
void storage_db_torrentV2::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreString::store(root_dir_, s);
...
void storage_db_torrentV2::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  std::int32_t var0;
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreString::store(root_dir_, s);
...
void storage_db_torrentV2::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_torrentV2");
  std::int32_t var0;
    s.store_field("flags", (var0 = flags_));
    s.store_field("root_dir", root_dir_);
    s.store_field("added_at", added_at_);
...
storage_db_key_config::storage_db_key_config() {
}

const std::int32_t storage_db_key_config::ID;

object_ptr<storage_db_key_config> storage_db_key_config::fetch(td::TlParser &p) {
  return make_object<storage_db_key_config>(p);
}

storage_db_key_config::storage_db_key_config(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_db_key_config::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_db_key_config::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_db_key_config::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_config");
    s.store_class_end();
  }
}

storage_db_key_pieceInDb::storage_db_key_pieceInDb()
  : hash_()
  , idx_()
{}

storage_db_key_pieceInDb::storage_db_key_pieceInDb(td::Bits256 const &hash_, std::int64_t idx_)
  : hash_(hash_)
  , idx_(idx_)
{}

const std::int32_t storage_db_key_pieceInDb::ID;

object_ptr<storage_db_key_pieceInDb> storage_db_key_pieceInDb::fetch(td::TlParser &p) {
  return make_object<storage_db_key_pieceInDb>(p);
}

storage_db_key_pieceInDb::storage_db_key_pieceInDb(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , idx_(TlFetchLong::parse(p))
#undef FAIL
...
void storage_db_key_pieceInDb::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(idx_, s);
}

void storage_db_key_pieceInDb::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(idx_, s);
}

void storage_db_key_pieceInDb::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_pieceInDb");
    s.store_field("hash", hash_);
    s.store_field("idx", idx_);
    s.store_class_end();
  }
...
storage_db_key_piecesInDb::storage_db_key_piecesInDb()
  : hash_()
{}

storage_db_key_piecesInDb::storage_db_key_piecesInDb(td::Bits256 const &hash_)
  : hash_(hash_)
{}

const std::int32_t storage_db_key_piecesInDb::ID;

object_ptr<storage_db_key_piecesInDb> storage_db_key_piecesInDb::fetch(td::TlParser &p) {
  return make_object<storage_db_key_piecesInDb>(p);
}

storage_db_key_piecesInDb::storage_db_key_piecesInDb(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_db_key_piecesInDb::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_piecesInDb::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_piecesInDb::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_piecesInDb");
    s.store_field("hash", hash_);
    s.store_class_end();
  }
}

storage_db_key_priorities::storage_db_key_priorities()
  : hash_()
{}

storage_db_key_priorities::storage_db_key_priorities(td::Bits256 const &hash_)
  : hash_(hash_)
{}

const std::int32_t storage_db_key_priorities::ID;

object_ptr<storage_db_key_priorities> storage_db_key_priorities::fetch(td::TlParser &p) {
  return make_object<storage_db_key_priorities>(p);
}

storage_db_key_priorities::storage_db_key_priorities(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_db_key_priorities::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_priorities::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_priorities::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_priorities");
    s.store_field("hash", hash_);
    s.store_class_end();
  }
}

storage_db_key_torrentList::storage_db_key_torrentList() {
}

const std::int32_t storage_db_key_torrentList::ID;

object_ptr<storage_db_key_torrentList> storage_db_key_torrentList::fetch(td::TlParser &p) {
  return make_object<storage_db_key_torrentList>(p);
}

storage_db_key_torrentList::storage_db_key_torrentList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_db_key_torrentList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_db_key_torrentList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_db_key_torrentList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_torrentList");
    s.store_class_end();
  }
}

storage_db_key_torrentMeta::storage_db_key_torrentMeta()
  : hash_()
{}

storage_db_key_torrentMeta::storage_db_key_torrentMeta(td::Bits256 const &hash_)
  : hash_(hash_)
{}

const std::int32_t storage_db_key_torrentMeta::ID;

object_ptr<storage_db_key_torrentMeta> storage_db_key_torrentMeta::fetch(td::TlParser &p) {
  return make_object<storage_db_key_torrentMeta>(p);
}

storage_db_key_torrentMeta::storage_db_key_torrentMeta(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_db_key_torrentMeta::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_torrentMeta::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_torrentMeta::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_torrentMeta");
    s.store_field("hash", hash_);
    s.store_class_end();
  }
}

storage_db_key_torrent::storage_db_key_torrent()
  : hash_()
{}

storage_db_key_torrent::storage_db_key_torrent(td::Bits256 const &hash_)
  : hash_(hash_)
{}

const std::int32_t storage_db_key_torrent::ID;

object_ptr<storage_db_key_torrent> storage_db_key_torrent::fetch(td::TlParser &p) {
  return make_object<storage_db_key_torrent>(p);
}

storage_db_key_torrent::storage_db_key_torrent(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
#undef FAIL
{}

void storage_db_key_torrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_torrent::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(hash_, s);
}

void storage_db_key_torrent::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_db_key_torrent");
    s.store_field("hash", hash_);
    s.store_class_end();
  }
}

storage_provider_db_microchunkTree::storage_provider_db_microchunkTree()
  : data_()
{}

storage_provider_db_microchunkTree::storage_provider_db_microchunkTree(td::BufferSlice &&data_)
  : data_(std::move(data_))
{}

const std::int32_t storage_provider_db_microchunkTree::ID;

object_ptr<storage_provider_db_microchunkTree> storage_provider_db_microchunkTree::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_microchunkTree>(p);
}

storage_provider_db_microchunkTree::storage_provider_db_microchunkTree(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : data_(TlFetchBytes<td::BufferSlice>::parse(p))
#undef FAIL
{}

void storage_provider_db_microchunkTree::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreString::store(data_, s);
}

void storage_provider_db_microchunkTree::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreString::store(data_, s);
}

void storage_provider_db_microchunkTree::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_microchunkTree");
    s.store_bytes_field("data", data_);
    s.store_class_end();
  }
}

storage_provider_db_state::storage_provider_db_state()
  : last_processed_lt_()
{}

storage_provider_db_state::storage_provider_db_state(std::int64_t last_processed_lt_)
  : last_processed_lt_(last_processed_lt_)
{}

const std::int32_t storage_provider_db_state::ID;

object_ptr<storage_provider_db_state> storage_provider_db_state::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_state>(p);
}

storage_provider_db_state::storage_provider_db_state(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : last_processed_lt_(TlFetchLong::parse(p))
#undef FAIL
{}

void storage_provider_db_state::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(last_processed_lt_, s);
}

void storage_provider_db_state::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(last_processed_lt_, s);
}

void storage_provider_db_state::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_state");
    s.store_field("last_processed_lt", last_processed_lt_);
    s.store_class_end();
  }
}

storage_provider_db_storageContract::storage_provider_db_storageContract()
  : torrent_hash_()
  , microchunk_hash_()
  , created_time_()
  , state_()
...
storage_provider_db_storageContract::storage_provider_db_storageContract(td::Bits256 const &torrent_hash_, td::Bits256 const &microchunk_hash_, std::int32_t created_time_, std::int32_t state_, std::int64_t file_size_, std::string const &rate_, std::int32_t max_span_)
  : torrent_hash_(torrent_hash_)
  , microchunk_hash_(microchunk_hash_)
  , created_time_(created_time_)
  , state_(state_)
  , file_size_(file_size_)
  , rate_(std::move(rate_))
...
const std::int32_t storage_provider_db_storageContract::ID;

object_ptr<storage_provider_db_storageContract> storage_provider_db_storageContract::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_storageContract>(p);
}

storage_provider_db_storageContract::storage_provider_db_storageContract(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : torrent_hash_(TlFetchInt256::parse(p))
  , microchunk_hash_(TlFetchInt256::parse(p))
  , created_time_(TlFetchInt::parse(p))
  , state_(TlFetchInt::parse(p))
  , file_size_(TlFetchLong::parse(p))
  , rate_(TlFetchString<std::string>::parse(p))
...
void storage_provider_db_storageContract::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(torrent_hash_, s);
  TlStoreBinary::store(microchunk_hash_, s);
  TlStoreBinary::store(created_time_, s);
  TlStoreBinary::store(state_, s);
  TlStoreBinary::store(file_size_, s);
  TlStoreString::store(rate_, s);
...
void storage_provider_db_storageContract::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(torrent_hash_, s);
  TlStoreBinary::store(microchunk_hash_, s);
  TlStoreBinary::store(created_time_, s);
...
void storage_provider_db_storageContract::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_storageContract");
    s.store_field("torrent_hash", torrent_hash_);
    s.store_field("microchunk_hash", microchunk_hash_);
    s.store_field("created_time", created_time_);
    s.store_field("state", state_);
    s.store_field("file_size", file_size_);
    s.store_field("rate", rate_);
...
storage_provider_db_key_contractList::storage_provider_db_key_contractList() {
}

const std::int32_t storage_provider_db_key_contractList::ID;

object_ptr<storage_provider_db_key_contractList> storage_provider_db_key_contractList::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_key_contractList>(p);
}

storage_provider_db_key_contractList::storage_provider_db_key_contractList(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_provider_db_key_contractList::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_contractList::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_contractList::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_key_contractList");
    s.store_class_end();
  }
}

storage_provider_db_key_microchunkTree::storage_provider_db_key_microchunkTree()
  : wc_()
  , addr_()
{}

storage_provider_db_key_microchunkTree::storage_provider_db_key_microchunkTree(std::int32_t wc_, td::Bits256 const &addr_)
  : wc_(wc_)
  , addr_(addr_)
{}

const std::int32_t storage_provider_db_key_microchunkTree::ID;

object_ptr<storage_provider_db_key_microchunkTree> storage_provider_db_key_microchunkTree::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_key_microchunkTree>(p);
}

storage_provider_db_key_microchunkTree::storage_provider_db_key_microchunkTree(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : wc_(TlFetchInt::parse(p))
  , addr_(TlFetchInt256::parse(p))
#undef FAIL
...
void storage_provider_db_key_microchunkTree::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_key_microchunkTree::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_key_microchunkTree::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_key_microchunkTree");
    s.store_field("wc", wc_);
    s.store_field("addr", addr_);
    s.store_class_end();
  }
...
storage_provider_db_key_providerConfig::storage_provider_db_key_providerConfig() {
}

const std::int32_t storage_provider_db_key_providerConfig::ID;

object_ptr<storage_provider_db_key_providerConfig> storage_provider_db_key_providerConfig::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_key_providerConfig>(p);
}

storage_provider_db_key_providerConfig::storage_provider_db_key_providerConfig(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_provider_db_key_providerConfig::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_providerConfig::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_providerConfig::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_key_providerConfig");
    s.store_class_end();
  }
}

storage_provider_db_key_state::storage_provider_db_key_state() {
}

const std::int32_t storage_provider_db_key_state::ID;

object_ptr<storage_provider_db_key_state> storage_provider_db_key_state::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_key_state>(p);
}

storage_provider_db_key_state::storage_provider_db_key_state(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_provider_db_key_state::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_state::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
}

void storage_provider_db_key_state::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_key_state");
    s.store_class_end();
  }
}

storage_provider_db_key_storageContract::storage_provider_db_key_storageContract()
  : wc_()
  , addr_()
{}

storage_provider_db_key_storageContract::storage_provider_db_key_storageContract(std::int32_t wc_, td::Bits256 const &addr_)
  : wc_(wc_)
  , addr_(addr_)
{}

const std::int32_t storage_provider_db_key_storageContract::ID;

object_ptr<storage_provider_db_key_storageContract> storage_provider_db_key_storageContract::fetch(td::TlParser &p) {
  return make_object<storage_provider_db_key_storageContract>(p);
}

storage_provider_db_key_storageContract::storage_provider_db_key_storageContract(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : wc_(TlFetchInt::parse(p))
  , addr_(TlFetchInt256::parse(p))
#undef FAIL
...
void storage_provider_db_key_storageContract::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_key_storageContract::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(wc_, s);
  TlStoreBinary::store(addr_, s);
}

void storage_provider_db_key_storageContract::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_provider_db_key_storageContract");
    s.store_field("wc", wc_);
    s.store_field("addr", addr_);
    s.store_class_end();
  }
...
tonNode_privateBlockOverlayId::tonNode_privateBlockOverlayId()
  : zero_state_file_hash_()
  , nodes_()
{}

tonNode_privateBlockOverlayId::tonNode_privateBlockOverlayId(td::Bits256 const &zero_state_file_hash_, std::vector<td::Bits256> &&nodes_)
  : zero_state_file_hash_(zero_state_file_hash_)
  , nodes_(std::move(nodes_))
{}

const std::int32_t tonNode_privateBlockOverlayId::ID;

object_ptr<tonNode_privateBlockOverlayId> tonNode_privateBlockOverlayId::fetch(td::TlParser &p) {
  return make_object<tonNode_privateBlockOverlayId>(p);
}

tonNode_privateBlockOverlayId::tonNode_privateBlockOverlayId(td::TlParser &p)
#define FAIL(error) p.set_error(error)
...
void tonNode_privateBlockOverlayId::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(zero_state_file_hash_, s);
  TlStoreVector<TlStoreBinary>::store(nodes_, s);
}

void tonNode_privateBlockOverlayId::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(zero_state_file_hash_, s);
  TlStoreVector<TlStoreBinary>::store(nodes_, s);
}

void tonNode_privateBlockOverlayId::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "tonNode_privateBlockOverlayId");
...
validatorSession_catchainOptions::validatorSession_catchainOptions()
  : idle_timeout_()
  , max_deps_()
  , max_block_size_()
  , block_hash_covers_data_()
  , max_block_height_ceoff_()
  , debug_disable_db_()
{}

validatorSession_catchainOptions::validatorSession_catchainOptions(double idle_timeout_, std::int32_t max_deps_, std::int32_t max_block_size_, bool block_hash_covers_data_, std::int32_t max_block_height_ceoff_, bool debug_disable_db_)
  : idle_timeout_(idle_timeout_)
  , max_deps_(max_deps_)
  , max_block_size_(max_block_size_)
  , block_hash_covers_data_(block_hash_covers_data_)
  , max_block_height_ceoff_(max_block_height_ceoff_)
  , debug_disable_db_(debug_disable_db_)
{}

const std::int32_t validatorSession_catchainOptions::ID;

object_ptr<validatorSession_catchainOptions> validatorSession_catchainOptions::fetch(td::TlParser &p) {
  return make_object<validatorSession_catchainOptions>(p);
}

validatorSession_catchainOptions::validatorSession_catchainOptions(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : idle_timeout_(TlFetchDouble::parse(p))
  , max_deps_(TlFetchInt::parse(p))
  , max_block_size_(TlFetchInt::parse(p))
  , block_hash_covers_data_(TlFetchBool::parse(p))
  , max_block_height_ceoff_(TlFetchInt::parse(p))
  , debug_disable_db_(TlFetchBool::parse(p))
#undef FAIL
{}

void validatorSession_catchainOptions::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(idle_timeout_, s);
  TlStoreBinary::store(max_deps_, s);
  TlStoreBinary::store(max_block_size_, s);
  TlStoreBool::store(block_hash_covers_data_, s);
  TlStoreBinary::store(max_block_height_ceoff_, s);
  TlStoreBool::store(debug_disable_db_, s);
}

void validatorSession_catchainOptions::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(idle_timeout_, s);
  TlStoreBinary::store(max_deps_, s);
  TlStoreBinary::store(max_block_size_, s);
...
void validatorSession_catchainOptions::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_catchainOptions");
    s.store_field("idle_timeout", idle_timeout_);
    s.store_field("max_deps", max_deps_);
    s.store_field("max_block_size", max_block_size_);
    s.store_field("block_hash_covers_data", block_hash_covers_data_);
    s.store_field("max_block_height_ceoff", max_block_height_ceoff_);
    s.store_field("debug_disable_db", debug_disable_db_);
    s.store_class_end();
  }
}
...
validatorSession_configVersioned::validatorSession_configVersioned()
  : catchain_idle_timeout_()
  , catchain_max_deps_()
  , round_candidates_()
  , next_candidate_delay_()
...
const std::int32_t validatorSession_configVersioned::ID;

object_ptr<validatorSession_Config> validatorSession_configVersioned::fetch(td::TlParser &p) {
  return make_object<validatorSession_configVersioned>(p);
}

validatorSession_configVersioned::validatorSession_configVersioned(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : catchain_idle_timeout_(TlFetchDouble::parse(p))
  , catchain_max_deps_(TlFetchInt::parse(p))
  , round_candidates_(TlFetchInt::parse(p))
...
void validatorSession_configVersioned::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(catchain_idle_timeout_, s);
  TlStoreBinary::store(catchain_max_deps_, s);
  TlStoreBinary::store(round_candidates_, s);
...
void validatorSession_configVersioned::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(catchain_idle_timeout_, s);
  TlStoreBinary::store(catchain_max_deps_, s);
  TlStoreBinary::store(round_candidates_, s);
...
void validatorSession_configVersioned::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_configVersioned");
    s.store_field("catchain_idle_timeout", catchain_idle_timeout_);
    s.store_field("catchain_max_deps", catchain_max_deps_);
    s.store_field("round_candidates", round_candidates_);
    s.store_field("next_candidate_delay", next_candidate_delay_);
...
validatorSession_configVersionedV2::validatorSession_configVersionedV2()
  : catchain_opts_()
  , round_candidates_()
  , next_candidate_delay_()
  , round_attempt_duration_()
...
validatorSession_configVersionedV2::validatorSession_configVersionedV2(object_ptr<validatorSession_catchainOptions> &&catchain_opts_, std::int32_t round_candidates_, double next_candidate_delay_, std::int32_t round_attempt_duration_, std::int32_t max_round_attempts_, std::int32_t max_block_size_, std::int32_t max_collated_data_size_, std::int32_t version_)
  : catchain_opts_(std::move(catchain_opts_))
  , round_candidates_(round_candidates_)
  , next_candidate_delay_(next_candidate_delay_)
  , round_attempt_duration_(round_attempt_duration_)
  , max_round_attempts_(max_round_attempts_)
...
const std::int32_t validatorSession_configVersionedV2::ID;

object_ptr<validatorSession_Config> validatorSession_configVersionedV2::fetch(td::TlParser &p) {
  return make_object<validatorSession_configVersionedV2>(p);
}

validatorSession_configVersionedV2::validatorSession_configVersionedV2(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : catchain_opts_(TlFetchBoxed<TlFetchObject<validatorSession_catchainOptions>, 1893878246>::parse(p))
  , round_candidates_(TlFetchInt::parse(p))
  , next_candidate_delay_(TlFetchDouble::parse(p))
  , round_attempt_duration_(TlFetchInt::parse(p))
  , max_round_attempts_(TlFetchInt::parse(p))
...
void validatorSession_configVersionedV2::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBoxed<TlStoreObject, 1893878246>::store(catchain_opts_, s);
  TlStoreBinary::store(round_candidates_, s);
  TlStoreBinary::store(next_candidate_delay_, s);
  TlStoreBinary::store(round_attempt_duration_, s);
  TlStoreBinary::store(max_round_attempts_, s);
...
void validatorSession_configVersionedV2::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBoxed<TlStoreObject, 1893878246>::store(catchain_opts_, s);
  TlStoreBinary::store(round_candidates_, s);
  TlStoreBinary::store(next_candidate_delay_, s);
...
void validatorSession_configVersionedV2::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_configVersionedV2");
    if (catchain_opts_ == nullptr) { s.store_field("catchain_opts", "null"); } else { catchain_opts_->store(s, "catchain_opts"); }
    s.store_field("round_candidates", round_candidates_);
    s.store_field("next_candidate_delay", next_candidate_delay_);
    s.store_field("round_attempt_duration", round_attempt_duration_);
    s.store_field("max_round_attempts", max_round_attempts_);
...
validatorSession_stats::validatorSession_stats()
  : id_()
  , timestamp_()
  , self_()
  , creator_()
  ...
  , signatures_weight_()
  , approve_signatures_()
  , approve_signatures_weight_()
  , first_round_()
  , rounds_()
{}

validatorSession_stats::validatorSession_stats(object_ptr<tonNode_blockId> &&id_, std::int64_t timestamp_, td::Bits256 const &self_, td::Bits256 const &creator_, std::int32_t total_validators_, std::int64_t total_weight_, std::int32_t signatures_, std::int64_t signatures_weight_, std::int32_t approve_signatures_, std::int64_t approve_signatures_weight_, std::int32_t first_round_, std::vector<object_ptr<validatorSession_statsRound>> &&rounds_)
  : id_(std::move(id_))
  , timestamp_(timestamp_)
  , self_(self_)
  , creator_(creator_)
  , total_validators_(total_validators_)
  , total_weight_(total_weight_)
  , signatures_(signatures_)
  , signatures_weight_(signatures_weight_)
  , approve_signatures_(approve_signatures_)
  , approve_signatures_weight_(approve_signatures_weight_)
  , first_round_(first_round_)
  , rounds_(std::move(rounds_))
{}

const std::int32_t validatorSession_stats::ID;

object_ptr<validatorSession_stats> validatorSession_stats::fetch(td::TlParser &p) {
  return make_object<validatorSession_stats>(p);
}

validatorSession_stats::validatorSession_stats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchObject<tonNode_blockId>::parse(p))
  , timestamp_(TlFetchLong::parse(p))
  , self_(TlFetchInt256::parse(p))
  , creator_(TlFetchInt256::parse(p))
  , total_validators_(TlFetchInt::parse(p))
  , total_weight_(TlFetchLong::parse(p))
  , signatures_(TlFetchInt::parse(p))
  , signatures_weight_(TlFetchLong::parse(p))
  , approve_signatures_(TlFetchInt::parse(p))
  , approve_signatures_weight_(TlFetchLong::parse(p))
  , first_round_(TlFetchInt::parse(p))
  , rounds_(TlFetchVector<TlFetchObject<validatorSession_statsRound>>::parse(p))
#undef FAIL
{}

void validatorSession_stats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store(timestamp_, s);
  TlStoreBinary::store(self_, s);
  TlStoreBinary::store(creator_, s);
  TlStoreBinary::store(total_validators_, s);
  TlStoreBinary::store(total_weight_, s);
  TlStoreBinary::store(signatures_, s);
  TlStoreBinary::store(signatures_weight_, s);
  TlStoreBinary::store(approve_signatures_, s);
  TlStoreBinary::store(approve_signatures_weight_, s);
  TlStoreBinary::store(first_round_, s);
  TlStoreVector<TlStoreObject>::store(rounds_, s);
}

void validatorSession_stats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreObject::store(id_, s);
  TlStoreBinary::store(timestamp_, s);
  TlStoreBinary::store(self_, s);
...
void validatorSession_stats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_stats");
    if (id_ == nullptr) { s.store_field("id", "null"); } else { id_->store(s, "id"); }
    s.store_field("timestamp", timestamp_);
    s.store_field("self", self_);
    s.store_field("creator", creator_);
    s.store_field("total_validators", total_validators_);
    s.store_field("total_weight", total_weight_);
    s.store_field("signatures", signatures_);
    s.store_field("signatures_weight", signatures_weight_);
    s.store_field("approve_signatures", approve_signatures_);
    s.store_field("approve_signatures_weight", approve_signatures_weight_);
    s.store_field("first_round", first_round_);
    { const std::vector<object_ptr<validatorSession_statsRound>> &v = rounds_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("rounds", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}

validatorSession_statsProducer::validatorSession_statsProducer()
  : id_()
  , block_status_()
  , block_timestamp_()
{}

validatorSession_statsProducer::validatorSession_statsProducer(td::Bits256 const &id_, std::int32_t block_status_, std::int64_t block_timestamp_)
  : id_(id_)
  , block_status_(block_status_)
  , block_timestamp_(block_timestamp_)
{}

const std::int32_t validatorSession_statsProducer::ID;

object_ptr<validatorSession_statsProducer> validatorSession_statsProducer::fetch(td::TlParser &p) {
  return make_object<validatorSession_statsProducer>(p);
}

validatorSession_statsProducer::validatorSession_statsProducer(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : id_(TlFetchInt256::parse(p))
  , block_status_(TlFetchInt::parse(p))
  , block_timestamp_(TlFetchLong::parse(p))
#undef FAIL
{}

void validatorSession_statsProducer::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(id_, s);
  TlStoreBinary::store(block_status_, s);
  TlStoreBinary::store(block_timestamp_, s);
}

void validatorSession_statsProducer::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(id_, s);
  TlStoreBinary::store(block_status_, s);
  TlStoreBinary::store(block_timestamp_, s);
...
void validatorSession_statsProducer::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_statsProducer");
    s.store_field("id", id_);
    s.store_field("block_status", block_status_);
    s.store_field("block_timestamp", block_timestamp_);
    s.store_class_end();
  }
}

validatorSession_statsRound::validatorSession_statsRound()
  : timestamp_()
  , producers_()
{}

validatorSession_statsRound::validatorSession_statsRound(std::int64_t timestamp_, std::vector<object_ptr<validatorSession_statsProducer>> &&producers_)
  : timestamp_(timestamp_)
  , producers_(std::move(producers_))
{}

const std::int32_t validatorSession_statsRound::ID;

object_ptr<validatorSession_statsRound> validatorSession_statsRound::fetch(td::TlParser &p) {
  return make_object<validatorSession_statsRound>(p);
}

validatorSession_statsRound::validatorSession_statsRound(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : timestamp_(TlFetchLong::parse(p))
  , producers_(TlFetchVector<TlFetchObject<validatorSession_statsProducer>>::parse(p))
#undef FAIL
{}

void validatorSession_statsRound::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(timestamp_, s);
  TlStoreVector<TlStoreObject>::store(producers_, s);
}

void validatorSession_statsRound::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  TlStoreBinary::store(timestamp_, s);
  TlStoreVector<TlStoreObject>::store(producers_, s);
}

void validatorSession_statsRound::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "validatorSession_statsRound");
    s.store_field("timestamp", timestamp_);
    { const std::vector<object_ptr<validatorSession_statsProducer>> &v = producers_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("producers", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_class_end();
  }
}
...
dht_registerReverseConnection::dht_registerReverseConnection()
  : node_()
  , ttl_()
  , signature_()
{}

dht_registerReverseConnection::dht_registerReverseConnection(object_ptr<PublicKey> &&node_, std::int32_t ttl_, td::BufferSlice &&signature_)
  : node_(std::move(node_))
  , ttl_(ttl_)
  , signature_(std::move(signature_))
{}

const std::int32_t dht_registerReverseConnection::ID;

object_ptr<dht_registerReverseConnection> dht_registerReverseConnection::fetch(td::TlParser &p) {
  return make_object<dht_registerReverseConnection>(p);
}

dht_registerReverseConnection::dht_registerReverseConnection(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : node_(TlFetchObject<PublicKey>::parse(p))
  , ttl_(TlFetchInt::parse(p))
  , signature_(TlFetchBytes<td::BufferSlice>::parse(p))
#undef FAIL
{}

void dht_registerReverseConnection::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(573357153);
  TlStoreBoxedUnknown<TlStoreObject>::store(node_, s);
  TlStoreBinary::store(ttl_, s);
  TlStoreString::store(signature_, s);
}

void dht_registerReverseConnection::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(573357153);
  TlStoreBoxedUnknown<TlStoreObject>::store(node_, s);
  TlStoreBinary::store(ttl_, s);
...
void dht_registerReverseConnection::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_registerReverseConnection");
    if (node_ == nullptr) { s.store_field("node", "null"); } else { node_->store(s, "node"); }
    s.store_field("ttl", ttl_);
    s.store_bytes_field("signature", signature_);
    s.store_class_end();
...
dht_registerReverseConnection::ReturnType dht_registerReverseConnection::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<dht_stored>, 1881602824>::parse(p);
#undef FAIL
}

dht_requestReversePing::dht_requestReversePing()
  : target_()
  , signature_()
  , client_()
  , k_()
...
dht_requestReversePing::dht_requestReversePing(object_ptr<adnl_node> &&target_, td::BufferSlice &&signature_, td::Bits256 const &client_, std::int32_t k_)
  : target_(std::move(target_))
  , signature_(std::move(signature_))
  , client_(client_)
  , k_(k_)
...
const std::int32_t dht_requestReversePing::ID;

object_ptr<dht_requestReversePing> dht_requestReversePing::fetch(td::TlParser &p) {
  return make_object<dht_requestReversePing>(p);
}

dht_requestReversePing::dht_requestReversePing(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : target_(TlFetchBoxed<TlFetchObject<adnl_node>, 1800802949>::parse(p))
  , signature_(TlFetchBytes<td::BufferSlice>::parse(p))
  , client_(TlFetchInt256::parse(p))
...
void dht_requestReversePing::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(194290698);
  TlStoreBoxed<TlStoreObject, 1800802949>::store(target_, s);
  TlStoreString::store(signature_, s);
  TlStoreBinary::store(client_, s);
  TlStoreBinary::store(k_, s);
...
void dht_requestReversePing::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(194290698);
  TlStoreBoxed<TlStoreObject, 1800802949>::store(target_, s);
  TlStoreString::store(signature_, s);
...
void dht_requestReversePing::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "dht_requestReversePing");
    if (target_ == nullptr) { s.store_field("target", "null"); } else { target_->store(s, "target"); }
    s.store_bytes_field("signature", signature_);
    s.store_field("client", client_);
    s.store_field("k", k_);
...
dht_requestReversePing::ReturnType dht_requestReversePing::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchObject<dht_ReversePingResult>::parse(p);
#undef FAIL
}
...
engine_validator_getOverlaysStats::engine_validator_getOverlaysStats() {
}

const std::int32_t engine_validator_getOverlaysStats::ID;

object_ptr<engine_validator_getOverlaysStats> engine_validator_getOverlaysStats::fetch(td::TlParser &p) {
  return make_object<engine_validator_getOverlaysStats>(p);
}

engine_validator_getOverlaysStats::engine_validator_getOverlaysStats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void engine_validator_getOverlaysStats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-52908850);
}

void engine_validator_getOverlaysStats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-52908850);
}

void engine_validator_getOverlaysStats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_getOverlaysStats");
    s.store_class_end();
  }
}

engine_validator_getOverlaysStats::ReturnType engine_validator_getOverlaysStats::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_overlaysStats>, -1677121921>::parse(p);
#undef FAIL
}

engine_validator_getPerfTimerStats::engine_validator_getPerfTimerStats()
  : name_()
{}

engine_validator_getPerfTimerStats::engine_validator_getPerfTimerStats(std::string const &name_)
  : name_(std::move(name_))
{}

const std::int32_t engine_validator_getPerfTimerStats::ID;

object_ptr<engine_validator_getPerfTimerStats> engine_validator_getPerfTimerStats::fetch(td::TlParser &p) {
  return make_object<engine_validator_getPerfTimerStats>(p);
}

engine_validator_getPerfTimerStats::engine_validator_getPerfTimerStats(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : name_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void engine_validator_getPerfTimerStats::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-364709649);
  TlStoreString::store(name_, s);
}

void engine_validator_getPerfTimerStats::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-364709649);
  TlStoreString::store(name_, s);
}

void engine_validator_getPerfTimerStats::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_getPerfTimerStats");
    s.store_field("name", name_);
    s.store_class_end();
  }
}

engine_validator_getPerfTimerStats::ReturnType engine_validator_getPerfTimerStats::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_perfTimerStats>, 1607488795>::parse(p);
#undef FAIL
}

engine_validator_getShardOutQueueSize::engine_validator_getShardOutQueueSize()
  : flags_()
  , block_id_()
  , dest_wc_()
  , dest_shard_()
...
engine_validator_getShardOutQueueSize::engine_validator_getShardOutQueueSize(std::int32_t flags_, object_ptr<tonNode_blockId> &&block_id_, std::int32_t dest_wc_, std::int64_t dest_shard_)
  : flags_(flags_)
  , block_id_(std::move(block_id_))
  , dest_wc_(dest_wc_)
  , dest_shard_(dest_shard_)
{}

const std::int32_t engine_validator_getShardOutQueueSize::ID;

object_ptr<engine_validator_getShardOutQueueSize> engine_validator_getShardOutQueueSize::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<engine_validator_getShardOutQueueSize> res = make_object<engine_validator_getShardOutQueueSize>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->block_id_ = TlFetchObject<tonNode_blockId>::parse(p);
  if (var0 & 1) { res->dest_wc_ = TlFetchInt::parse(p); }
  if (var0 & 1) { res->dest_shard_ = TlFetchLong::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void engine_validator_getShardOutQueueSize::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1537301584);
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreObject::store(block_id_, s);
  if (var0 & 1) { TlStoreBinary::store(dest_wc_, s); }
  if (var0 & 1) { TlStoreBinary::store(dest_shard_, s); }
}

void engine_validator_getShardOutQueueSize::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1537301584);
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreObject::store(block_id_, s);
...
void engine_validator_getShardOutQueueSize::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_getShardOutQueueSize");
    s.store_field("flags", (var0 = flags_));
    if (block_id_ == nullptr) { s.store_field("block_id", "null"); } else { block_id_->store(s, "block_id"); }
    if (var0 & 1) { s.store_field("dest_wc", dest_wc_); }
    if (var0 & 1) { s.store_field("dest_shard", dest_shard_); }
    s.store_class_end();
  }
}

engine_validator_getShardOutQueueSize::ReturnType engine_validator_getShardOutQueueSize::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_shardOutQueueSize>, 266052701>::parse(p);
#undef FAIL
}
...
engine_validator_importCertificate::engine_validator_importCertificate()
  : overlay_id_()
  , local_id_()
  , signed_key_()
  , cert_()
...
engine_validator_importCertificate::engine_validator_importCertificate(td::Bits256 const &overlay_id_, object_ptr<adnl_id_short> &&local_id_, object_ptr<engine_validator_keyHash> &&signed_key_, object_ptr<overlay_Certificate> &&cert_)
  : overlay_id_(overlay_id_)
  , local_id_(std::move(local_id_))
  , signed_key_(std::move(signed_key_))
  , cert_(std::move(cert_))
{}

const std::int32_t engine_validator_importCertificate::ID;

object_ptr<engine_validator_importCertificate> engine_validator_importCertificate::fetch(td::TlParser &p) {
  return make_object<engine_validator_importCertificate>(p);
}

engine_validator_importCertificate::engine_validator_importCertificate(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : overlay_id_(TlFetchInt256::parse(p))
  , local_id_(TlFetchObject<adnl_id_short>::parse(p))
  , signed_key_(TlFetchBoxed<TlFetchObject<engine_validator_keyHash>, -1027168946>::parse(p))
  , cert_(TlFetchObject<overlay_Certificate>::parse(p))
#undef FAIL
{}

void engine_validator_importCertificate::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1015201999);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreObject::store(local_id_, s);
  TlStoreBoxed<TlStoreObject, -1027168946>::store(signed_key_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(cert_, s);
}

void engine_validator_importCertificate::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1015201999);
  TlStoreBinary::store(overlay_id_, s);
  TlStoreObject::store(local_id_, s);
...
void engine_validator_importCertificate::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_importCertificate");
    s.store_field("overlay_id", overlay_id_);
    if (local_id_ == nullptr) { s.store_field("local_id", "null"); } else { local_id_->store(s, "local_id"); }
    if (signed_key_ == nullptr) { s.store_field("signed_key", "null"); } else { signed_key_->store(s, "signed_key"); }
    if (cert_ == nullptr) { s.store_field("cert", "null"); } else { cert_->store(s, "cert"); }
    s.store_class_end();
  }
}

engine_validator_importCertificate::ReturnType engine_validator_importCertificate::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_success>, -1276860789>::parse(p);
#undef FAIL
}
...
engine_validator_importShardOverlayCertificate::engine_validator_importShardOverlayCertificate()
  : workchain_()
  , shard_()
  , signed_key_()
  , cert_()
...
engine_validator_importShardOverlayCertificate::engine_validator_importShardOverlayCertificate(std::int32_t workchain_, std::int64_t shard_, object_ptr<engine_validator_keyHash> &&signed_key_, object_ptr<overlay_Certificate> &&cert_)
  : workchain_(workchain_)
  , shard_(shard_)
  , signed_key_(std::move(signed_key_))
  , cert_(std::move(cert_))
...
const std::int32_t engine_validator_importShardOverlayCertificate::ID;

object_ptr<engine_validator_importShardOverlayCertificate> engine_validator_importShardOverlayCertificate::fetch(td::TlParser &p) {
  return make_object<engine_validator_importShardOverlayCertificate>(p);
}

engine_validator_importShardOverlayCertificate::engine_validator_importShardOverlayCertificate(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : workchain_(TlFetchInt::parse(p))
  , shard_(TlFetchLong::parse(p))
  , signed_key_(TlFetchBoxed<TlFetchObject<engine_validator_keyHash>, -1027168946>::parse(p))
...
void engine_validator_importShardOverlayCertificate::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(448989784);
  TlStoreBinary::store(workchain_, s);
  TlStoreBinary::store(shard_, s);
  TlStoreBoxed<TlStoreObject, -1027168946>::store(signed_key_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(cert_, s);
...
void engine_validator_importShardOverlayCertificate::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(448989784);
  TlStoreBinary::store(workchain_, s);
  TlStoreBinary::store(shard_, s);
...
void engine_validator_importShardOverlayCertificate::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_importShardOverlayCertificate");
    s.store_field("workchain", workchain_);
    s.store_field("shard", shard_);
    if (signed_key_ == nullptr) { s.store_field("signed_key", "null"); } else { signed_key_->store(s, "signed_key"); }
    if (cert_ == nullptr) { s.store_field("cert", "null"); } else { cert_->store(s, "cert"); }
...
engine_validator_importShardOverlayCertificate::ReturnType engine_validator_importShardOverlayCertificate::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_success>, -1276860789>::parse(p);
#undef FAIL
}

engine_validator_setExtMessagesBroadcastDisabled::engine_validator_setExtMessagesBroadcastDisabled()
  : disabled_()
{}

engine_validator_setExtMessagesBroadcastDisabled::engine_validator_setExtMessagesBroadcastDisabled(bool disabled_)
  : disabled_(disabled_)
{}

const std::int32_t engine_validator_setExtMessagesBroadcastDisabled::ID;

object_ptr<engine_validator_setExtMessagesBroadcastDisabled> engine_validator_setExtMessagesBroadcastDisabled::fetch(td::TlParser &p) {
  return make_object<engine_validator_setExtMessagesBroadcastDisabled>(p);
}

engine_validator_setExtMessagesBroadcastDisabled::engine_validator_setExtMessagesBroadcastDisabled(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : disabled_(TlFetchBool::parse(p))
#undef FAIL
{}

void engine_validator_setExtMessagesBroadcastDisabled::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1970206246);
  TlStoreBool::store(disabled_, s);
}

void engine_validator_setExtMessagesBroadcastDisabled::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1970206246);
  TlStoreBool::store(disabled_, s);
}

void engine_validator_setExtMessagesBroadcastDisabled::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_setExtMessagesBroadcastDisabled");
    s.store_field("disabled", disabled_);
    s.store_class_end();
  }
}

engine_validator_setExtMessagesBroadcastDisabled::ReturnType engine_validator_setExtMessagesBroadcastDisabled::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<engine_validator_success>, -1276860789>::parse(p);
#undef FAIL
}
...
engine_validator_signShardOverlayCertificate::engine_validator_signShardOverlayCertificate()
  : workchain_()
  , shard_()
  , signed_key_()
  , expire_at_()
...
engine_validator_signShardOverlayCertificate::engine_validator_signShardOverlayCertificate(std::int32_t workchain_, std::int64_t shard_, object_ptr<engine_validator_keyHash> &&signed_key_, std::int32_t expire_at_, std::int32_t max_size_)
  : workchain_(workchain_)
  , shard_(shard_)
  , signed_key_(std::move(signed_key_))
  , expire_at_(expire_at_)
...
const std::int32_t engine_validator_signShardOverlayCertificate::ID;

object_ptr<engine_validator_signShardOverlayCertificate> engine_validator_signShardOverlayCertificate::fetch(td::TlParser &p) {
  return make_object<engine_validator_signShardOverlayCertificate>(p);
}

engine_validator_signShardOverlayCertificate::engine_validator_signShardOverlayCertificate(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : workchain_(TlFetchInt::parse(p))
  , shard_(TlFetchLong::parse(p))
  , signed_key_(TlFetchBoxed<TlFetchObject<engine_validator_keyHash>, -1027168946>::parse(p))
...
void engine_validator_signShardOverlayCertificate::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1553415254);
  TlStoreBinary::store(workchain_, s);
  TlStoreBinary::store(shard_, s);
  TlStoreBoxed<TlStoreObject, -1027168946>::store(signed_key_, s);
  TlStoreBinary::store(expire_at_, s);
...
void engine_validator_signShardOverlayCertificate::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1553415254);
  TlStoreBinary::store(workchain_, s);
  TlStoreBinary::store(shard_, s);
...
void engine_validator_signShardOverlayCertificate::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "engine_validator_signShardOverlayCertificate");
    s.store_field("workchain", workchain_);
    s.store_field("shard", shard_);
    if (signed_key_ == nullptr) { s.store_field("signed_key", "null"); } else { signed_key_->store(s, "signed_key"); }
    s.store_field("expire_at", expire_at_);
...
engine_validator_signShardOverlayCertificate::ReturnType engine_validator_signShardOverlayCertificate::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchObject<overlay_Certificate>::parse(p);
#undef FAIL
}
...
http_proxy_getCapabilities::http_proxy_getCapabilities()
  : capabilities_()
{}

http_proxy_getCapabilities::http_proxy_getCapabilities(std::int64_t capabilities_)
  : capabilities_(capabilities_)
{}

const std::int32_t http_proxy_getCapabilities::ID;

object_ptr<http_proxy_getCapabilities> http_proxy_getCapabilities::fetch(td::TlParser &p) {
  return make_object<http_proxy_getCapabilities>(p);
}

http_proxy_getCapabilities::http_proxy_getCapabilities(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : capabilities_(TlFetchLong::parse(p))
#undef FAIL
{}

void http_proxy_getCapabilities::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-613277815);
  TlStoreBinary::store(capabilities_, s);
}

void http_proxy_getCapabilities::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-613277815);
  TlStoreBinary::store(capabilities_, s);
}

void http_proxy_getCapabilities::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "http_proxy_getCapabilities");
    s.store_field("capabilities", capabilities_);
    s.store_class_end();
  }
}

http_proxy_getCapabilities::ReturnType http_proxy_getCapabilities::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<http_proxy_capabilities>, 831679505>::parse(p);
#undef FAIL
}
...
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<http_response>, -901208246>::parse(p);
#undef FAIL
}
...
storage_daemon_addByHash::storage_daemon_addByHash()
  : hash_()
  , root_dir_()
  , start_download_()
  , allow_upload_()
...
storage_daemon_addByHash::storage_daemon_addByHash(td::Bits256 const &hash_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_, std::int32_t flags_)
  : hash_(hash_)
  , root_dir_(std::move(root_dir_))
  , start_download_(start_download_)
  , allow_upload_(allow_upload_)
  , priorities_(std::move(priorities_))
  , flags_(flags_)
{}

const std::int32_t storage_daemon_addByHash::ID;

object_ptr<storage_daemon_addByHash> storage_daemon_addByHash::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_addByHash> res = make_object<storage_daemon_addByHash>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  res->root_dir_ = TlFetchString<std::string>::parse(p);
  res->start_download_ = TlFetchBool::parse(p);
  res->allow_upload_ = TlFetchBool::parse(p);
  res->priorities_ = TlFetchVector<TlFetchObject<storage_PriorityAction>>::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
...
void storage_daemon_addByHash::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1254791010);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(root_dir_, s);
  TlStoreBool::store(start_download_, s);
  TlStoreBool::store(allow_upload_, s);
  TlStoreVector<TlStoreBoxedUnknown<TlStoreObject>>::store(priorities_, s);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_addByHash::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1254791010);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(root_dir_, s);
...
void storage_daemon_addByHash::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_addByHash");
    s.store_field("hash", hash_);
    s.store_field("root_dir", root_dir_);
    s.store_field("start_download", start_download_);
    s.store_field("allow_upload", allow_upload_);
    { const std::vector<object_ptr<storage_PriorityAction>> &v = priorities_; const std::uint32_t multiplicity = static_cast<std::uint32_t>(v.size()); const auto vector_name = "vector[" + td::to_string(multiplicity)+ "]"; s.store_class_begin("priorities", vector_name.c_str()); for (std::uint32_t i = 0; i < multiplicity; i++) { if (v[i] == nullptr) { s.store_field("", "null"); } else { v[i]->store(s, ""); } } s.store_class_end(); }
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
}

storage_daemon_addByHash::ReturnType storage_daemon_addByHash::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentFull>, 1604881447>::parse(p);
#undef FAIL
}

storage_daemon_addByMeta::storage_daemon_addByMeta()
  : meta_()
  , root_dir_()
  , start_download_()
  , allow_upload_()
...
storage_daemon_addByMeta::storage_daemon_addByMeta(td::BufferSlice &&meta_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_, std::int32_t flags_)
  : meta_(std::move(meta_))
  , root_dir_(std::move(root_dir_))
  , start_download_(start_download_)
  , allow_upload_(allow_upload_)
...
const std::int32_t storage_daemon_addByMeta::ID;

object_ptr<storage_daemon_addByMeta> storage_daemon_addByMeta::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_addByMeta> res = make_object<storage_daemon_addByMeta>();
  std::int32_t var0;
  res->meta_ = TlFetchBytes<td::BufferSlice>::parse(p);
  res->root_dir_ = TlFetchString<std::string>::parse(p);
  res->start_download_ = TlFetchBool::parse(p);
  res->allow_upload_ = TlFetchBool::parse(p);
  res->priorities_ = TlFetchVector<TlFetchObject<storage_PriorityAction>>::parse(p);
...
void storage_daemon_addByMeta::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1235675554);
  TlStoreString::store(meta_, s);
  TlStoreString::store(root_dir_, s);
  TlStoreBool::store(start_download_, s);
  TlStoreBool::store(allow_upload_, s);
...
void storage_daemon_addByMeta::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1235675554);
  TlStoreString::store(meta_, s);
  TlStoreString::store(root_dir_, s);
...
void storage_daemon_addByMeta::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_addByMeta");
    s.store_bytes_field("meta", meta_);
    s.store_field("root_dir", root_dir_);
    s.store_field("start_download", start_download_);
    s.store_field("allow_upload", allow_upload_);
...
storage_daemon_addByMeta::ReturnType storage_daemon_addByMeta::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentFull>, 1604881447>::parse(p);
#undef FAIL
}

storage_daemon_closeStorageContract::storage_daemon_closeStorageContract()
  : address_()
{}

storage_daemon_closeStorageContract::storage_daemon_closeStorageContract(std::string const &address_)
  : address_(std::move(address_))
{}

const std::int32_t storage_daemon_closeStorageContract::ID;

object_ptr<storage_daemon_closeStorageContract> storage_daemon_closeStorageContract::fetch(td::TlParser &p) {
  return make_object<storage_daemon_closeStorageContract>(p);
}

storage_daemon_closeStorageContract::storage_daemon_closeStorageContract(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_closeStorageContract::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-159929584);
  TlStoreString::store(address_, s);
}

void storage_daemon_closeStorageContract::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-159929584);
  TlStoreString::store(address_, s);
}

void storage_daemon_closeStorageContract::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_closeStorageContract");
    s.store_field("address", address_);
    s.store_class_end();
  }
}

storage_daemon_closeStorageContract::ReturnType storage_daemon_closeStorageContract::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_createTorrent::storage_daemon_createTorrent()
  : path_()
  , description_()
  , allow_upload_()
  , copy_inside_()
...
storage_daemon_createTorrent::storage_daemon_createTorrent(std::string const &path_, std::string const &description_, bool allow_upload_, bool copy_inside_, std::int32_t flags_)
  : path_(std::move(path_))
  , description_(std::move(description_))
  , allow_upload_(allow_upload_)
  , copy_inside_(copy_inside_)
  , flags_(flags_)
{}

const std::int32_t storage_daemon_createTorrent::ID;

object_ptr<storage_daemon_createTorrent> storage_daemon_createTorrent::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_createTorrent> res = make_object<storage_daemon_createTorrent>();
  std::int32_t var0;
  res->path_ = TlFetchString<std::string>::parse(p);
  res->description_ = TlFetchString<std::string>::parse(p);
  res->allow_upload_ = TlFetchBool::parse(p);
  res->copy_inside_ = TlFetchBool::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
...
void storage_daemon_createTorrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1650869205);
  TlStoreString::store(path_, s);
  TlStoreString::store(description_, s);
  TlStoreBool::store(allow_upload_, s);
  TlStoreBool::store(copy_inside_, s);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_createTorrent::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1650869205);
  TlStoreString::store(path_, s);
  TlStoreString::store(description_, s);
...
void storage_daemon_createTorrent::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_createTorrent");
    s.store_field("path", path_);
    s.store_field("description", description_);
    s.store_field("allow_upload", allow_upload_);
    s.store_field("copy_inside", copy_inside_);
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
}

storage_daemon_createTorrent::ReturnType storage_daemon_createTorrent::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentFull>, 1604881447>::parse(p);
#undef FAIL
}

storage_daemon_deployProvider::storage_daemon_deployProvider() {
}

const std::int32_t storage_daemon_deployProvider::ID;

object_ptr<storage_daemon_deployProvider> storage_daemon_deployProvider::fetch(td::TlParser &p) {
  return make_object<storage_daemon_deployProvider>(p);
}

storage_daemon_deployProvider::storage_daemon_deployProvider(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_daemon_deployProvider::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(2108811237);
}

void storage_daemon_deployProvider::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(2108811237);
}

void storage_daemon_deployProvider::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_deployProvider");
    s.store_class_end();
  }
}

storage_daemon_deployProvider::ReturnType storage_daemon_deployProvider::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_providerAddress>, -2007058158>::parse(p);
#undef FAIL
}

storage_daemon_getNewContractMessage::storage_daemon_getNewContractMessage()
  : hash_()
  , query_id_()
  , params_()
{}

storage_daemon_getNewContractMessage::storage_daemon_getNewContractMessage(td::Bits256 const &hash_, std::int64_t query_id_, object_ptr<storage_daemon_NewContractParams> &&params_)
  : hash_(hash_)
  , query_id_(query_id_)
  , params_(std::move(params_))
{}

const std::int32_t storage_daemon_getNewContractMessage::ID;

object_ptr<storage_daemon_getNewContractMessage> storage_daemon_getNewContractMessage::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getNewContractMessage>(p);
}

storage_daemon_getNewContractMessage::storage_daemon_getNewContractMessage(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , query_id_(TlFetchLong::parse(p))
  , params_(TlFetchObject<storage_daemon_NewContractParams>::parse(p))
#undef FAIL
{}

void storage_daemon_getNewContractMessage::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-374603884);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(query_id_, s);
  TlStoreBoxedUnknown<TlStoreObject>::store(params_, s);
}

void storage_daemon_getNewContractMessage::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-374603884);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(query_id_, s);
...
void storage_daemon_getNewContractMessage::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getNewContractMessage");
    s.store_field("hash", hash_);
    s.store_field("query_id", query_id_);
...
storage_daemon_getNewContractMessage::ReturnType storage_daemon_getNewContractMessage::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_newContractMessage>, -175526410>::parse(p);
#undef FAIL
}

storage_daemon_getProviderInfo::storage_daemon_getProviderInfo()
  : with_balances_()
  , with_contracts_()
{}

storage_daemon_getProviderInfo::storage_daemon_getProviderInfo(bool with_balances_, bool with_contracts_)
  : with_balances_(with_balances_)
  , with_contracts_(with_contracts_)
{}

const std::int32_t storage_daemon_getProviderInfo::ID;

object_ptr<storage_daemon_getProviderInfo> storage_daemon_getProviderInfo::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getProviderInfo>(p);
}

storage_daemon_getProviderInfo::storage_daemon_getProviderInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : with_balances_(TlFetchBool::parse(p))
  , with_contracts_(TlFetchBool::parse(p))
#undef FAIL
{}

void storage_daemon_getProviderInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(859666907);
  TlStoreBool::store(with_balances_, s);
  TlStoreBool::store(with_contracts_, s);
}

void storage_daemon_getProviderInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(859666907);
  TlStoreBool::store(with_balances_, s);
  TlStoreBool::store(with_contracts_, s);
...
void storage_daemon_getProviderInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getProviderInfo");
    s.store_field("with_balances", with_balances_);
    s.store_field("with_contracts", with_contracts_);
    s.store_class_end();
  }
}

storage_daemon_getProviderInfo::ReturnType storage_daemon_getProviderInfo::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_providerInfo>, -412417747>::parse(p);
#undef FAIL
}

storage_daemon_getProviderParams::storage_daemon_getProviderParams()
  : address_()
{}

storage_daemon_getProviderParams::storage_daemon_getProviderParams(std::string const &address_)
  : address_(std::move(address_))
{}

const std::int32_t storage_daemon_getProviderParams::ID;

object_ptr<storage_daemon_getProviderParams> storage_daemon_getProviderParams::fetch(td::TlParser &p) {
  return make_object<storage_daemon_getProviderParams>(p);
}

storage_daemon_getProviderParams::storage_daemon_getProviderParams(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_getProviderParams::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1832020367);
  TlStoreString::store(address_, s);
}

void storage_daemon_getProviderParams::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1832020367);
  TlStoreString::store(address_, s);
}

void storage_daemon_getProviderParams::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getProviderParams");
    s.store_field("address", address_);
    s.store_class_end();
  }
}

storage_daemon_getProviderParams::ReturnType storage_daemon_getProviderParams::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_provider_params>, -1401721337>::parse(p);
#undef FAIL
}

storage_daemon_getSpeedLimits::storage_daemon_getSpeedLimits()
  : flags_()
{}

storage_daemon_getSpeedLimits::storage_daemon_getSpeedLimits(std::int32_t flags_)
  : flags_(flags_)
{}

const std::int32_t storage_daemon_getSpeedLimits::ID;

object_ptr<storage_daemon_getSpeedLimits> storage_daemon_getSpeedLimits::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getSpeedLimits> res = make_object<storage_daemon_getSpeedLimits>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
  return res;
...
void storage_daemon_getSpeedLimits::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1699835777);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getSpeedLimits::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1699835777);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getSpeedLimits::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getSpeedLimits");
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
}

storage_daemon_getSpeedLimits::ReturnType storage_daemon_getSpeedLimits::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_speedLimits>, -21960423>::parse(p);
#undef FAIL
}

storage_daemon_getTorrentFull::storage_daemon_getTorrentFull()
  : hash_()
  , flags_()
{}

storage_daemon_getTorrentFull::storage_daemon_getTorrentFull(td::Bits256 const &hash_, std::int32_t flags_)
  : hash_(hash_)
  , flags_(flags_)
{}

const std::int32_t storage_daemon_getTorrentFull::ID;

object_ptr<storage_daemon_getTorrentFull> storage_daemon_getTorrentFull::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getTorrentFull> res = make_object<storage_daemon_getTorrentFull>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
...
void storage_daemon_getTorrentFull::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1553612902);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getTorrentFull::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1553612902);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_getTorrentFull::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getTorrentFull");
    s.store_field("hash", hash_);
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
...
storage_daemon_getTorrentFull::ReturnType storage_daemon_getTorrentFull::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentFull>, 1604881447>::parse(p);
#undef FAIL
}

storage_daemon_getTorrentMeta::storage_daemon_getTorrentMeta()
  : hash_()
  , flags_()
{}

storage_daemon_getTorrentMeta::storage_daemon_getTorrentMeta(td::Bits256 const &hash_, std::int32_t flags_)
  : hash_(hash_)
  , flags_(flags_)
{}

const std::int32_t storage_daemon_getTorrentMeta::ID;

object_ptr<storage_daemon_getTorrentMeta> storage_daemon_getTorrentMeta::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getTorrentMeta> res = make_object<storage_daemon_getTorrentMeta>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
...
void storage_daemon_getTorrentMeta::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1935486449);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getTorrentMeta::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1935486449);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_getTorrentMeta::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getTorrentMeta");
    s.store_field("hash", hash_);
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
...
storage_daemon_getTorrentMeta::ReturnType storage_daemon_getTorrentMeta::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentMeta>, -725737752>::parse(p);
#undef FAIL
}

storage_daemon_getTorrentPeers::storage_daemon_getTorrentPeers()
  : hash_()
  , flags_()
{}

storage_daemon_getTorrentPeers::storage_daemon_getTorrentPeers(td::Bits256 const &hash_, std::int32_t flags_)
  : hash_(hash_)
  , flags_(flags_)
{}

const std::int32_t storage_daemon_getTorrentPeers::ID;

object_ptr<storage_daemon_getTorrentPeers> storage_daemon_getTorrentPeers::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getTorrentPeers> res = make_object<storage_daemon_getTorrentPeers>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
...
void storage_daemon_getTorrentPeers::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(297259161);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getTorrentPeers::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(297259161);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_getTorrentPeers::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getTorrentPeers");
    s.store_field("hash", hash_);
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
...
storage_daemon_getTorrentPeers::ReturnType storage_daemon_getTorrentPeers::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_peerList>, -1512163307>::parse(p);
#undef FAIL
}

storage_daemon_getTorrentPiecesInfo::storage_daemon_getTorrentPiecesInfo()
  : hash_()
  , flags_()
  , offset_()
  , max_pieces_()
...
storage_daemon_getTorrentPiecesInfo::storage_daemon_getTorrentPiecesInfo(td::Bits256 const &hash_, std::int32_t flags_, std::int64_t offset_, std::int64_t max_pieces_)
  : hash_(hash_)
  , flags_(flags_)
  , offset_(offset_)
  , max_pieces_(max_pieces_)
{}

const std::int32_t storage_daemon_getTorrentPiecesInfo::ID;

object_ptr<storage_daemon_getTorrentPiecesInfo> storage_daemon_getTorrentPiecesInfo::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getTorrentPiecesInfo> res = make_object<storage_daemon_getTorrentPiecesInfo>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  res->offset_ = TlFetchLong::parse(p);
  res->max_pieces_ = TlFetchLong::parse(p);
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_daemon_getTorrentPiecesInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-206784730);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
  TlStoreBinary::store(offset_, s);
  TlStoreBinary::store(max_pieces_, s);
}

void storage_daemon_getTorrentPiecesInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-206784730);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_getTorrentPiecesInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getTorrentPiecesInfo");
    s.store_field("hash", hash_);
    s.store_field("flags", (var0 = flags_));
    s.store_field("offset", offset_);
    s.store_field("max_pieces", max_pieces_);
    s.store_class_end();
  }
}

storage_daemon_getTorrentPiecesInfo::ReturnType storage_daemon_getTorrentPiecesInfo::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentPiecesInfo>, 152873873>::parse(p);
#undef FAIL
}

storage_daemon_getTorrents::storage_daemon_getTorrents()
  : flags_()
{}

storage_daemon_getTorrents::storage_daemon_getTorrents(std::int32_t flags_)
  : flags_(flags_)
{}

const std::int32_t storage_daemon_getTorrents::ID;

object_ptr<storage_daemon_getTorrents> storage_daemon_getTorrents::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_getTorrents> res = make_object<storage_daemon_getTorrents>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (p.get_error()) { FAIL(""); }
  return res;
...
void storage_daemon_getTorrents::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(590740314);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getTorrents::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(590740314);
  TlStoreBinary::store((var0 = flags_), s);
}

void storage_daemon_getTorrents::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_getTorrents");
    s.store_field("flags", (var0 = flags_));
    s.store_class_end();
  }
}

storage_daemon_getTorrents::ReturnType storage_daemon_getTorrents::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrentList>, 1327241282>::parse(p);
#undef FAIL
}

storage_daemon_importPrivateKey::storage_daemon_importPrivateKey()
  : key_()
{}

storage_daemon_importPrivateKey::storage_daemon_importPrivateKey(object_ptr<PrivateKey> &&key_)
  : key_(std::move(key_))
{}

const std::int32_t storage_daemon_importPrivateKey::ID;

object_ptr<storage_daemon_importPrivateKey> storage_daemon_importPrivateKey::fetch(td::TlParser &p) {
  return make_object<storage_daemon_importPrivateKey>(p);
}

storage_daemon_importPrivateKey::storage_daemon_importPrivateKey(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : key_(TlFetchObject<PrivateKey>::parse(p))
#undef FAIL
{}

void storage_daemon_importPrivateKey::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(2147449850);
  TlStoreBoxedUnknown<TlStoreObject>::store(key_, s);
}

void storage_daemon_importPrivateKey::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(2147449850);
  TlStoreBoxedUnknown<TlStoreObject>::store(key_, s);
}

void storage_daemon_importPrivateKey::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_importPrivateKey");
    if (key_ == nullptr) { s.store_field("key", "null"); } else { key_->store(s, "key"); }
    s.store_class_end();
  }
}

storage_daemon_importPrivateKey::ReturnType storage_daemon_importPrivateKey::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_keyHash>, -2051710244>::parse(p);
#undef FAIL
}

storage_daemon_initProvider::storage_daemon_initProvider()
  : account_address_()
{}

storage_daemon_initProvider::storage_daemon_initProvider(std::string const &account_address_)
  : account_address_(std::move(account_address_))
{}

const std::int32_t storage_daemon_initProvider::ID;

object_ptr<storage_daemon_initProvider> storage_daemon_initProvider::fetch(td::TlParser &p) {
  return make_object<storage_daemon_initProvider>(p);
}

storage_daemon_initProvider::storage_daemon_initProvider(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : account_address_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_initProvider::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(673143500);
  TlStoreString::store(account_address_, s);
}

void storage_daemon_initProvider::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(673143500);
  TlStoreString::store(account_address_, s);
}

void storage_daemon_initProvider::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_initProvider");
    s.store_field("account_address", account_address_);
    s.store_class_end();
  }
}

storage_daemon_initProvider::ReturnType storage_daemon_initProvider::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_loadFrom::storage_daemon_loadFrom()
  : hash_()
  , meta_()
  , path_()
  , flags_()
...
storage_daemon_loadFrom::storage_daemon_loadFrom(td::Bits256 const &hash_, td::BufferSlice &&meta_, std::string const &path_, std::int32_t flags_)
  : hash_(hash_)
  , meta_(std::move(meta_))
  , path_(std::move(path_))
  , flags_(flags_)
...
const std::int32_t storage_daemon_loadFrom::ID;

object_ptr<storage_daemon_loadFrom> storage_daemon_loadFrom::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_loadFrom> res = make_object<storage_daemon_loadFrom>();
  std::int32_t var0;
  res->hash_ = TlFetchInt256::parse(p);
  res->meta_ = TlFetchBytes<td::BufferSlice>::parse(p);
  res->path_ = TlFetchString<std::string>::parse(p);
...
void storage_daemon_loadFrom::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-937435609);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(meta_, s);
  TlStoreString::store(path_, s);
  TlStoreBinary::store((var0 = flags_), s);
...
void storage_daemon_loadFrom::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-937435609);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(meta_, s);
...
void storage_daemon_loadFrom::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_loadFrom");
    s.store_field("hash", hash_);
    s.store_bytes_field("meta", meta_);
    s.store_field("path", path_);
    s.store_field("flags", (var0 = flags_));
...
storage_daemon_loadFrom::ReturnType storage_daemon_loadFrom::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_torrent>, 364055399>::parse(p);
#undef FAIL
}

storage_daemon_removeStorageProvider::storage_daemon_removeStorageProvider() {
}

const std::int32_t storage_daemon_removeStorageProvider::ID;

object_ptr<storage_daemon_removeStorageProvider> storage_daemon_removeStorageProvider::fetch(td::TlParser &p) {
  return make_object<storage_daemon_removeStorageProvider>(p);
}

storage_daemon_removeStorageProvider::storage_daemon_removeStorageProvider(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_daemon_removeStorageProvider::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1121689494);
}

void storage_daemon_removeStorageProvider::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1121689494);
}

void storage_daemon_removeStorageProvider::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_removeStorageProvider");
    s.store_class_end();
  }
}

storage_daemon_removeStorageProvider::ReturnType storage_daemon_removeStorageProvider::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_removeTorrent::storage_daemon_removeTorrent()
  : hash_()
  , remove_files_()
{}

storage_daemon_removeTorrent::storage_daemon_removeTorrent(td::Bits256 const &hash_, bool remove_files_)
  : hash_(hash_)
  , remove_files_(remove_files_)
{}

const std::int32_t storage_daemon_removeTorrent::ID;

object_ptr<storage_daemon_removeTorrent> storage_daemon_removeTorrent::fetch(td::TlParser &p) {
  return make_object<storage_daemon_removeTorrent>(p);
}

storage_daemon_removeTorrent::storage_daemon_removeTorrent(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , remove_files_(TlFetchBool::parse(p))
#undef FAIL
{}

void storage_daemon_removeTorrent::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(175789147);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(remove_files_, s);
}

void storage_daemon_removeTorrent::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(175789147);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(remove_files_, s);
...
void storage_daemon_removeTorrent::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_removeTorrent");
    s.store_field("hash", hash_);
    s.store_field("remove_files", remove_files_);
    s.store_class_end();
  }
}

storage_daemon_removeTorrent::ReturnType storage_daemon_removeTorrent::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_sendCoins::storage_daemon_sendCoins()
  : address_()
  , amount_()
  , message_()
{}

storage_daemon_sendCoins::storage_daemon_sendCoins(std::string const &address_, std::string const &amount_, std::string const &message_)
  : address_(std::move(address_))
  , amount_(std::move(amount_))
  , message_(std::move(message_))
{}

const std::int32_t storage_daemon_sendCoins::ID;

object_ptr<storage_daemon_sendCoins> storage_daemon_sendCoins::fetch(td::TlParser &p) {
  return make_object<storage_daemon_sendCoins>(p);
}

storage_daemon_sendCoins::storage_daemon_sendCoins(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : address_(TlFetchString<std::string>::parse(p))
  , amount_(TlFetchString<std::string>::parse(p))
  , message_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_sendCoins::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(21329702);
  TlStoreString::store(address_, s);
  TlStoreString::store(amount_, s);
  TlStoreString::store(message_, s);
}

void storage_daemon_sendCoins::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(21329702);
  TlStoreString::store(address_, s);
  TlStoreString::store(amount_, s);
...
void storage_daemon_sendCoins::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_sendCoins");
    s.store_field("address", address_);
...
storage_daemon_sendCoins::ReturnType storage_daemon_sendCoins::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setActiveDownload::storage_daemon_setActiveDownload()
  : hash_()
  , active_()
{}

storage_daemon_setActiveDownload::storage_daemon_setActiveDownload(td::Bits256 const &hash_, bool active_)
  : hash_(hash_)
  , active_(active_)
{}

const std::int32_t storage_daemon_setActiveDownload::ID;

object_ptr<storage_daemon_setActiveDownload> storage_daemon_setActiveDownload::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setActiveDownload>(p);
}

storage_daemon_setActiveDownload::storage_daemon_setActiveDownload(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , active_(TlFetchBool::parse(p))
#undef FAIL
{}

void storage_daemon_setActiveDownload::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1954176413);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(active_, s);
}

void storage_daemon_setActiveDownload::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1954176413);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(active_, s);
...
void storage_daemon_setActiveDownload::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setActiveDownload");
    s.store_field("hash", hash_);
...
storage_daemon_setActiveDownload::ReturnType storage_daemon_setActiveDownload::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setActiveUpload::storage_daemon_setActiveUpload()
  : hash_()
  , active_()
{}

storage_daemon_setActiveUpload::storage_daemon_setActiveUpload(td::Bits256 const &hash_, bool active_)
  : hash_(hash_)
  , active_(active_)
{}

const std::int32_t storage_daemon_setActiveUpload::ID;

object_ptr<storage_daemon_setActiveUpload> storage_daemon_setActiveUpload::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setActiveUpload>(p);
}

storage_daemon_setActiveUpload::storage_daemon_setActiveUpload(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , active_(TlFetchBool::parse(p))
#undef FAIL
...
void storage_daemon_setActiveUpload::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1001305755);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(active_, s);
}

void storage_daemon_setActiveUpload::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1001305755);
  TlStoreBinary::store(hash_, s);
  TlStoreBool::store(active_, s);
...
void storage_daemon_setActiveUpload::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setActiveUpload");
    s.store_field("hash", hash_);
    s.store_field("active", active_);
    s.store_class_end();
  }
...
storage_daemon_setActiveUpload::ReturnType storage_daemon_setActiveUpload::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setFilePriorityAll::storage_daemon_setFilePriorityAll()
  : hash_()
  , priority_()
{}

storage_daemon_setFilePriorityAll::storage_daemon_setFilePriorityAll(td::Bits256 const &hash_, std::int32_t priority_)
  : hash_(hash_)
  , priority_(priority_)
{}

const std::int32_t storage_daemon_setFilePriorityAll::ID;

object_ptr<storage_daemon_setFilePriorityAll> storage_daemon_setFilePriorityAll::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setFilePriorityAll>(p);
}

storage_daemon_setFilePriorityAll::storage_daemon_setFilePriorityAll(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , priority_(TlFetchInt::parse(p))
#undef FAIL
...
void storage_daemon_setFilePriorityAll::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1921342855);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_daemon_setFilePriorityAll::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1921342855);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(priority_, s);
...
void storage_daemon_setFilePriorityAll::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setFilePriorityAll");
    s.store_field("hash", hash_);
    s.store_field("priority", priority_);
    s.store_class_end();
  }
...
storage_daemon_setFilePriorityAll::ReturnType storage_daemon_setFilePriorityAll::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchObject<storage_daemon_SetPriorityStatus>::parse(p);
#undef FAIL
}

storage_daemon_setFilePriorityByIdx::storage_daemon_setFilePriorityByIdx()
  : hash_()
  , idx_()
  , priority_()
{}

storage_daemon_setFilePriorityByIdx::storage_daemon_setFilePriorityByIdx(td::Bits256 const &hash_, std::int64_t idx_, std::int32_t priority_)
  : hash_(hash_)
  , idx_(idx_)
  , priority_(priority_)
{}

const std::int32_t storage_daemon_setFilePriorityByIdx::ID;

object_ptr<storage_daemon_setFilePriorityByIdx> storage_daemon_setFilePriorityByIdx::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setFilePriorityByIdx>(p);
}

storage_daemon_setFilePriorityByIdx::storage_daemon_setFilePriorityByIdx(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , idx_(TlFetchLong::parse(p))
  , priority_(TlFetchInt::parse(p))
...
void storage_daemon_setFilePriorityByIdx::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1134024347);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(idx_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_daemon_setFilePriorityByIdx::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1134024347);
  TlStoreBinary::store(hash_, s);
  TlStoreBinary::store(idx_, s);
...
void storage_daemon_setFilePriorityByIdx::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setFilePriorityByIdx");
    s.store_field("hash", hash_);
    s.store_field("idx", idx_);
    s.store_field("priority", priority_);
    s.store_class_end();
...
storage_daemon_setFilePriorityByIdx::ReturnType storage_daemon_setFilePriorityByIdx::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchObject<storage_daemon_SetPriorityStatus>::parse(p);
#undef FAIL
}

storage_daemon_setFilePriorityByName::storage_daemon_setFilePriorityByName()
  : hash_()
  , name_()
  , priority_()
{}

storage_daemon_setFilePriorityByName::storage_daemon_setFilePriorityByName(td::Bits256 const &hash_, std::string const &name_, std::int32_t priority_)
  : hash_(hash_)
  , name_(std::move(name_))
  , priority_(priority_)
{}

const std::int32_t storage_daemon_setFilePriorityByName::ID;

object_ptr<storage_daemon_setFilePriorityByName> storage_daemon_setFilePriorityByName::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setFilePriorityByName>(p);
}

storage_daemon_setFilePriorityByName::storage_daemon_setFilePriorityByName(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : hash_(TlFetchInt256::parse(p))
  , name_(TlFetchString<std::string>::parse(p))
  , priority_(TlFetchInt::parse(p))
...
void storage_daemon_setFilePriorityByName::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-567467319);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(name_, s);
  TlStoreBinary::store(priority_, s);
}

void storage_daemon_setFilePriorityByName::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-567467319);
  TlStoreBinary::store(hash_, s);
  TlStoreString::store(name_, s);
...
void storage_daemon_setFilePriorityByName::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setFilePriorityByName");
    s.store_field("hash", hash_);
    s.store_field("name", name_);
    s.store_field("priority", priority_);
    s.store_class_end();
...
storage_daemon_setFilePriorityByName::ReturnType storage_daemon_setFilePriorityByName::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchObject<storage_daemon_SetPriorityStatus>::parse(p);
#undef FAIL
}

storage_daemon_setProviderConfig::storage_daemon_setProviderConfig()
  : config_()
{}

storage_daemon_setProviderConfig::storage_daemon_setProviderConfig(object_ptr<storage_daemon_providerConfig> &&config_)
  : config_(std::move(config_))
{}

const std::int32_t storage_daemon_setProviderConfig::ID;

object_ptr<storage_daemon_setProviderConfig> storage_daemon_setProviderConfig::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setProviderConfig>(p);
}

storage_daemon_setProviderConfig::storage_daemon_setProviderConfig(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : config_(TlFetchObject<storage_daemon_providerConfig>::parse(p))
#undef FAIL
{}

void storage_daemon_setProviderConfig::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1918060660);
  TlStoreObject::store(config_, s);
}

void storage_daemon_setProviderConfig::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1918060660);
  TlStoreObject::store(config_, s);
}

void storage_daemon_setProviderConfig::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setProviderConfig");
    if (config_ == nullptr) { s.store_field("config", "null"); } else { config_->store(s, "config"); }
    s.store_class_end();
  }
}

storage_daemon_setProviderConfig::ReturnType storage_daemon_setProviderConfig::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setProviderParams::storage_daemon_setProviderParams()
  : params_()
{}

storage_daemon_setProviderParams::storage_daemon_setProviderParams(object_ptr<storage_daemon_provider_params> &&params_)
  : params_(std::move(params_))
{}

const std::int32_t storage_daemon_setProviderParams::ID;

object_ptr<storage_daemon_setProviderParams> storage_daemon_setProviderParams::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setProviderParams>(p);
}

storage_daemon_setProviderParams::storage_daemon_setProviderParams(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : params_(TlFetchObject<storage_daemon_provider_params>::parse(p))
#undef FAIL
{}

void storage_daemon_setProviderParams::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(1615801628);
  TlStoreObject::store(params_, s);
}

void storage_daemon_setProviderParams::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(1615801628);
  TlStoreObject::store(params_, s);
}

void storage_daemon_setProviderParams::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setProviderParams");
    if (params_ == nullptr) { s.store_field("params", "null"); } else { params_->store(s, "params"); }
    s.store_class_end();
  }
}

storage_daemon_setProviderParams::ReturnType storage_daemon_setProviderParams::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setSpeedLimits::storage_daemon_setSpeedLimits()
  : flags_()
  , download_()
  , upload_()
{}

storage_daemon_setSpeedLimits::storage_daemon_setSpeedLimits(std::int32_t flags_, double download_, double upload_)
  : flags_(flags_)
  , download_(download_)
  , upload_(upload_)
{}

const std::int32_t storage_daemon_setSpeedLimits::ID;

object_ptr<storage_daemon_setSpeedLimits> storage_daemon_setSpeedLimits::fetch(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return nullptr;
  object_ptr<storage_daemon_setSpeedLimits> res = make_object<storage_daemon_setSpeedLimits>();
  std::int32_t var0;
  if ((var0 = res->flags_ = TlFetchInt::parse(p)) < 0) { FAIL("Variable of type # can't be negative"); }
  if (var0 & 1) { res->download_ = TlFetchDouble::parse(p); }
  if (var0 & 2) { res->upload_ = TlFetchDouble::parse(p); }
  if (p.get_error()) { FAIL(""); }
  return res;
#undef FAIL
}

void storage_daemon_setSpeedLimits::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(732030954);
  TlStoreBinary::store((var0 = flags_), s);
  if (var0 & 1) { TlStoreBinary::store(download_, s); }
  if (var0 & 2) { TlStoreBinary::store(upload_, s); }
}

void storage_daemon_setSpeedLimits::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(732030954);
  TlStoreBinary::store((var0 = flags_), s);
  if (var0 & 1) { TlStoreBinary::store(download_, s); }
...
void storage_daemon_setSpeedLimits::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setSpeedLimits");
    s.store_field("flags", (var0 = flags_));
    if (var0 & 1) { s.store_field("download", download_); }
    if (var0 & 2) { s.store_field("upload", upload_); }
    s.store_class_end();
  }
}

storage_daemon_setSpeedLimits::ReturnType storage_daemon_setSpeedLimits::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_setVerbosity::storage_daemon_setVerbosity()
  : verbosity_()
{}

storage_daemon_setVerbosity::storage_daemon_setVerbosity(std::int32_t verbosity_)
  : verbosity_(verbosity_)
{}

const std::int32_t storage_daemon_setVerbosity::ID;

object_ptr<storage_daemon_setVerbosity> storage_daemon_setVerbosity::fetch(td::TlParser &p) {
  return make_object<storage_daemon_setVerbosity>(p);
}

storage_daemon_setVerbosity::storage_daemon_setVerbosity(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : verbosity_(TlFetchInt::parse(p))
#undef FAIL
{}

void storage_daemon_setVerbosity::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(649903000);
  TlStoreBinary::store(verbosity_, s);
}

void storage_daemon_setVerbosity::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(649903000);
  TlStoreBinary::store(verbosity_, s);
}

void storage_daemon_setVerbosity::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_setVerbosity");
    s.store_field("verbosity", verbosity_);
    s.store_class_end();
  }
}

storage_daemon_setVerbosity::ReturnType storage_daemon_setVerbosity::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}

storage_daemon_withdraw::storage_daemon_withdraw()
  : contract_()
{}

storage_daemon_withdraw::storage_daemon_withdraw(std::string const &contract_)
  : contract_(std::move(contract_))
{}

const std::int32_t storage_daemon_withdraw::ID;

object_ptr<storage_daemon_withdraw> storage_daemon_withdraw::fetch(td::TlParser &p) {
  return make_object<storage_daemon_withdraw>(p);
}

storage_daemon_withdraw::storage_daemon_withdraw(td::TlParser &p)
#define FAIL(error) p.set_error(error)
  : contract_(TlFetchString<std::string>::parse(p))
#undef FAIL
{}

void storage_daemon_withdraw::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-37961743);
  TlStoreString::store(contract_, s);
}

void storage_daemon_withdraw::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-37961743);
  TlStoreString::store(contract_, s);
}

void storage_daemon_withdraw::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_daemon_withdraw");
    s.store_field("contract", contract_);
    s.store_class_end();
  }
}

storage_daemon_withdraw::ReturnType storage_daemon_withdraw::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_daemon_success>, -1280381156>::parse(p);
#undef FAIL
}
...
storage_getTorrentInfo::storage_getTorrentInfo() {
}

const std::int32_t storage_getTorrentInfo::ID;

object_ptr<storage_getTorrentInfo> storage_getTorrentInfo::fetch(td::TlParser &p) {
  return make_object<storage_getTorrentInfo>(p);
}

storage_getTorrentInfo::storage_getTorrentInfo(td::TlParser &p)
#define FAIL(error) p.set_error(error)
#undef FAIL
{
  (void)p;
...
void storage_getTorrentInfo::store(td::TlStorerCalcLength &s) const {
  (void)sizeof(s);
  s.store_binary(-1849387478);
}

void storage_getTorrentInfo::store(td::TlStorerUnsafe &s) const {
  (void)sizeof(s);
  s.store_binary(-1849387478);
}

void storage_getTorrentInfo::store(td::TlStorerToString &s, const char *field_name) const {
  if (!LOG_IS_STRIPPED(ERROR)) {
    s.store_class_begin(field_name, "storage_getTorrentInfo");
    s.store_class_end();
  }
}

storage_getTorrentInfo::ReturnType storage_getTorrentInfo::fetch_result(td::TlParser &p) {
#define FAIL(error) p.set_error(error); return ReturnType()
  return TlFetchBoxed<TlFetchObject<storage_torrentInfo>, 349098222>::parse(p);
#undef FAIL
}
