...
class dht_requestReversePingCont;

class dht_ReversePingResult;
...
class engine_validator_fullNodeConfig;
...
class engine_validator_onePerfTimerStat;

class engine_validator_oneStat;

class engine_validator_overlayStats;

class engine_validator_overlayStatsNode;

class engine_validator_overlaysStats;

class engine_validator_perfTimerStats;

class engine_validator_perfTimerStatsByName;

class engine_validator_proposalVote;

class engine_validator_shardOutQueueSize;
...
class storage_PriorityAction;

class storage_state;

class storage_torrentInfo;

class storage_Update;

class storage_daemon_contractInfo;

class storage_daemon_fileInfo;

class storage_daemon_filePiecesInfo;

class storage_daemon_keyHash;

class storage_daemon_newContractMessage;

class storage_daemon_NewContractParams;

class storage_daemon_peer;

class storage_daemon_peerList;

class storage_daemon_providerAddress;

class storage_daemon_providerConfig;

class storage_daemon_providerInfo;

class storage_daemon_queryError;

class storage_daemon_SetPriorityStatus;

class storage_daemon_speedLimits;

class storage_daemon_success;

class storage_daemon_torrent;

class storage_daemon_torrentFull;

class storage_daemon_torrentList;

class storage_daemon_torrentMeta;

class storage_daemon_torrentPiecesInfo;

class storage_daemon_config;

class storage_daemon_provider_params;

class storage_db_config;

class storage_provider_db_contractAddress;

class storage_provider_db_contractList;

class storage_db_piecesInDb;

class storage_db_priorities;

class storage_db_torrentList;

class storage_db_TorrentShort;

class storage_db_key_config;

class storage_db_key_pieceInDb;

class storage_db_key_piecesInDb;

class storage_db_key_priorities;

class storage_db_key_torrentList;

class storage_db_key_torrentMeta;

class storage_db_key_torrent;

class storage_provider_db_microchunkTree;

class storage_provider_db_state;

class storage_provider_db_storageContract;

class storage_provider_db_key_contractList;

class storage_provider_db_key_microchunkTree;

class storage_provider_db_key_providerConfig;

class storage_provider_db_key_state;

class storage_provider_db_key_storageContract;
...
class tonNode_privateBlockOverlayId;
...
class validatorSession_catchainOptions;
...
class validatorSession_stats;

class validatorSession_statsProducer;

class validatorSession_statsRound;
...
class adnl_address_reverse final : public adnl_Address {
 public:

  adnl_address_reverse();

  static const std::int32_t ID = 662262406;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit adnl_address_reverse(td::TlParser &p);
...
class config_global final : public Object {
 public:
  ...
  static const std::int32_t ID = -261690960;
  std::int32_t get_id() const final {
    return ID;
  }
...
class dht_requestReversePingCont final : public Object {
 public:
  object_ptr<adnl_node> target_;
  td::BufferSlice signature_;
  td::Bits256 client_;

  dht_requestReversePingCont();

  dht_requestReversePingCont(object_ptr<adnl_node> &&target_, td::BufferSlice &&signature_, td::Bits256 const &client_);

  static const std::int32_t ID = -609369851;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<dht_requestReversePingCont> fetch(td::TlParser &p);

  explicit dht_requestReversePingCont(td::TlParser &p);
...
class dht_ReversePingResult: public Object {
 public:

  static object_ptr<dht_ReversePingResult> fetch(td::TlParser &p);
};

class dht_clientNotFound final : public dht_ReversePingResult {
 public:
  object_ptr<dht_nodes> nodes_;

  dht_clientNotFound();

  explicit dht_clientNotFound(object_ptr<dht_nodes> &&nodes_);

  static const std::int32_t ID = 756842095;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit dht_clientNotFound(td::TlParser &p);
...
class dht_reversePingOk final : public dht_ReversePingResult {
 public:

  dht_reversePingOk();

  static const std::int32_t ID = 541077666;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit dht_reversePingOk(td::TlParser &p);
...
class dht_config_Global: public Object {
 public:

  static object_ptr<dht_config_Global> fetch(td::TlParser &p);
};

class dht_config_global final : public dht_config_Global {
 public:
...
class dht_config_global_v2 final : public dht_config_Global {
 public:
  object_ptr<dht_nodes> static_nodes_;
  std::int32_t k_;
  std::int32_t a_;
  std::int32_t network_id_;

  dht_config_global_v2();

  dht_config_global_v2(object_ptr<dht_nodes> &&static_nodes_, std::int32_t k_, std::int32_t a_, std::int32_t network_id_);

  static const std::int32_t ID = 1768129575;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit dht_config_global_v2(td::TlParser &p);
...
class engine_validator_config final : public Object {
 public:
  ...
  object_ptr<engine_validator_fullNodeConfig> fullnodeconfig_;
  ...
  static const std::int32_t ID = -400613680;
  std::int32_t get_id() const final {
    return ID;
  }
...
class engine_validator_fullNodeConfig final : public Object {
 public:
  bool ext_messages_broadcast_disabled_;

  engine_validator_fullNodeConfig();

  explicit engine_validator_fullNodeConfig(bool ext_messages_broadcast_disabled_);

  static const std::int32_t ID = 704557332;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_fullNodeConfig> fetch(td::TlParser &p);

  explicit engine_validator_fullNodeConfig(td::TlParser &p);
...
class engine_validator_onePerfTimerStat final : public Object {
 public:
  std::int32_t time_;
  double min_;
  double avg_;
  ...
  engine_validator_onePerfTimerStat(std::int32_t time_, double min_, double avg_, double max_);

  static const std::int32_t ID = -1859935384;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_onePerfTimerStat> fetch(td::TlParser &p);

  explicit engine_validator_onePerfTimerStat(td::TlParser &p);
...
class engine_validator_overlayStats final : public Object {
 public:
  td::Bits256 overlay_id_;
  object_ptr<PublicKey> overlay_id_full_;
  td::Bits256 adnl_id_;
  std::string scope_;
  std::vector<object_ptr<engine_validator_overlayStatsNode>> nodes_;
  std::vector<object_ptr<engine_validator_oneStat>> stats_;

  engine_validator_overlayStats();

  engine_validator_overlayStats(td::Bits256 const &overlay_id_, object_ptr<PublicKey> &&overlay_id_full_, td::Bits256 const &adnl_id_, std::string const &scope_, std::vector<object_ptr<engine_validator_overlayStatsNode>> &&nodes_, std::vector<object_ptr<engine_validator_oneStat>> &&stats_);

  static const std::int32_t ID = -543098119;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_overlayStats> fetch(td::TlParser &p);

  explicit engine_validator_overlayStats(td::TlParser &p);
...
class engine_validator_overlayStatsNode final : public Object {
 public:
  td::Bits256 adnl_id_;
  std::string ip_addr_;
  std::int32_t bdcst_errors_;
  std::int32_t fec_bdcst_errors_;
  std::int32_t last_in_query_;
  std::int32_t last_out_query_;
  std::int32_t t_out_bytes_;
  std::int32_t t_in_bytes_;
  std::int32_t t_out_pckts_;
  std::int32_t t_in_pckts_;

  engine_validator_overlayStatsNode();

  engine_validator_overlayStatsNode(td::Bits256 const &adnl_id_, std::string const &ip_addr_, std::int32_t bdcst_errors_, std::int32_t fec_bdcst_errors_, std::int32_t last_in_query_, std::int32_t last_out_query_, std::int32_t t_out_bytes_, std::int32_t t_in_bytes_, std::int32_t t_out_pckts_, std::int32_t t_in_pckts_);

  static const std::int32_t ID = -109960999;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_overlayStatsNode> fetch(td::TlParser &p);

  explicit engine_validator_overlayStatsNode(td::TlParser &p);
...
class engine_validator_overlaysStats final : public Object {
 public:
  std::vector<object_ptr<engine_validator_overlayStats>> overlays_;

  engine_validator_overlaysStats();

  explicit engine_validator_overlaysStats(std::vector<object_ptr<engine_validator_overlayStats>> &&overlays_);

  static const std::int32_t ID = -1677121921;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_overlaysStats> fetch(td::TlParser &p);

  explicit engine_validator_overlaysStats(td::TlParser &p);
...
class engine_validator_perfTimerStats final : public Object {
 public:
  std::vector<object_ptr<engine_validator_perfTimerStatsByName>> stats_;

  engine_validator_perfTimerStats();

  explicit engine_validator_perfTimerStats(std::vector<object_ptr<engine_validator_perfTimerStatsByName>> &&stats_);

  static const std::int32_t ID = 1607488795;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_perfTimerStats> fetch(td::TlParser &p);

  explicit engine_validator_perfTimerStats(td::TlParser &p);
...
class engine_validator_perfTimerStatsByName final : public Object {
 public:
  std::string name_;
  std::vector<object_ptr<engine_validator_onePerfTimerStat>> stats_;

  engine_validator_perfTimerStatsByName();

  engine_validator_perfTimerStatsByName(std::string const &name_, std::vector<object_ptr<engine_validator_onePerfTimerStat>> &&stats_);

  static const std::int32_t ID = -2101686812;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_perfTimerStatsByName> fetch(td::TlParser &p);

  explicit engine_validator_perfTimerStatsByName(td::TlParser &p);
...
class engine_validator_shardOutQueueSize final : public Object {
 public:
  std::int32_t size_;

  engine_validator_shardOutQueueSize();

  explicit engine_validator_shardOutQueueSize(std::int32_t size_);

  static const std::int32_t ID = 266052701;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<engine_validator_shardOutQueueSize> fetch(td::TlParser &p);

  explicit engine_validator_shardOutQueueSize(td::TlParser &p);
...
class http_response final : public Object {
 public:
  ...
  http_response(std::string const &http_version_, std::int32_t status_code_, std::string const &reason_, std::vector<object_ptr<http_header>> &&headers_, bool no_payload_);

  static const std::int32_t ID = -901208246;
  std::int32_t get_id() const final {
    return ID;
  }
...
class http_proxy_capabilities final : public Object {
 public:
  std::int64_t capabilities_;

  http_proxy_capabilities();

  explicit http_proxy_capabilities(std::int64_t capabilities_);

  static const std::int32_t ID = 831679505;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<http_proxy_capabilities> fetch(td::TlParser &p);

  explicit http_proxy_capabilities(td::TlParser &p);
...
class overlay_certificateV2 final : public overlay_Certificate {
 public:
  object_ptr<PublicKey> issued_by_;
  std::int32_t expire_at_;
  std::int32_t max_size_;
  ...
  overlay_certificateV2(object_ptr<PublicKey> &&issued_by_, std::int32_t expire_at_, std::int32_t max_size_, std::int32_t flags_, td::BufferSlice &&signature_);

  static const std::int32_t ID = -1270899581;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_certificateV2(td::TlParser &p);
...
class overlay_CertificateId: public Object {
 public:

  static object_ptr<overlay_CertificateId> fetch(td::TlParser &p);
};

class overlay_certificateId final : public overlay_CertificateId {
 public:
  td::Bits256 overlay_id_;
  td::Bits256 node_;
  std::int32_t expire_at_;
...
class overlay_certificateIdV2 final : public overlay_CertificateId {
 public:
  td::Bits256 overlay_id_;
  td::Bits256 node_;
  std::int32_t expire_at_;
  ...
  overlay_certificateIdV2(td::Bits256 const &overlay_id_, td::Bits256 const &node_, std::int32_t expire_at_, std::int32_t max_size_, std::int32_t flags_);

  static const std::int32_t ID = -59977049;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit overlay_certificateIdV2(td::TlParser &p);
...
class storage_PriorityAction: public Object {
 public:

  static object_ptr<storage_PriorityAction> fetch(td::TlParser &p);
};

class storage_priorityAction_all final : public storage_PriorityAction {
 public:
  std::int32_t priority_;

  storage_priorityAction_all();

  explicit storage_priorityAction_all(std::int32_t priority_);

  static const std::int32_t ID = -31225536;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_priorityAction_all(td::TlParser &p);
...
class storage_priorityAction_idx final : public storage_PriorityAction {
 public:
  std::int64_t idx_;
  std::int32_t priority_;
  ...
  storage_priorityAction_idx(std::int64_t idx_, std::int32_t priority_);

  static const std::int32_t ID = -1794132184;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_priorityAction_idx(td::TlParser &p);
...
class storage_priorityAction_name final : public storage_PriorityAction {
 public:
  std::string name_;
  std::int32_t priority_;
  ...
  storage_priorityAction_name(std::string const &name_, std::int32_t priority_);

  static const std::int32_t ID = 19190208;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_priorityAction_name(td::TlParser &p);
...
class storage_torrentInfo final : public Object {
 public:
  td::BufferSlice data_;

  storage_torrentInfo();

  explicit storage_torrentInfo(td::BufferSlice &&data_);

  static const std::int32_t ID = 349098222;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_torrentInfo> fetch(td::TlParser &p);

  explicit storage_torrentInfo(td::TlParser &p);
...
class storage_updateInit final : public storage_Update {
 public:
  ...
  std::int32_t have_pieces_offset_;
  object_ptr<storage_state> state_;

  storage_updateInit();

  storage_updateInit(td::BufferSlice &&have_pieces_, std::int32_t have_pieces_offset_, object_ptr<storage_state> &&state_);

  static const std::int32_t ID = -835460938;
  std::int32_t get_id() const final {
    return ID;
  }
...
class storage_daemon_contractInfo final : public Object {
 public:
  std::string address_;
  std::int32_t state_;
  td::Bits256 torrent_;
  std::int32_t created_time_;
  std::int64_t file_size_;
  std::int64_t downloaded_size_;
  std::string rate_;
  std::int32_t max_span_;
  std::string client_balance_;
  std::string contract_balance_;

  storage_daemon_contractInfo();

  storage_daemon_contractInfo(std::string const &address_, std::int32_t state_, td::Bits256 const &torrent_, std::int32_t created_time_, std::int64_t file_size_, std::int64_t downloaded_size_, std::string const &rate_, std::int32_t max_span_, std::string const &client_balance_, std::string const &contract_balance_);

  static const std::int32_t ID = -680243447;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_contractInfo> fetch(td::TlParser &p);

  explicit storage_daemon_contractInfo(td::TlParser &p);
...
class storage_daemon_fileInfo final : public Object {
 public:
  std::string name_;
  std::int64_t size_;
  std::int32_t flags_;
  ...
  storage_daemon_fileInfo(std::string const &name_, std::int64_t size_, std::int32_t flags_, std::int32_t priority_, std::int64_t downloaded_size_);

  static const std::int32_t ID = 1903680510;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_fileInfo> fetch(td::TlParser &p);
...
class storage_daemon_filePiecesInfo final : public Object {
 public:
  std::string name_;
  std::int64_t range_l_;
  std::int64_t range_r_;

  storage_daemon_filePiecesInfo();

  storage_daemon_filePiecesInfo(std::string const &name_, std::int64_t range_l_, std::int64_t range_r_);

  static const std::int32_t ID = 55915843;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_filePiecesInfo> fetch(td::TlParser &p);

  explicit storage_daemon_filePiecesInfo(td::TlParser &p);
...
class storage_daemon_keyHash final : public Object {
 public:
  td::Bits256 key_hash_;

  storage_daemon_keyHash();

  explicit storage_daemon_keyHash(td::Bits256 const &key_hash_);

  static const std::int32_t ID = -2051710244;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_keyHash> fetch(td::TlParser &p);

  explicit storage_daemon_keyHash(td::TlParser &p);
...
class storage_daemon_newContractMessage final : public Object {
 public:
  ...
  storage_daemon_newContractMessage(td::BufferSlice &&body_, std::string const &rate_, std::int32_t max_span_);

  static const std::int32_t ID = -175526410;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_newContractMessage> fetch(td::TlParser &p);

  explicit storage_daemon_newContractMessage(td::TlParser &p);
...
class storage_daemon_NewContractParams: public Object {
 public:

  static object_ptr<storage_daemon_NewContractParams> fetch(td::TlParser &p);
};

class storage_daemon_newContractParams final : public storage_daemon_NewContractParams {
 public:
  std::string rate_;
  std::int32_t max_span_;
  ...
  storage_daemon_newContractParams(std::string const &rate_, std::int32_t max_span_);

  static const std::int32_t ID = 1432029316;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_newContractParams(td::TlParser &p);
...
class storage_daemon_newContractParamsAuto final : public storage_daemon_NewContractParams {
 public:
  std::string provider_address_;

  storage_daemon_newContractParamsAuto();

  explicit storage_daemon_newContractParamsAuto(std::string const &provider_address_);

  static const std::int32_t ID = -1351129171;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_newContractParamsAuto(td::TlParser &p);
...
class storage_daemon_peer final : public Object {
 public:
  td::Bits256 adnl_id_;
  std::string ip_str_;
  double download_speed_;
  double upload_speed_;
  std::int64_t ready_parts_;

  storage_daemon_peer();

  storage_daemon_peer(td::Bits256 const &adnl_id_, std::string const &ip_str_, double download_speed_, double upload_speed_, std::int64_t ready_parts_);

  static const std::int32_t ID = -1120645068;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_peer> fetch(td::TlParser &p);

  explicit storage_daemon_peer(td::TlParser &p);
...
class storage_daemon_peerList final : public Object {
 public:
  std::vector<object_ptr<storage_daemon_peer>> peers_;
  double download_speed_;
  double upload_speed_;
  std::int64_t total_parts_;

  storage_daemon_peerList();

  storage_daemon_peerList(std::vector<object_ptr<storage_daemon_peer>> &&peers_, double download_speed_, double upload_speed_, std::int64_t total_parts_);

  static const std::int32_t ID = -1512163307;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_peerList> fetch(td::TlParser &p);

  explicit storage_daemon_peerList(td::TlParser &p);
...
class storage_daemon_providerAddress final : public Object {
 public:
  std::string address_;

  storage_daemon_providerAddress();

  explicit storage_daemon_providerAddress(std::string const &address_);

  static const std::int32_t ID = -2007058158;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_providerAddress> fetch(td::TlParser &p);

  explicit storage_daemon_providerAddress(td::TlParser &p);
...
class storage_daemon_providerConfig final : public Object {
 public:
  std::int32_t max_contracts_;
  std::int64_t max_total_size_;

  storage_daemon_providerConfig();

  storage_daemon_providerConfig(std::int32_t max_contracts_, std::int64_t max_total_size_);

  static const std::int32_t ID = 2108492436;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_providerConfig> fetch(td::TlParser &p);

  explicit storage_daemon_providerConfig(td::TlParser &p);
...
class storage_daemon_providerInfo final : public Object {
 public:
  std::string address_;
  std::string balance_;
  object_ptr<storage_daemon_providerConfig> config_;
  std::int32_t contracts_count_;
  std::int64_t contracts_total_size_;
  std::vector<object_ptr<storage_daemon_contractInfo>> contracts_;

  storage_daemon_providerInfo();

  storage_daemon_providerInfo(std::string const &address_, std::string const &balance_, object_ptr<storage_daemon_providerConfig> &&config_, std::int32_t contracts_count_, std::int64_t contracts_total_size_, std::vector<object_ptr<storage_daemon_contractInfo>> &&contracts_);

  static const std::int32_t ID = -412417747;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_providerInfo> fetch(td::TlParser &p);

  explicit storage_daemon_providerInfo(td::TlParser &p);
...
class storage_daemon_queryError final : public Object {
 public:
  std::string message_;

  storage_daemon_queryError();

  explicit storage_daemon_queryError(std::string const &message_);

  static const std::int32_t ID = 79542980;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_queryError> fetch(td::TlParser &p);

  explicit storage_daemon_queryError(td::TlParser &p);
...
class storage_daemon_SetPriorityStatus: public Object {
 public:

  static object_ptr<storage_daemon_SetPriorityStatus> fetch(td::TlParser &p);
};

class storage_daemon_prioritySet final : public storage_daemon_SetPriorityStatus {
 public:

  storage_daemon_prioritySet();

  static const std::int32_t ID = -1226268713;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_prioritySet(td::TlParser &p);
...
class storage_daemon_priorityPending final : public storage_daemon_SetPriorityStatus {
 public:

  storage_daemon_priorityPending();

  static const std::int32_t ID = -2079759962;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_daemon_priorityPending(td::TlParser &p);
...
class storage_daemon_speedLimits final : public Object {
 public:
  double download_;
  double upload_;

  storage_daemon_speedLimits();

  storage_daemon_speedLimits(double download_, double upload_);

  static const std::int32_t ID = -21960423;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_speedLimits> fetch(td::TlParser &p);

  explicit storage_daemon_speedLimits(td::TlParser &p);
...
class storage_daemon_success final : public Object {
 public:

  storage_daemon_success();

  static const std::int32_t ID = -1280381156;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_success> fetch(td::TlParser &p);

  explicit storage_daemon_success(td::TlParser &p);
...
class storage_daemon_torrent final : public Object {
 public:
  td::Bits256 hash_;
  std::int32_t flags_;
  std::int64_t total_size_;
  std::string description_;
  std::int64_t files_count_;
  std::int64_t included_size_;
  std::string dir_name_;
  std::int64_t downloaded_size_;
  std::int32_t added_at_;
  std::string root_dir_;
  bool active_download_;
  bool active_upload_;
  bool completed_;
  double download_speed_;
  double upload_speed_;
  std::string fatal_error_;
  enum Flags : std::int32_t {TOTAL_SIZE_MASK = 1, DESCRIPTION_MASK = 1, FILES_COUNT_MASK = 2, INCLUDED_SIZE_MASK = 2, DIR_NAME_MASK = 2, FATAL_ERROR_MASK = 4};

  storage_daemon_torrent();

  storage_daemon_torrent(td::Bits256 const &hash_, std::int32_t flags_, std::int64_t total_size_, std::string const &description_, std::int64_t files_count_, std::int64_t included_size_, std::string const &dir_name_, std::int64_t downloaded_size_, std::int32_t added_at_, std::string const &root_dir_, bool active_download_, bool active_upload_, bool completed_, double download_speed_, double upload_speed_, std::string const &fatal_error_);

  static const std::int32_t ID = 364055399;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_torrent> fetch(td::TlParser &p);
...
class storage_daemon_torrentFull final : public Object {
 public:
  object_ptr<storage_daemon_torrent> torrent_;
  std::vector<object_ptr<storage_daemon_fileInfo>> files_;

  storage_daemon_torrentFull();

  storage_daemon_torrentFull(object_ptr<storage_daemon_torrent> &&torrent_, std::vector<object_ptr<storage_daemon_fileInfo>> &&files_);

  static const std::int32_t ID = 1604881447;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_torrentFull> fetch(td::TlParser &p);

  explicit storage_daemon_torrentFull(td::TlParser &p);
...
class storage_daemon_torrentList final : public Object {
 public:
  std::vector<object_ptr<storage_daemon_torrent>> torrents_;

  storage_daemon_torrentList();

  explicit storage_daemon_torrentList(std::vector<object_ptr<storage_daemon_torrent>> &&torrents_);

  static const std::int32_t ID = 1327241282;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_torrentList> fetch(td::TlParser &p);

  explicit storage_daemon_torrentList(td::TlParser &p);
...
class storage_daemon_torrentMeta final : public Object {
 public:
  td::BufferSlice meta_;

  storage_daemon_torrentMeta();

  explicit storage_daemon_torrentMeta(td::BufferSlice &&meta_);

  static const std::int32_t ID = -725737752;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_torrentMeta> fetch(td::TlParser &p);

  explicit storage_daemon_torrentMeta(td::TlParser &p);
...
class storage_daemon_torrentPiecesInfo final : public Object {
 public:
  std::int32_t flags_;
  std::int64_t total_pieces_;
  std::int32_t piece_size_;
  std::int64_t range_l_;
  std::int64_t range_r_;
  td::BufferSlice piece_ready_bitset_;
  std::vector<object_ptr<storage_daemon_filePiecesInfo>> files_;
  enum Flags : std::int32_t {FILES_MASK = 1};

  storage_daemon_torrentPiecesInfo();

  storage_daemon_torrentPiecesInfo(std::int32_t flags_, std::int64_t total_pieces_, std::int32_t piece_size_, std::int64_t range_l_, std::int64_t range_r_, td::BufferSlice &&piece_ready_bitset_, std::vector<object_ptr<storage_daemon_filePiecesInfo>> &&files_);

  static const std::int32_t ID = 152873873;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_torrentPiecesInfo> fetch(td::TlParser &p);
...
class storage_daemon_config final : public Object {
 public:
  object_ptr<PublicKey> server_key_;
  td::Bits256 cli_key_hash_;
  std::string provider_address_;
  object_ptr<PublicKey> adnl_id_;
  object_ptr<PublicKey> dht_id_;

  storage_daemon_config();

  storage_daemon_config(object_ptr<PublicKey> &&server_key_, td::Bits256 const &cli_key_hash_, std::string const &provider_address_, object_ptr<PublicKey> &&adnl_id_, object_ptr<PublicKey> &&dht_id_);

  static const std::int32_t ID = -255421257;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_config> fetch(td::TlParser &p);

  explicit storage_daemon_config(td::TlParser &p);
...
class storage_daemon_provider_params final : public Object {
 public:
  bool accept_new_contracts_;
  std::string rate_per_mb_day_;
  std::int32_t max_span_;
  std::int64_t minimal_file_size_;
  std::int64_t maximal_file_size_;

  storage_daemon_provider_params();

  storage_daemon_provider_params(bool accept_new_contracts_, std::string const &rate_per_mb_day_, std::int32_t max_span_, std::int64_t minimal_file_size_, std::int64_t maximal_file_size_);

  static const std::int32_t ID = -1401721337;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_daemon_provider_params> fetch(td::TlParser &p);

  explicit storage_daemon_provider_params(td::TlParser &p);
...
class storage_db_config final : public Object {
 public:
  std::int32_t flags_;
  double download_speed_limit_;
  double upload_speed_limit_;

  storage_db_config();

  storage_db_config(std::int32_t flags_, double download_speed_limit_, double upload_speed_limit_);

  static const std::int32_t ID = 1569738024;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_config> fetch(td::TlParser &p);
...
class storage_provider_db_contractAddress final : public Object {
 public:
  std::int32_t wc_;
  td::Bits256 addr_;
  ...
  storage_provider_db_contractAddress(std::int32_t wc_, td::Bits256 const &addr_);

  static const std::int32_t ID = -497488643;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_contractAddress> fetch(td::TlParser &p);

  explicit storage_provider_db_contractAddress(td::TlParser &p);
...
class storage_provider_db_contractList final : public Object {
 public:
  std::vector<object_ptr<storage_provider_db_contractAddress>> contracts_;

  storage_provider_db_contractList();

  explicit storage_provider_db_contractList(std::vector<object_ptr<storage_provider_db_contractAddress>> &&contracts_);

  static const std::int32_t ID = -633805033;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_contractList> fetch(td::TlParser &p);

  explicit storage_provider_db_contractList(td::TlParser &p);
...
class storage_db_piecesInDb final : public Object {
 public:
  std::vector<std::int64_t> pieces_;

  storage_db_piecesInDb();

  explicit storage_db_piecesInDb(std::vector<std::int64_t> &&pieces_);

  static const std::int32_t ID = 102347836;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_piecesInDb> fetch(td::TlParser &p);

  explicit storage_db_piecesInDb(td::TlParser &p);
...
class storage_db_priorities final : public Object {
 public:
  std::vector<object_ptr<storage_PriorityAction>> actions_;

  storage_db_priorities();

  explicit storage_db_priorities(std::vector<object_ptr<storage_PriorityAction>> &&actions_);

  static const std::int32_t ID = 959048526;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_priorities> fetch(td::TlParser &p);

  explicit storage_db_priorities(td::TlParser &p);
...
class storage_db_torrentList final : public Object {
 public:
  std::vector<td::Bits256> torrents_;

  storage_db_torrentList();

  explicit storage_db_torrentList(std::vector<td::Bits256> &&torrents_);

  static const std::int32_t ID = 1508893569;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_torrentList> fetch(td::TlParser &p);

  explicit storage_db_torrentList(td::TlParser &p);
...
class storage_db_TorrentShort: public Object {
 public:

  static object_ptr<storage_db_TorrentShort> fetch(td::TlParser &p);
};

class storage_db_torrent final : public storage_db_TorrentShort {
 public:
  std::string root_dir_;
  bool active_download_;
  bool active_upload_;
  ...
  storage_db_torrent(std::string const &root_dir_, bool active_download_, bool active_upload_);

  static const std::int32_t ID = -1389545574;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit storage_db_torrent(td::TlParser &p);
...
class storage_db_torrentV2 final : public storage_db_TorrentShort {
 public:
  std::int32_t flags_;
  std::string root_dir_;
  std::int32_t added_at_;
  ...
  storage_db_torrentV2();

  storage_db_torrentV2(std::int32_t flags_, std::string const &root_dir_, std::int32_t added_at_, bool active_download_, bool active_upload_);

  static const std::int32_t ID = -1980958565;
  std::int32_t get_id() const final {
    return ID;
  }
...
class storage_db_key_config final : public Object {
 public:

  storage_db_key_config();

  static const std::int32_t ID = -577227769;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_config> fetch(td::TlParser &p);

  explicit storage_db_key_config(td::TlParser &p);
...
class storage_db_key_pieceInDb final : public Object {
 public:
  td::Bits256 hash_;
  std::int64_t idx_;
  ...
  storage_db_key_pieceInDb(td::Bits256 const &hash_, std::int64_t idx_);

  static const std::int32_t ID = -1005916723;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_pieceInDb> fetch(td::TlParser &p);

  explicit storage_db_key_pieceInDb(td::TlParser &p);
...
class storage_db_key_piecesInDb final : public Object {
 public:
  td::Bits256 hash_;

  storage_db_key_piecesInDb();

  explicit storage_db_key_piecesInDb(td::Bits256 const &hash_);

  static const std::int32_t ID = -605500957;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_piecesInDb> fetch(td::TlParser &p);

  explicit storage_db_key_piecesInDb(td::TlParser &p);
...
class storage_db_key_priorities final : public Object {
 public:
  td::Bits256 hash_;

  storage_db_key_priorities();

  explicit storage_db_key_priorities(td::Bits256 const &hash_);

  static const std::int32_t ID = -1242445203;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_priorities> fetch(td::TlParser &p);

  explicit storage_db_key_priorities(td::TlParser &p);
...
class storage_db_key_torrentList final : public Object {
 public:

  storage_db_key_torrentList();

  static const std::int32_t ID = -876156842;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_torrentList> fetch(td::TlParser &p);

  explicit storage_db_key_torrentList(td::TlParser &p);
...
class storage_db_key_torrentMeta final : public Object {
 public:
  td::Bits256 hash_;

  storage_db_key_torrentMeta();

  explicit storage_db_key_torrentMeta(td::Bits256 const &hash_);

  static const std::int32_t ID = 1646501222;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_torrentMeta> fetch(td::TlParser &p);

  explicit storage_db_key_torrentMeta(td::TlParser &p);
...
class storage_db_key_torrent final : public Object {
 public:
  td::Bits256 hash_;

  storage_db_key_torrent();

  explicit storage_db_key_torrent(td::Bits256 const &hash_);

  static const std::int32_t ID = -1182264785;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_db_key_torrent> fetch(td::TlParser &p);

  explicit storage_db_key_torrent(td::TlParser &p);
...
class storage_provider_db_microchunkTree final : public Object {
 public:
  td::BufferSlice data_;

  storage_provider_db_microchunkTree();

  explicit storage_provider_db_microchunkTree(td::BufferSlice &&data_);

  static const std::int32_t ID = -1026945214;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_microchunkTree> fetch(td::TlParser &p);

  explicit storage_provider_db_microchunkTree(td::TlParser &p);
...
class storage_provider_db_state final : public Object {
 public:
  std::int64_t last_processed_lt_;

  storage_provider_db_state();

  explicit storage_provider_db_state(std::int64_t last_processed_lt_);

  static const std::int32_t ID = 27874803;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_state> fetch(td::TlParser &p);

  explicit storage_provider_db_state(td::TlParser &p);
...
class storage_provider_db_storageContract final : public Object {
 public:
  td::Bits256 torrent_hash_;
  td::Bits256 microchunk_hash_;
  std::int32_t created_time_;
  std::int32_t state_;
  std::int64_t file_size_;
  std::string rate_;
  ...
  storage_provider_db_storageContract(td::Bits256 const &torrent_hash_, td::Bits256 const &microchunk_hash_, std::int32_t created_time_, std::int32_t state_, std::int64_t file_size_, std::string const &rate_, std::int32_t max_span_);

  static const std::int32_t ID = -290216142;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_storageContract> fetch(td::TlParser &p);

  explicit storage_provider_db_storageContract(td::TlParser &p);
...
class storage_provider_db_key_contractList final : public Object {
 public:

  storage_provider_db_key_contractList();

  static const std::int32_t ID = 1435683910;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_key_contractList> fetch(td::TlParser &p);

  explicit storage_provider_db_key_contractList(td::TlParser &p);
...
class storage_provider_db_key_microchunkTree final : public Object {
 public:
  std::int32_t wc_;
  td::Bits256 addr_;
  ...
  storage_provider_db_key_microchunkTree(std::int32_t wc_, td::Bits256 const &addr_);

  static const std::int32_t ID = 697887353;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_key_microchunkTree> fetch(td::TlParser &p);

  explicit storage_provider_db_key_microchunkTree(td::TlParser &p);
...
class storage_provider_db_key_providerConfig final : public Object {
 public:

  storage_provider_db_key_providerConfig();

  static const std::int32_t ID = -404223694;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_key_providerConfig> fetch(td::TlParser &p);

  explicit storage_provider_db_key_providerConfig(td::TlParser &p);
...
class storage_provider_db_key_state final : public Object {
 public:

  storage_provider_db_key_state();

  static const std::int32_t ID = -199176286;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_key_state> fetch(td::TlParser &p);

  explicit storage_provider_db_key_state(td::TlParser &p);
...
class storage_provider_db_key_storageContract final : public Object {
 public:
  std::int32_t wc_;
  td::Bits256 addr_;
  ...
  storage_provider_db_key_storageContract(std::int32_t wc_, td::Bits256 const &addr_);

  static const std::int32_t ID = -866202850;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<storage_provider_db_key_storageContract> fetch(td::TlParser &p);

  explicit storage_provider_db_key_storageContract(td::TlParser &p);
...
class tonNode_privateBlockOverlayId final : public Object {
 public:
  td::Bits256 zero_state_file_hash_;
  std::vector<td::Bits256> nodes_;

  tonNode_privateBlockOverlayId();

  tonNode_privateBlockOverlayId(td::Bits256 const &zero_state_file_hash_, std::vector<td::Bits256> &&nodes_);

  static const std::int32_t ID = -1493903262;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<tonNode_privateBlockOverlayId> fetch(td::TlParser &p);

  explicit tonNode_privateBlockOverlayId(td::TlParser &p);
...
class validatorSession_catchainOptions final : public Object {
 public:
  double idle_timeout_;
  std::int32_t max_deps_;
  std::int32_t max_block_size_;
  bool block_hash_covers_data_;
  std::int32_t max_block_height_ceoff_;
  bool debug_disable_db_;

  validatorSession_catchainOptions();

  validatorSession_catchainOptions(double idle_timeout_, std::int32_t max_deps_, std::int32_t max_block_size_, bool block_hash_covers_data_, std::int32_t max_block_height_ceoff_, bool debug_disable_db_);

  static const std::int32_t ID = 1893878246;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorSession_catchainOptions> fetch(td::TlParser &p);

  explicit validatorSession_catchainOptions(td::TlParser &p);
...
class validatorSession_configVersioned final : public validatorSession_Config {
 public:
  double catchain_idle_timeout_;
  std::int32_t catchain_max_deps_;
  std::int32_t round_candidates_;
  ...
  validatorSession_configVersioned(double catchain_idle_timeout_, std::int32_t catchain_max_deps_, std::int32_t round_candidates_, double next_candidate_delay_, std::int32_t round_attempt_duration_, std::int32_t max_round_attempts_, std::int32_t max_block_size_, std::int32_t max_collated_data_size_, std::int32_t version_);

  static const std::int32_t ID = 1076532995;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit validatorSession_configVersioned(td::TlParser &p);
...
class validatorSession_configVersionedV2 final : public validatorSession_Config {
 public:
  object_ptr<validatorSession_catchainOptions> catchain_opts_;
  std::int32_t round_candidates_;
  double next_candidate_delay_;
  std::int32_t round_attempt_duration_;
  std::int32_t max_round_attempts_;
  ...
  validatorSession_configVersionedV2(object_ptr<validatorSession_catchainOptions> &&catchain_opts_, std::int32_t round_candidates_, double next_candidate_delay_, std::int32_t round_attempt_duration_, std::int32_t max_round_attempts_, std::int32_t max_block_size_, std::int32_t max_collated_data_size_, std::int32_t version_);

  static const std::int32_t ID = -1451552337;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  explicit validatorSession_configVersionedV2(td::TlParser &p);
...
class validatorSession_stats final : public Object {
 public:
  object_ptr<tonNode_blockId> id_;
  std::int64_t timestamp_;
  td::Bits256 self_;
  td::Bits256 creator_;
  std::int32_t total_validators_;
  std::int64_t total_weight_;
  std::int32_t signatures_;
  std::int64_t signatures_weight_;
  std::int32_t approve_signatures_;
  std::int64_t approve_signatures_weight_;
  std::int32_t first_round_;
  std::vector<object_ptr<validatorSession_statsRound>> rounds_;

  validatorSession_stats();

  validatorSession_stats(object_ptr<tonNode_blockId> &&id_, std::int64_t timestamp_, td::Bits256 const &self_, td::Bits256 const &creator_, std::int32_t total_validators_, std::int64_t total_weight_, std::int32_t signatures_, std::int64_t signatures_weight_, std::int32_t approve_signatures_, std::int64_t approve_signatures_weight_, std::int32_t first_round_, std::vector<object_ptr<validatorSession_statsRound>> &&rounds_);

  static const std::int32_t ID = 1749899919;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorSession_stats> fetch(td::TlParser &p);

  explicit validatorSession_stats(td::TlParser &p);
...
class validatorSession_statsProducer final : public Object {
 public:
  td::Bits256 id_;
  std::int32_t block_status_;
  std::int64_t block_timestamp_;

  validatorSession_statsProducer();

  validatorSession_statsProducer(td::Bits256 const &id_, std::int32_t block_status_, std::int64_t block_timestamp_);

  static const std::int32_t ID = -1912887795;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorSession_statsProducer> fetch(td::TlParser &p);

  explicit validatorSession_statsProducer(td::TlParser &p);
...
class validatorSession_statsRound final : public Object {
 public:
  std::int64_t timestamp_;
  std::vector<object_ptr<validatorSession_statsProducer>> producers_;

  validatorSession_statsRound();

  validatorSession_statsRound(std::int64_t timestamp_, std::vector<object_ptr<validatorSession_statsProducer>> &&producers_);

  static const std::int32_t ID = -1557143706;
  std::int32_t get_id() const final {
    return ID;
  }

  static object_ptr<validatorSession_statsRound> fetch(td::TlParser &p);

  explicit validatorSession_statsRound(td::TlParser &p);
...
class dht_registerReverseConnection final : public Function {
 public:
  object_ptr<PublicKey> node_;
  std::int32_t ttl_;
  td::BufferSlice signature_;

  dht_registerReverseConnection();

  dht_registerReverseConnection(object_ptr<PublicKey> &&node_, std::int32_t ttl_, td::BufferSlice &&signature_);

  static const std::int32_t ID = 573357153;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<dht_registerReverseConnection> fetch(td::TlParser &p);

  explicit dht_registerReverseConnection(td::TlParser &p);
...
class dht_requestReversePing final : public Function {
 public:
  object_ptr<adnl_node> target_;
  td::BufferSlice signature_;
  td::Bits256 client_;
  ...
  dht_requestReversePing(object_ptr<adnl_node> &&target_, td::BufferSlice &&signature_, td::Bits256 const &client_, std::int32_t k_);

  static const std::int32_t ID = 194290698;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<dht_ReversePingResult>;

  static object_ptr<dht_requestReversePing> fetch(td::TlParser &p);

  explicit dht_requestReversePing(td::TlParser &p);
...
class engine_validator_getOverlaysStats final : public Function {
 public:

  engine_validator_getOverlaysStats();

  static const std::int32_t ID = -52908850;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_overlaysStats>;

  static object_ptr<engine_validator_getOverlaysStats> fetch(td::TlParser &p);

  explicit engine_validator_getOverlaysStats(td::TlParser &p);
...
class engine_validator_getPerfTimerStats final : public Function {
 public:
  std::string name_;

  engine_validator_getPerfTimerStats();

  explicit engine_validator_getPerfTimerStats(std::string const &name_);

  static const std::int32_t ID = -364709649;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_perfTimerStats>;

  static object_ptr<engine_validator_getPerfTimerStats> fetch(td::TlParser &p);

  explicit engine_validator_getPerfTimerStats(td::TlParser &p);
...
class engine_validator_getShardOutQueueSize final : public Function {
 public:
  std::int32_t flags_;
  object_ptr<tonNode_blockId> block_id_;
  std::int32_t dest_wc_;
  std::int64_t dest_shard_;
  enum Flags : std::int32_t {DEST_WC_MASK = 1, DEST_SHARD_MASK = 1};
  mutable std::int32_t var0;

  engine_validator_getShardOutQueueSize();

  engine_validator_getShardOutQueueSize(std::int32_t flags_, object_ptr<tonNode_blockId> &&block_id_, std::int32_t dest_wc_, std::int64_t dest_shard_);

  static const std::int32_t ID = 1537301584;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<engine_validator_shardOutQueueSize>;

  static object_ptr<engine_validator_getShardOutQueueSize> fetch(td::TlParser &p);
...
class engine_validator_importCertificate final : public Function {
 public:
  td::Bits256 overlay_id_;
  object_ptr<adnl_id_short> local_id_;
  object_ptr<engine_validator_keyHash> signed_key_;
  object_ptr<overlay_Certificate> cert_;

  engine_validator_importCertificate();

  engine_validator_importCertificate(td::Bits256 const &overlay_id_, object_ptr<adnl_id_short> &&local_id_, object_ptr<engine_validator_keyHash> &&signed_key_, object_ptr<overlay_Certificate> &&cert_);

  static const std::int32_t ID = 1015201999;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_importCertificate> fetch(td::TlParser &p);

  explicit engine_validator_importCertificate(td::TlParser &p);
...
class engine_validator_importShardOverlayCertificate final : public Function {
 public:
  std::int32_t workchain_;
  std::int64_t shard_;
  object_ptr<engine_validator_keyHash> signed_key_;
  ...
  engine_validator_importShardOverlayCertificate(std::int32_t workchain_, std::int64_t shard_, object_ptr<engine_validator_keyHash> &&signed_key_, object_ptr<overlay_Certificate> &&cert_);

  static const std::int32_t ID = 448989784;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_importShardOverlayCertificate> fetch(td::TlParser &p);

  explicit engine_validator_importShardOverlayCertificate(td::TlParser &p);
...
class engine_validator_setExtMessagesBroadcastDisabled final : public Function {
 public:
  bool disabled_;

  engine_validator_setExtMessagesBroadcastDisabled();

  explicit engine_validator_setExtMessagesBroadcastDisabled(bool disabled_);

  static const std::int32_t ID = -1970206246;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<engine_validator_setExtMessagesBroadcastDisabled> fetch(td::TlParser &p);

  explicit engine_validator_setExtMessagesBroadcastDisabled(td::TlParser &p);
...
class engine_validator_signShardOverlayCertificate final : public Function {
 public:
  std::int32_t workchain_;
  std::int64_t shard_;
  object_ptr<engine_validator_keyHash> signed_key_;
  ...
  engine_validator_signShardOverlayCertificate(std::int32_t workchain_, std::int64_t shard_, object_ptr<engine_validator_keyHash> &&signed_key_, std::int32_t expire_at_, std::int32_t max_size_);

  static const std::int32_t ID = 1553415254;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<overlay_Certificate>;

  static object_ptr<engine_validator_signShardOverlayCertificate> fetch(td::TlParser &p);

  explicit engine_validator_signShardOverlayCertificate(td::TlParser &p);
...
class http_proxy_getCapabilities final : public Function {
 public:
  std::int64_t capabilities_;

  http_proxy_getCapabilities();

  explicit http_proxy_getCapabilities(std::int64_t capabilities_);

  static const std::int32_t ID = -613277815;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<http_proxy_capabilities>;

  static object_ptr<http_proxy_getCapabilities> fetch(td::TlParser &p);

  explicit http_proxy_getCapabilities(td::TlParser &p);
...
class storage_daemon_addByHash final : public Function {
 public:
  td::Bits256 hash_;
  std::string root_dir_;
  bool start_download_;
  bool allow_upload_;
  std::vector<object_ptr<storage_PriorityAction>> priorities_;
  std::int32_t flags_;
  mutable std::int32_t var0;

  storage_daemon_addByHash();

  storage_daemon_addByHash(td::Bits256 const &hash_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_, std::int32_t flags_);

  static const std::int32_t ID = -1254791010;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_torrentFull>;

  static object_ptr<storage_daemon_addByHash> fetch(td::TlParser &p);
...
class storage_daemon_addByMeta final : public Function {
 public:
  td::BufferSlice meta_;
  std::string root_dir_;
  bool start_download_;
  ...
  storage_daemon_addByMeta(td::BufferSlice &&meta_, std::string const &root_dir_, bool start_download_, bool allow_upload_, std::vector<object_ptr<storage_PriorityAction>> &&priorities_, std::int32_t flags_);

  static const std::int32_t ID = -1235675554;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_addByMeta> fetch(td::TlParser &p);
...
class storage_daemon_closeStorageContract final : public Function {
 public:
  std::string address_;

  storage_daemon_closeStorageContract();

  explicit storage_daemon_closeStorageContract(std::string const &address_);

  static const std::int32_t ID = -159929584;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_success>;

  static object_ptr<storage_daemon_closeStorageContract> fetch(td::TlParser &p);

  explicit storage_daemon_closeStorageContract(td::TlParser &p);
...
class storage_daemon_createTorrent final : public Function {
 public:
  std::string path_;
  std::string description_;
  bool allow_upload_;
  ...
  storage_daemon_createTorrent(std::string const &path_, std::string const &description_, bool allow_upload_, bool copy_inside_, std::int32_t flags_);

  static const std::int32_t ID = -1650869205;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_createTorrent> fetch(td::TlParser &p);
...
class storage_daemon_deployProvider final : public Function {
 public:

  storage_daemon_deployProvider();

  static const std::int32_t ID = 2108811237;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_providerAddress>;

  static object_ptr<storage_daemon_deployProvider> fetch(td::TlParser &p);

  explicit storage_daemon_deployProvider(td::TlParser &p);
...
class storage_daemon_getNewContractMessage final : public Function {
 public:
  td::Bits256 hash_;
  std::int64_t query_id_;
  object_ptr<storage_daemon_NewContractParams> params_;

  storage_daemon_getNewContractMessage();

  storage_daemon_getNewContractMessage(td::Bits256 const &hash_, std::int64_t query_id_, object_ptr<storage_daemon_NewContractParams> &&params_);

  static const std::int32_t ID = -374603884;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_newContractMessage>;

  static object_ptr<storage_daemon_getNewContractMessage> fetch(td::TlParser &p);

  explicit storage_daemon_getNewContractMessage(td::TlParser &p);
...
class storage_daemon_getProviderInfo final : public Function {
 public:
  bool with_balances_;
  bool with_contracts_;

  storage_daemon_getProviderInfo();

  storage_daemon_getProviderInfo(bool with_balances_, bool with_contracts_);

  static const std::int32_t ID = 859666907;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_providerInfo>;

  static object_ptr<storage_daemon_getProviderInfo> fetch(td::TlParser &p);

  explicit storage_daemon_getProviderInfo(td::TlParser &p);
...
class storage_daemon_getProviderParams final : public Function {
 public:
  std::string address_;

  storage_daemon_getProviderParams();

  explicit storage_daemon_getProviderParams(std::string const &address_);

  static const std::int32_t ID = -1832020367;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_provider_params>;

  static object_ptr<storage_daemon_getProviderParams> fetch(td::TlParser &p);

  explicit storage_daemon_getProviderParams(td::TlParser &p);
...
class storage_daemon_getSpeedLimits final : public Function {
 public:
  std::int32_t flags_;
  mutable std::int32_t var0;

  storage_daemon_getSpeedLimits();

  explicit storage_daemon_getSpeedLimits(std::int32_t flags_);

  static const std::int32_t ID = -1699835777;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_speedLimits>;

  static object_ptr<storage_daemon_getSpeedLimits> fetch(td::TlParser &p);
...
class storage_daemon_getTorrentFull final : public Function {
 public:
  td::Bits256 hash_;
  std::int32_t flags_;
  mutable std::int32_t var0;
  ...
  storage_daemon_getTorrentFull(td::Bits256 const &hash_, std::int32_t flags_);

  static const std::int32_t ID = 1553612902;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_getTorrentFull> fetch(td::TlParser &p);
...
class storage_daemon_getTorrentMeta final : public Function {
 public:
  td::Bits256 hash_;
  std::int32_t flags_;
  mutable std::int32_t var0;
  ...
  storage_daemon_getTorrentMeta(td::Bits256 const &hash_, std::int32_t flags_);

  static const std::int32_t ID = 1935486449;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_torrentMeta>;

  static object_ptr<storage_daemon_getTorrentMeta> fetch(td::TlParser &p);
...
class storage_daemon_getTorrentPeers final : public Function {
 public:
  td::Bits256 hash_;
  std::int32_t flags_;
  mutable std::int32_t var0;
  ...
  storage_daemon_getTorrentPeers(td::Bits256 const &hash_, std::int32_t flags_);

  static const std::int32_t ID = 297259161;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_peerList>;

  static object_ptr<storage_daemon_getTorrentPeers> fetch(td::TlParser &p);
...
class storage_daemon_getTorrentPiecesInfo final : public Function {
 public:
  td::Bits256 hash_;
  std::int32_t flags_;
  std::int64_t offset_;
  std::int64_t max_pieces_;
  mutable std::int32_t var0;

  storage_daemon_getTorrentPiecesInfo();

  storage_daemon_getTorrentPiecesInfo(td::Bits256 const &hash_, std::int32_t flags_, std::int64_t offset_, std::int64_t max_pieces_);

  static const std::int32_t ID = -206784730;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_torrentPiecesInfo>;

  static object_ptr<storage_daemon_getTorrentPiecesInfo> fetch(td::TlParser &p);
...
class storage_daemon_getTorrents final : public Function {
 public:
  std::int32_t flags_;
  mutable std::int32_t var0;
  ...
  explicit storage_daemon_getTorrents(std::int32_t flags_);

  static const std::int32_t ID = 590740314;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_torrentList>;

  static object_ptr<storage_daemon_getTorrents> fetch(td::TlParser &p);
...
class storage_daemon_importPrivateKey final : public Function {
 public:
  object_ptr<PrivateKey> key_;

  storage_daemon_importPrivateKey();

  explicit storage_daemon_importPrivateKey(object_ptr<PrivateKey> &&key_);

  static const std::int32_t ID = 2147449850;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_keyHash>;

  static object_ptr<storage_daemon_importPrivateKey> fetch(td::TlParser &p);

  explicit storage_daemon_importPrivateKey(td::TlParser &p);
...
class storage_daemon_initProvider final : public Function {
 public:
  std::string account_address_;

  storage_daemon_initProvider();

  explicit storage_daemon_initProvider(std::string const &account_address_);

  static const std::int32_t ID = 673143500;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_initProvider> fetch(td::TlParser &p);

  explicit storage_daemon_initProvider(td::TlParser &p);
...
class storage_daemon_loadFrom final : public Function {
 public:
  td::Bits256 hash_;
  td::BufferSlice meta_;
  std::string path_;
  ...
  storage_daemon_loadFrom(td::Bits256 const &hash_, td::BufferSlice &&meta_, std::string const &path_, std::int32_t flags_);

  static const std::int32_t ID = -937435609;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_torrent>;

  static object_ptr<storage_daemon_loadFrom> fetch(td::TlParser &p);
...
class storage_daemon_removeStorageProvider final : public Function {
 public:

  storage_daemon_removeStorageProvider();

  static const std::int32_t ID = 1121689494;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_removeStorageProvider> fetch(td::TlParser &p);

  explicit storage_daemon_removeStorageProvider(td::TlParser &p);
...
class storage_daemon_removeTorrent final : public Function {
 public:
  td::Bits256 hash_;
  bool remove_files_;
  ...
  storage_daemon_removeTorrent(td::Bits256 const &hash_, bool remove_files_);

  static const std::int32_t ID = 175789147;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_removeTorrent> fetch(td::TlParser &p);

  explicit storage_daemon_removeTorrent(td::TlParser &p);
...
class storage_daemon_sendCoins final : public Function {
 public:
  std::string address_;
  std::string amount_;
  std::string message_;
  ...
  storage_daemon_sendCoins(std::string const &address_, std::string const &amount_, std::string const &message_);

  static const std::int32_t ID = 21329702;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_sendCoins> fetch(td::TlParser &p);

  explicit storage_daemon_sendCoins(td::TlParser &p);
...
class storage_daemon_setActiveDownload final : public Function {
 public:
  td::Bits256 hash_;
  bool active_;
  ...
  storage_daemon_setActiveDownload(td::Bits256 const &hash_, bool active_);

  static const std::int32_t ID = 1954176413;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setActiveDownload> fetch(td::TlParser &p);

  explicit storage_daemon_setActiveDownload(td::TlParser &p);
...
class storage_daemon_setActiveUpload final : public Function {
 public:
  td::Bits256 hash_;
  bool active_;
  ...
  storage_daemon_setActiveUpload(td::Bits256 const &hash_, bool active_);

  static const std::int32_t ID = 1001305755;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setActiveUpload> fetch(td::TlParser &p);

  explicit storage_daemon_setActiveUpload(td::TlParser &p);
...
class storage_daemon_setFilePriorityAll final : public Function {
 public:
  td::Bits256 hash_;
  std::int32_t priority_;
  ...
  storage_daemon_setFilePriorityAll(td::Bits256 const &hash_, std::int32_t priority_);

  static const std::int32_t ID = -1921342855;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_daemon_SetPriorityStatus>;

  static object_ptr<storage_daemon_setFilePriorityAll> fetch(td::TlParser &p);

  explicit storage_daemon_setFilePriorityAll(td::TlParser &p);
...
class storage_daemon_setFilePriorityByIdx final : public Function {
 public:
  td::Bits256 hash_;
  std::int64_t idx_;
  std::int32_t priority_;
  ...
  storage_daemon_setFilePriorityByIdx(td::Bits256 const &hash_, std::int64_t idx_, std::int32_t priority_);

  static const std::int32_t ID = 1134024347;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setFilePriorityByIdx> fetch(td::TlParser &p);

  explicit storage_daemon_setFilePriorityByIdx(td::TlParser &p);
...
class storage_daemon_setFilePriorityByName final : public Function {
 public:
  td::Bits256 hash_;
  std::string name_;
  std::int32_t priority_;
  ...
  storage_daemon_setFilePriorityByName(td::Bits256 const &hash_, std::string const &name_, std::int32_t priority_);

  static const std::int32_t ID = -567467319;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setFilePriorityByName> fetch(td::TlParser &p);

  explicit storage_daemon_setFilePriorityByName(td::TlParser &p);
...
class storage_daemon_setProviderConfig final : public Function {
 public:
  object_ptr<storage_daemon_providerConfig> config_;

  storage_daemon_setProviderConfig();

  explicit storage_daemon_setProviderConfig(object_ptr<storage_daemon_providerConfig> &&config_);

  static const std::int32_t ID = -1918060660;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setProviderConfig> fetch(td::TlParser &p);

  explicit storage_daemon_setProviderConfig(td::TlParser &p);
...
class storage_daemon_setProviderParams final : public Function {
 public:
  object_ptr<storage_daemon_provider_params> params_;

  storage_daemon_setProviderParams();

  explicit storage_daemon_setProviderParams(object_ptr<storage_daemon_provider_params> &&params_);

  static const std::int32_t ID = 1615801628;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setProviderParams> fetch(td::TlParser &p);

  explicit storage_daemon_setProviderParams(td::TlParser &p);
...
class storage_daemon_setSpeedLimits final : public Function {
 public:
  std::int32_t flags_;
  double download_;
  double upload_;
  enum Flags : std::int32_t {DOWNLOAD_MASK = 1, UPLOAD_MASK = 2};
  mutable std::int32_t var0;

  storage_daemon_setSpeedLimits();

  storage_daemon_setSpeedLimits(std::int32_t flags_, double download_, double upload_);

  static const std::int32_t ID = 732030954;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setSpeedLimits> fetch(td::TlParser &p);
...
class storage_daemon_setVerbosity final : public Function {
 public:
  std::int32_t verbosity_;

  storage_daemon_setVerbosity();

  explicit storage_daemon_setVerbosity(std::int32_t verbosity_);

  static const std::int32_t ID = 649903000;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_setVerbosity> fetch(td::TlParser &p);

  explicit storage_daemon_setVerbosity(td::TlParser &p);
...
class storage_daemon_withdraw final : public Function {
 public:
  std::string contract_;

  storage_daemon_withdraw();

  explicit storage_daemon_withdraw(std::string const &contract_);

  static const std::int32_t ID = -37961743;
  std::int32_t get_id() const final {
    return ID;
  }
  ...
  static object_ptr<storage_daemon_withdraw> fetch(td::TlParser &p);

  explicit storage_daemon_withdraw(td::TlParser &p);
...
class storage_getTorrentInfo final : public Function {
 public:

  storage_getTorrentInfo();

  static const std::int32_t ID = -1849387478;
  std::int32_t get_id() const final {
    return ID;
  }

  using ReturnType = object_ptr<storage_torrentInfo>;

  static object_ptr<storage_getTorrentInfo> fetch(td::TlParser &p);

  explicit storage_getTorrentInfo(td::TlParser &p);
