...
int Coins::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool Coins::skip(vm::CellSlice& cs) const {
  return t_Grams.skip(cs);
}

bool Coins::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_Grams.validate_skip(ops, cs, weak);
}

bool Coins::unpack(vm::CellSlice& cs, Coins::Record& data) const {
  return t_Grams.fetch_to(cs, data.grams);
}

bool Coins::unpack_cons1(vm::CellSlice& cs, Ref<CellSlice>& grams) const {
  return t_Grams.fetch_to(cs, grams);
}

bool Coins::cell_unpack(Ref<vm::Cell> cell_ref, Coins::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool Coins::cell_unpack_cons1(Ref<vm::Cell> cell_ref, Ref<CellSlice>& grams) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons1(cs, grams) && cs.empty_ext();
}

bool Coins::pack(vm::CellBuilder& cb, const Coins::Record& data) const {
  return t_Grams.store_from(cb, data.grams);
}

bool Coins::pack_cons1(vm::CellBuilder& cb, Ref<CellSlice> grams) const {
  return t_Grams.store_from(cb, grams);
}

bool Coins::cell_pack(Ref<vm::Cell>& cell_ref, const Coins::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool Coins::cell_pack_cons1(Ref<vm::Cell>& cell_ref, Ref<CellSlice> grams) const {
  vm::CellBuilder cb;
  return pack_cons1(cb, std::move(grams)) && std::move(cb).finalize_to(cell_ref);
}

bool Coins::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
      && pp.field("grams")
...
bool StateInit::unpack(vm::CellSlice& cs, StateInit::Record& data) const {
  return t_Maybe_natwidth_5.fetch_to(cs, data.split_depth)
      ...
      && t_Maybe_Ref_Cell.fetch_to(cs, data.library);
}
...
bool StateInit::pack(vm::CellBuilder& cb, const StateInit::Record& data) const {
  return t_Maybe_natwidth_5.store_from(cb, data.split_depth)
      ...
      && t_Maybe_Ref_Cell.store_from(cb, data.library);
}
...
//
// code for type `StateInitWithLibs`
//

int StateInitWithLibs::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool StateInitWithLibs::skip(vm::CellSlice& cs) const {
  return t_Maybe_natwidth_5.skip(cs)
      && t_Maybe_TickTock.skip(cs)
      && t_Maybe_Ref_Cell.skip(cs)
      && t_Maybe_Ref_Cell.skip(cs)
...
bool StateInitWithLibs::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_Maybe_natwidth_5.validate_skip(ops, cs, weak)
      && t_Maybe_TickTock.validate_skip(ops, cs, weak)
      && t_Maybe_Ref_Cell.validate_skip(ops, cs, weak)
      && t_Maybe_Ref_Cell.validate_skip(ops, cs, weak)
...
bool StateInitWithLibs::unpack(vm::CellSlice& cs, StateInitWithLibs::Record& data) const {
  return t_Maybe_natwidth_5.fetch_to(cs, data.split_depth)
      && t_Maybe_TickTock.fetch_to(cs, data.special)
      && t_Maybe_Ref_Cell.fetch_to(cs, data.code)
      && t_Maybe_Ref_Cell.fetch_to(cs, data.data)
...
bool StateInitWithLibs::cell_unpack(Ref<vm::Cell> cell_ref, StateInitWithLibs::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool StateInitWithLibs::pack(vm::CellBuilder& cb, const StateInitWithLibs::Record& data) const {
  return t_Maybe_natwidth_5.store_from(cb, data.split_depth)
      && t_Maybe_TickTock.store_from(cb, data.special)
      && t_Maybe_Ref_Cell.store_from(cb, data.code)
      && t_Maybe_Ref_Cell.store_from(cb, data.data)
...
bool StateInitWithLibs::cell_pack(Ref<vm::Cell>& cell_ref, const StateInitWithLibs::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool StateInitWithLibs::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
      && pp.field("split_depth")
      && t_Maybe_natwidth_5.print_skip(pp, cs)
      && pp.field("special")
...
const StateInitWithLibs t_StateInitWithLibs;
...
//
constexpr char ComputeSkipReason::cons_len[4];
constexpr unsigned char ComputeSkipReason::cons_tag[4];
...
int ComputeSkipReason::check_tag(const vm::CellSlice& cs) const {
  ...
  case cskip_no_gas:
    return cs.have(2) ? cskip_no_gas : -1;
  case cskip_suspended:
    return cs.prefetch_ulong(3) == 6 ? cskip_suspended : -1;
  }
  return -1;
}

bool ComputeSkipReason::skip(vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case cskip_no_state:
    return cs.advance(2);
  case cskip_bad_state:
...
bool ComputeSkipReason::fetch_enum_to(vm::CellSlice& cs, char& value) const {
  int t = get_tag(cs);
  value = (char)t;
  return t >= 0 && cs.fetch_ulong(cons_len[t]) == cons_tag[t];
}

bool ComputeSkipReason::store_enum_from(vm::CellBuilder& cb, int value) const {
  return (unsigned)value < 4 && cb.store_long_bool(cons_tag[value], cons_len[value]);
}
...
bool ComputeSkipReason::unpack(vm::CellSlice& cs, ComputeSkipReason::Record_cskip_suspended& data) const {
  return cs.fetch_ulong(3) == 6;
}

bool ComputeSkipReason::unpack_cskip_suspended(vm::CellSlice& cs) const {
  return cs.fetch_ulong(3) == 6;
}

bool ComputeSkipReason::cell_unpack(Ref<vm::Cell> cell_ref, ComputeSkipReason::Record_cskip_suspended& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ComputeSkipReason::cell_unpack_cskip_suspended(Ref<vm::Cell> cell_ref) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cskip_suspended(cs) && cs.empty_ext();
}
...
bool ComputeSkipReason::pack(vm::CellBuilder& cb, const ComputeSkipReason::Record_cskip_suspended& data) const {
  return cb.store_long_bool(6, 3);
}

bool ComputeSkipReason::pack_cskip_suspended(vm::CellBuilder& cb) const {
  return cb.store_long_bool(6, 3);
}

bool ComputeSkipReason::cell_pack(Ref<vm::Cell>& cell_ref, const ComputeSkipReason::Record_cskip_suspended& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ComputeSkipReason::cell_pack_cskip_suspended(Ref<vm::Cell>& cell_ref) const {
  vm::CellBuilder cb;
  return pack_cskip_suspended(cb) && std::move(cb).finalize_to(cell_ref);
}
...
bool SmartContractInfo::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(32) == 0x76ef1ea
      ...
      && t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_MsgAddressInt.validate_skip(ops, cs, weak)
      && t_Maybe_Cell.validate_skip(ops, cs, weak);
}
...
bool SmartContractInfo::unpack(vm::CellSlice& cs, SmartContractInfo::Record& data) const {
  return cs.fetch_ulong(32) == 0x76ef1ea
      ...
      && t_Maybe_Cell.fetch_to(cs, data.global_config);
}
...
bool SmartContractInfo::pack(vm::CellBuilder& cb, const SmartContractInfo::Record& data) const {
  return cb.store_long_bool(0x76ef1ea, 32)
      ...
      && t_Maybe_Cell.store_from(cb, data.global_config);
}
...
bool SmartContractInfo::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(32) == 0x76ef1ea
      ...
      && pp.field("myself")
      && t_MsgAddressInt.print_skip(pp, cs)
      && pp.field("global_config")
      && t_Maybe_Cell.print_skip(pp, cs)
      && pp.close();
}
...
//
// code for auxiliary type `TYPE_1653`
//

int TYPE_1653::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool TYPE_1653::skip(vm::CellSlice& cs) const {
...
bool TYPE_1653::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
...
bool TYPE_1653::unpack(vm::CellSlice& cs, TYPE_1653::Record& data) const {
...
bool TYPE_1653::cell_unpack(Ref<vm::Cell> cell_ref, TYPE_1653::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool TYPE_1653::pack(vm::CellBuilder& cb, const TYPE_1653::Record& data) const {
...
bool TYPE_1653::cell_pack(Ref<vm::Cell>& cell_ref, const TYPE_1653::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool TYPE_1653::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
...
const TYPE_1653 t_TYPE_1653;

//
// code for auxiliary type `TYPE_1654`
//

int TYPE_1654::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool TYPE_1654::skip(vm::CellSlice& cs) const {
  return t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs);
...
bool TYPE_1654::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak);
...
bool TYPE_1654::unpack(vm::CellSlice& cs, TYPE_1654::Record& data) const {
...
bool TYPE_1654::cell_unpack(Ref<vm::Cell> cell_ref, TYPE_1654::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool TYPE_1654::pack(vm::CellBuilder& cb, const TYPE_1654::Record& data) const {
...
bool TYPE_1654::cell_pack(Ref<vm::Cell>& cell_ref, const TYPE_1654::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool TYPE_1654::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
...
const TYPE_1654 t_TYPE_1654;

//
// code for type `ValueFlow`
//
constexpr unsigned ValueFlow::cons_tag[2];
...
int ValueFlow::check_tag(const vm::CellSlice& cs) const {
  ...
  case value_flow_v2:
    return cs.prefetch_ulong(32) == 0x3ebf98b7 ? value_flow_v2 : -1;
  }
  return -1;
}
...
bool ValueFlow::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case value_flow:
    return cs.fetch_ulong(32) == 0xb8e48dfbU
        && t_TYPE_1653.validate_skip_ref(ops, cs, weak)
        && t_CurrencyCollection.validate_skip(ops, cs, weak)
        && t_TYPE_1654.validate_skip_ref(ops, cs, weak);
  case value_flow_v2:
    return cs.fetch_ulong(32) == 0x3ebf98b7
        && t_TYPE_1653.validate_skip_ref(ops, cs, weak)
        && t_CurrencyCollection.validate_skip(ops, cs, weak)
        && t_CurrencyCollection.validate_skip(ops, cs, weak)
        && t_TYPE_1654.validate_skip_ref(ops, cs, weak);
...
bool ValueFlow::unpack(vm::CellSlice& cs, ValueFlow::Record_value_flow& data) const {
  return cs.fetch_ulong(32) == 0xb8e48dfbU
      && t_TYPE_1653.cell_unpack(cs.fetch_ref(), data.r1)
      && t_CurrencyCollection.fetch_to(cs, data.fees_collected)
      && t_TYPE_1654.cell_unpack(cs.fetch_ref(), data.r2);
}

bool ValueFlow::cell_unpack(Ref<vm::Cell> cell_ref, ValueFlow::Record_value_flow& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ValueFlow::unpack(vm::CellSlice& cs, ValueFlow::Record_value_flow_v2& data) const {
  return cs.fetch_ulong(32) == 0x3ebf98b7
      && t_TYPE_1653.cell_unpack(cs.fetch_ref(), data.r1)
      && t_CurrencyCollection.fetch_to(cs, data.fees_collected)
      && t_CurrencyCollection.fetch_to(cs, data.burned)
      && t_TYPE_1654.cell_unpack(cs.fetch_ref(), data.r2);
}

bool ValueFlow::cell_unpack(Ref<vm::Cell> cell_ref, ValueFlow::Record_value_flow_v2& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ValueFlow::pack(vm::CellBuilder& cb, const ValueFlow::Record_value_flow& data) const {
  Ref<vm::Cell> tmp_cell;
  return cb.store_long_bool(0xb8e48dfbU, 32)
      && t_TYPE_1653.cell_pack(tmp_cell, data.r1)
      && cb.store_ref_bool(std::move(tmp_cell))
      && t_CurrencyCollection.store_from(cb, data.fees_collected)
      && t_TYPE_1654.cell_pack(tmp_cell, data.r2)
      && cb.store_ref_bool(std::move(tmp_cell));
}

bool ValueFlow::cell_pack(Ref<vm::Cell>& cell_ref, const ValueFlow::Record_value_flow& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ValueFlow::pack(vm::CellBuilder& cb, const ValueFlow::Record_value_flow_v2& data) const {
  Ref<vm::Cell> tmp_cell;
  return cb.store_long_bool(0x3ebf98b7, 32)
      && t_TYPE_1653.cell_pack(tmp_cell, data.r1)
      && cb.store_ref_bool(std::move(tmp_cell))
      && t_CurrencyCollection.store_from(cb, data.fees_collected)
      && t_CurrencyCollection.store_from(cb, data.burned)
      && t_TYPE_1654.cell_pack(tmp_cell, data.r2)
      && cb.store_ref_bool(std::move(tmp_cell));
}

bool ValueFlow::cell_pack(Ref<vm::Cell>& cell_ref, const ValueFlow::Record_value_flow_v2& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool ValueFlow::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case value_flow:
    return cs.fetch_ulong(32) == 0xb8e48dfbU
        && pp.open("value_flow")
        && pp.field()
        && t_TYPE_1653.print_ref(pp, cs.fetch_ref())
        && pp.field("fees_collected")
        && t_CurrencyCollection.print_skip(pp, cs)
        && pp.field()
        && t_TYPE_1654.print_ref(pp, cs.fetch_ref())
        && pp.close();
  case value_flow_v2:
    return cs.fetch_ulong(32) == 0x3ebf98b7
        && pp.open("value_flow_v2")
        && pp.field()
        && t_TYPE_1653.print_ref(pp, cs.fetch_ref())
        && pp.field("fees_collected")
        && t_CurrencyCollection.print_skip(pp, cs)
  ...
  return pp.fail("unknown constructor for ValueFlow");
}
...
//
// code for type `BurningConfig`
//
constexpr unsigned char BurningConfig::cons_tag[1];

int BurningConfig::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 1 ? burning_config : -1;
}

bool BurningConfig::skip(vm::CellSlice& cs) const {
  int fee_burn_num, fee_burn_denom;
  return cs.advance(8)
      && t_Maybe_bits256.skip(cs)
      && cs.fetch_uint_to(32, fee_burn_num)
      && cs.fetch_uint_to(32, fee_burn_denom)
      && fee_burn_num <= fee_burn_denom
      && 1 <= fee_burn_denom;
}

bool BurningConfig::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  int fee_burn_num, fee_burn_denom;
  return cs.fetch_ulong(8) == 1
      && t_Maybe_bits256.validate_skip(ops, cs, weak)
      && cs.fetch_uint_to(32, fee_burn_num)
      && cs.fetch_uint_to(32, fee_burn_denom)
      && fee_burn_num <= fee_burn_denom
      && 1 <= fee_burn_denom;
...
bool BurningConfig::unpack(vm::CellSlice& cs, BurningConfig::Record& data) const {
  return cs.fetch_ulong(8) == 1
      && t_Maybe_bits256.fetch_to(cs, data.blackhole_addr)
      && cs.fetch_uint_to(32, data.fee_burn_num)
      && cs.fetch_uint_to(32, data.fee_burn_denom)
      && data.fee_burn_num <= data.fee_burn_denom
      && 1 <= data.fee_burn_denom;
}

bool BurningConfig::unpack_burning_config(vm::CellSlice& cs, Ref<CellSlice>& blackhole_addr, int& fee_burn_num, int& fee_burn_denom) const {
  return cs.fetch_ulong(8) == 1
      && t_Maybe_bits256.fetch_to(cs, blackhole_addr)
      && cs.fetch_uint_to(32, fee_burn_num)
      && cs.fetch_uint_to(32, fee_burn_denom)
      && fee_burn_num <= fee_burn_denom
      && 1 <= fee_burn_denom;
...
bool BurningConfig::cell_unpack(Ref<vm::Cell> cell_ref, BurningConfig::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool BurningConfig::cell_unpack_burning_config(Ref<vm::Cell> cell_ref, Ref<CellSlice>& blackhole_addr, int& fee_burn_num, int& fee_burn_denom) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_burning_config(cs, blackhole_addr, fee_burn_num, fee_burn_denom) && cs.empty_ext();
}

bool BurningConfig::pack(vm::CellBuilder& cb, const BurningConfig::Record& data) const {
  return cb.store_long_bool(1, 8)
      && t_Maybe_bits256.store_from(cb, data.blackhole_addr)
      && cb.store_ulong_rchk_bool(data.fee_burn_num, 32)
      && cb.store_ulong_rchk_bool(data.fee_burn_denom, 32)
      && data.fee_burn_num <= data.fee_burn_denom
      && 1 <= data.fee_burn_denom;
}

bool BurningConfig::pack_burning_config(vm::CellBuilder& cb, Ref<CellSlice> blackhole_addr, int fee_burn_num, int fee_burn_denom) const {
  return cb.store_long_bool(1, 8)
      && t_Maybe_bits256.store_from(cb, blackhole_addr)
      && cb.store_ulong_rchk_bool(fee_burn_num, 32)
      && cb.store_ulong_rchk_bool(fee_burn_denom, 32)
      && fee_burn_num <= fee_burn_denom
      && 1 <= fee_burn_denom;
}

bool BurningConfig::cell_pack(Ref<vm::Cell>& cell_ref, const BurningConfig::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool BurningConfig::cell_pack_burning_config(Ref<vm::Cell>& cell_ref, Ref<CellSlice> blackhole_addr, int fee_burn_num, int fee_burn_denom) const {
  vm::CellBuilder cb;
  return pack_burning_config(cb, std::move(blackhole_addr), fee_burn_num, fee_burn_denom) && std::move(cb).finalize_to(cell_ref);
}

bool BurningConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  int fee_burn_num, fee_burn_denom;
  return cs.fetch_ulong(8) == 1
      && pp.open("burning_config")
      && pp.field("blackhole_addr")
      && t_Maybe_bits256.print_skip(pp, cs)
      && cs.fetch_uint_to(32, fee_burn_num)
      && pp.field_int(fee_burn_num, "fee_burn_num")
      && cs.fetch_uint_to(32, fee_burn_denom)
      && pp.field_int(fee_burn_denom, "fee_burn_denom")
      && fee_burn_num <= fee_burn_denom
      && 1 <= fee_burn_denom
      && pp.close();
}

const BurningConfig t_BurningConfig;
...
//
// code for type `WcSplitMergeTimings`
//

int WcSplitMergeTimings::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(4) == 0 ? wc_split_merge_timings : -1;
}

bool WcSplitMergeTimings::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(4) == 0
      && cs.advance(128);
}

bool WcSplitMergeTimings::unpack(vm::CellSlice& cs, WcSplitMergeTimings::Record& data) const {
  return cs.fetch_ulong(4) == 0
      && cs.fetch_uint_to(32, data.split_merge_delay)
      && cs.fetch_uint_to(32, data.split_merge_interval)
      && cs.fetch_uint_to(32, data.min_split_merge_interval)
      && cs.fetch_uint_to(32, data.max_split_merge_delay);
}

bool WcSplitMergeTimings::cell_unpack(Ref<vm::Cell> cell_ref, WcSplitMergeTimings::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool WcSplitMergeTimings::pack(vm::CellBuilder& cb, const WcSplitMergeTimings::Record& data) const {
  return cb.store_long_bool(0, 4)
      && cb.store_ulong_rchk_bool(data.split_merge_delay, 32)
      && cb.store_ulong_rchk_bool(data.split_merge_interval, 32)
      && cb.store_ulong_rchk_bool(data.min_split_merge_interval, 32)
      && cb.store_ulong_rchk_bool(data.max_split_merge_delay, 32);
}

bool WcSplitMergeTimings::cell_pack(Ref<vm::Cell>& cell_ref, const WcSplitMergeTimings::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool WcSplitMergeTimings::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(4) == 0
      && pp.open("wc_split_merge_timings")
      && pp.fetch_uint_field(cs, 32, "split_merge_delay")
      && pp.fetch_uint_field(cs, 32, "split_merge_interval")
      && pp.fetch_uint_field(cs, 32, "min_split_merge_interval")
      && pp.fetch_uint_field(cs, 32, "max_split_merge_delay")
      && pp.close();
}

const WcSplitMergeTimings t_WcSplitMergeTimings;

//
// code for type `WorkchainDescr`
//
constexpr unsigned char WorkchainDescr::cons_tag[2];

int WorkchainDescr::get_tag(const vm::CellSlice& cs) const {
  switch (cs.bselect(6, 0x60000000000ULL)) {
  case 0:
    return cs.bit_at(7) ? workchain_v2 : workchain;
  default:
    return -1;
  }
}
...
int WorkchainDescr::check_tag(const vm::CellSlice& cs) const {
  ...
  case workchain_v2:
    return cs.prefetch_ulong(8) == 0xa7 ? workchain_v2 : -1;
  }
  return -1;
}
...
bool WorkchainDescr::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case workchain_v2: {
    ...
    return cs.fetch_ulong(8) == 0xa7
        ...
        && cs.advance(544)
        && WorkchainFormat{basic}.validate_skip(ops, cs, weak)
        && t_WcSplitMergeTimings.validate_skip(ops, cs, weak);
    }
  }
  return false;
}

bool WorkchainDescr::unpack(vm::CellSlice& cs, WorkchainDescr::Record_workchain& data) const {
  return cs.fetch_ulong(8) == 0xa6
...
bool WorkchainDescr::cell_unpack(Ref<vm::Cell> cell_ref, WorkchainDescr::Record_workchain& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool WorkchainDescr::unpack(vm::CellSlice& cs, WorkchainDescr::Record_workchain_v2& data) const {
  return cs.fetch_ulong(8) == 0xa7
      && cs.fetch_uint_to(32, data.enabled_since)
      && cs.fetch_uint_to(8, data.actual_min_split)
      && cs.fetch_uint_to(8, data.min_split)
      ...
      && cs.fetch_uint_to(32, data.version)
      && WorkchainFormat{data.basic}.fetch_to(cs, data.format)
      && cs.fetch_subslice_to(132, data.split_merge_timings);
}

bool WorkchainDescr::cell_unpack(Ref<vm::Cell> cell_ref, WorkchainDescr::Record_workchain_v2& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool WorkchainDescr::pack(vm::CellBuilder& cb, const WorkchainDescr::Record_workchain& data) const {
...
bool WorkchainDescr::cell_pack(Ref<vm::Cell>& cell_ref, const WorkchainDescr::Record_workchain& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool WorkchainDescr::pack(vm::CellBuilder& cb, const WorkchainDescr::Record_workchain_v2& data) const {
  return cb.store_long_bool(0xa7, 8)
      && cb.store_ulong_rchk_bool(data.enabled_since, 32)
      && cb.store_ulong_rchk_bool(data.actual_min_split, 8)
      && cb.store_ulong_rchk_bool(data.min_split, 8)
      && cb.store_ulong_rchk_bool(data.max_split, 8)
      ...
      && cb.store_ulong_rchk_bool(data.version, 32)
      && WorkchainFormat{data.basic}.store_from(cb, data.format)
      && cb.append_cellslice_chk(data.split_merge_timings, 132);
}

bool WorkchainDescr::cell_pack(Ref<vm::Cell>& cell_ref, const WorkchainDescr::Record_workchain_v2& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool WorkchainDescr::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case workchain_v2: {
    ...
    return cs.fetch_ulong(8) == 0xa7
        ...
        && pp.field("format")
        && WorkchainFormat{basic}.print_skip(pp, cs)
        && pp.field("split_merge_timings")
        && t_WcSplitMergeTimings.print_skip(pp, cs)
        && pp.close();
    }
  }
  return pp.fail("unknown constructor for WorkchainDescr");
}
...
//
constexpr unsigned char GasLimitsPrices::cons_tag[4];
...
int GasLimitsPrices::get_tag(const vm::CellSlice& cs) const {
  ...
  case 2:
    if (cs.bit_at(6)) {
      return cs.bit_at(7) ? gas_prices_v3 : gas_prices_ext;
    } else {
      return gas_prices;
    }
  default:
...
int GasLimitsPrices::check_tag(const vm::CellSlice& cs) const {
  ...
  case gas_prices_v3:
    return cs.prefetch_ulong(8) == 0xdf ? gas_prices_v3 : -1;
  case gas_flat_pfx:
...
bool GasLimitsPrices::unpack(vm::CellSlice& cs, GasLimitsPrices::Record_gas_prices_v3& data) const {
  return cs.fetch_ulong(8) == 0xdf
      && cs.fetch_uint_to(64, data.gas_price)
      && cs.fetch_uint_to(64, data.gas_limit)
      && cs.fetch_uint_to(64, data.special_gas_limit)
...
bool GasLimitsPrices::cell_unpack(Ref<vm::Cell> cell_ref, GasLimitsPrices::Record_gas_prices_v3& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}
...
bool GasLimitsPrices::pack(vm::CellBuilder& cb, const GasLimitsPrices::Record_gas_prices_v3& data) const {
  return cb.store_long_bool(0xdf, 8)
      && cb.store_ulong_rchk_bool(data.gas_price, 64)
      && cb.store_ulong_rchk_bool(data.gas_limit, 64)
      && cb.store_ulong_rchk_bool(data.special_gas_limit, 64)
      && cb.store_ulong_rchk_bool(data.gas_credit, 64)
...
bool GasLimitsPrices::cell_pack(Ref<vm::Cell>& cell_ref, const GasLimitsPrices::Record_gas_prices_v3& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
//
constexpr unsigned char ConsensusConfig::cons_tag[4];

int ConsensusConfig::get_tag(const vm::CellSlice& cs) const {
  switch (cs.bselect(6, 0xe0000000000000ULL)) {
  case 0:
    return cs.bit_at(7) ? consensus_config_new : consensus_config;
  case 1:
    return cs.bit_at(7) ? consensus_config_v4 : consensus_config_v3;
  default:
    return -1;
  }
}
...
int ConsensusConfig::check_tag(const vm::CellSlice& cs) const {
  ...
  case consensus_config_v3:
    return cs.prefetch_ulong(8) == 0xd8 ? consensus_config_v3 : -1;
  case consensus_config_v4:
    return cs.prefetch_ulong(8) == 0xd9 ? consensus_config_v4 : -1;
  }
  return -1;
}
...
bool ConsensusConfig::unpack(vm::CellSlice& cs, ConsensusConfig::Record_consensus_config_v3& data) const {
  return cs.fetch_ulong(8) == 0xd8
      && cs.fetch_uint_to(7, data.flags)
      && data.flags == 0
      && cs.fetch_bool_to(data.new_catchain_ids)
      ...
      && cs.fetch_uint_to(32, data.max_block_bytes)
      && cs.fetch_uint_to(32, data.max_collated_bytes)
      && cs.fetch_uint_to(16, data.proto_version);
}

bool ConsensusConfig::cell_unpack(Ref<vm::Cell> cell_ref, ConsensusConfig::Record_consensus_config_v3& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConsensusConfig::unpack(vm::CellSlice& cs, ConsensusConfig::Record_consensus_config_v4& data) const {
  return cs.fetch_ulong(8) == 0xd9
      && cs.fetch_uint_to(7, data.flags)
      && data.flags == 0
      && cs.fetch_bool_to(data.new_catchain_ids)
      ...
      && cs.fetch_uint_to(32, data.max_collated_bytes)
      && cs.fetch_uint_to(16, data.proto_version)
      && cs.fetch_uint_to(32, data.catchain_max_blocks_coeff);
}

bool ConsensusConfig::cell_unpack(Ref<vm::Cell> cell_ref, ConsensusConfig::Record_consensus_config_v4& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}
...
bool ConsensusConfig::pack(vm::CellBuilder& cb, const ConsensusConfig::Record_consensus_config_v3& data) const {
  return cb.store_long_bool(0xd8, 8)
      && cb.store_ulong_rchk_bool(data.flags, 7)
      && data.flags == 0
      && cb.store_ulong_rchk_bool(data.new_catchain_ids, 1)
      && cb.store_ulong_rchk_bool(data.round_candidates, 8)
      ...
      && cb.store_ulong_rchk_bool(data.max_block_bytes, 32)
      && cb.store_ulong_rchk_bool(data.max_collated_bytes, 32)
      && cb.store_ulong_rchk_bool(data.proto_version, 16);
}

bool ConsensusConfig::cell_pack(Ref<vm::Cell>& cell_ref, const ConsensusConfig::Record_consensus_config_v3& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConsensusConfig::pack(vm::CellBuilder& cb, const ConsensusConfig::Record_consensus_config_v4& data) const {
  return cb.store_long_bool(0xd9, 8)
      && cb.store_ulong_rchk_bool(data.flags, 7)
      && data.flags == 0
      && cb.store_ulong_rchk_bool(data.new_catchain_ids, 1)
      && cb.store_ulong_rchk_bool(data.round_candidates, 8)
      ...
      && cb.store_ulong_rchk_bool(data.max_collated_bytes, 32)
      && cb.store_ulong_rchk_bool(data.proto_version, 16)
      && cb.store_ulong_rchk_bool(data.catchain_max_blocks_coeff, 32);
}

bool ConsensusConfig::cell_pack(Ref<vm::Cell>& cell_ref, const ConsensusConfig::Record_consensus_config_v4& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool ConsensusConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case consensus_config_v3: {
    ...
    return cs.fetch_ulong(8) == 0xd8
        ...
        && pp.fetch_uint_field(cs, 32, "max_block_bytes")
        && pp.fetch_uint_field(cs, 32, "max_collated_bytes")
        && pp.fetch_uint_field(cs, 16, "proto_version")
        && pp.close();
    }
  case consensus_config_v4: {
    int flags, round_candidates;
    return cs.fetch_ulong(8) == 0xd9
        && pp.open("consensus_config_v4")
        && cs.fetch_uint_to(7, flags)
        && pp.field_int(flags, "flags")
        && flags == 0
        && pp.fetch_uint_field(cs, 1, "new_catchain_ids")
        ...
        && pp.fetch_uint_field(cs, 32, "max_collated_bytes")
        && pp.fetch_uint_field(cs, 16, "proto_version")
        && pp.fetch_uint_field(cs, 32, "catchain_max_blocks_coeff")
        && pp.close();
    }
  }
...
//
// code for type `MisbehaviourPunishmentConfig`
//
constexpr unsigned char MisbehaviourPunishmentConfig::cons_tag[1];

int MisbehaviourPunishmentConfig::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 1 ? misbehaviour_punishment_config_v1 : -1;
}

bool MisbehaviourPunishmentConfig::skip(vm::CellSlice& cs) const {
  return cs.advance(8)
      && t_Grams.skip(cs)
      && cs.advance(176);
}

bool MisbehaviourPunishmentConfig::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(8) == 1
      && t_Grams.validate_skip(ops, cs, weak)
      && cs.advance(176);
}

bool MisbehaviourPunishmentConfig::unpack(vm::CellSlice& cs, MisbehaviourPunishmentConfig::Record& data) const {
  return cs.fetch_ulong(8) == 1
      && t_Grams.fetch_to(cs, data.default_flat_fine)
      && cs.fetch_uint_to(32, data.default_proportional_fine)
      && cs.fetch_uint_to(16, data.severity_flat_mult)
      && cs.fetch_uint_to(16, data.severity_proportional_mult)
      && cs.fetch_uint_to(16, data.unpunishable_interval)
      && cs.fetch_uint_to(16, data.long_interval)
      && cs.fetch_uint_to(16, data.long_flat_mult)
      && cs.fetch_uint_to(16, data.long_proportional_mult)
      && cs.fetch_uint_to(16, data.medium_interval)
      && cs.fetch_uint_to(16, data.medium_flat_mult)
      && cs.fetch_uint_to(16, data.medium_proportional_mult);
}

bool MisbehaviourPunishmentConfig::cell_unpack(Ref<vm::Cell> cell_ref, MisbehaviourPunishmentConfig::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool MisbehaviourPunishmentConfig::pack(vm::CellBuilder& cb, const MisbehaviourPunishmentConfig::Record& data) const {
  return cb.store_long_bool(1, 8)
      && t_Grams.store_from(cb, data.default_flat_fine)
      && cb.store_ulong_rchk_bool(data.default_proportional_fine, 32)
      && cb.store_ulong_rchk_bool(data.severity_flat_mult, 16)
      && cb.store_ulong_rchk_bool(data.severity_proportional_mult, 16)
      && cb.store_ulong_rchk_bool(data.unpunishable_interval, 16)
      && cb.store_ulong_rchk_bool(data.long_interval, 16)
      && cb.store_ulong_rchk_bool(data.long_flat_mult, 16)
      && cb.store_ulong_rchk_bool(data.long_proportional_mult, 16)
      && cb.store_ulong_rchk_bool(data.medium_interval, 16)
      && cb.store_ulong_rchk_bool(data.medium_flat_mult, 16)
      && cb.store_ulong_rchk_bool(data.medium_proportional_mult, 16);
}

bool MisbehaviourPunishmentConfig::cell_pack(Ref<vm::Cell>& cell_ref, const MisbehaviourPunishmentConfig::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool MisbehaviourPunishmentConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(8) == 1
      && pp.open("misbehaviour_punishment_config_v1")
      && pp.field("default_flat_fine")
      && t_Grams.print_skip(pp, cs)
      && pp.fetch_uint_field(cs, 32, "default_proportional_fine")
      && pp.fetch_uint_field(cs, 16, "severity_flat_mult")
      && pp.fetch_uint_field(cs, 16, "severity_proportional_mult")
      && pp.fetch_uint_field(cs, 16, "unpunishable_interval")
      && pp.fetch_uint_field(cs, 16, "long_interval")
      && pp.fetch_uint_field(cs, 16, "long_flat_mult")
      && pp.fetch_uint_field(cs, 16, "long_proportional_mult")
      && pp.fetch_uint_field(cs, 16, "medium_interval")
      && pp.fetch_uint_field(cs, 16, "medium_flat_mult")
      && pp.fetch_uint_field(cs, 16, "medium_proportional_mult")
      && pp.close();
}

const MisbehaviourPunishmentConfig t_MisbehaviourPunishmentConfig;

//
// code for type `SizeLimitsConfig`
//
constexpr unsigned char SizeLimitsConfig::cons_tag[2];

int SizeLimitsConfig::get_tag(const vm::CellSlice& cs) const {
  switch (cs.bselect(6, 3)) {
  case 0:
    return cs.bit_at(6) ? size_limits_config_v2 : size_limits_config;
  default:
    return -1;
  }
}

int SizeLimitsConfig::check_tag(const vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case size_limits_config:
    return cs.prefetch_ulong(8) == 1 ? size_limits_config : -1;
  case size_limits_config_v2:
    return cs.prefetch_ulong(8) == 2 ? size_limits_config_v2 : -1;
  }
  return -1;
}

bool SizeLimitsConfig::skip(vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case size_limits_config:
...
bool SizeLimitsConfig::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  switch (get_tag(cs)) {
  case size_limits_config:
    return cs.fetch_ulong(8) == 1
        && cs.advance(160);
...
bool SizeLimitsConfig::unpack(vm::CellSlice& cs, SizeLimitsConfig::Record_size_limits_config& data) const {
  return cs.fetch_ulong(8) == 1
      && cs.fetch_uint_to(32, data.max_msg_bits)
      && cs.fetch_uint_to(32, data.max_msg_cells)
      && cs.fetch_uint_to(32, data.max_library_cells)
      && cs.fetch_uint_to(16, data.max_vm_data_depth)
      && cs.fetch_uint_to(32, data.max_ext_msg_size)
      && cs.fetch_uint_to(16, data.max_ext_msg_depth);
}

bool SizeLimitsConfig::cell_unpack(Ref<vm::Cell> cell_ref, SizeLimitsConfig::Record_size_limits_config& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool SizeLimitsConfig::unpack(vm::CellSlice& cs, SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  return cs.fetch_ulong(8) == 2
      && cs.fetch_uint_to(32, data.max_msg_bits)
      && cs.fetch_uint_to(32, data.max_msg_cells)
      && cs.fetch_uint_to(32, data.max_library_cells)
      ...
      && cs.fetch_uint_to(32, data.max_ext_msg_size)
      && cs.fetch_uint_to(16, data.max_ext_msg_depth)
      && cs.fetch_uint_to(32, data.max_acc_state_cells)
      && cs.fetch_uint_to(32, data.max_acc_state_bits)
      && cs.fetch_uint_to(32, data.max_acc_public_libraries);
}

bool SizeLimitsConfig::cell_unpack(Ref<vm::Cell> cell_ref, SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool SizeLimitsConfig::pack(vm::CellBuilder& cb, const SizeLimitsConfig::Record_size_limits_config& data) const {
  return cb.store_long_bool(1, 8)
      && cb.store_ulong_rchk_bool(data.max_msg_bits, 32)
      && cb.store_ulong_rchk_bool(data.max_msg_cells, 32)
      && cb.store_ulong_rchk_bool(data.max_library_cells, 32)
      && cb.store_ulong_rchk_bool(data.max_vm_data_depth, 16)
      && cb.store_ulong_rchk_bool(data.max_ext_msg_size, 32)
      && cb.store_ulong_rchk_bool(data.max_ext_msg_depth, 16);
}

bool SizeLimitsConfig::cell_pack(Ref<vm::Cell>& cell_ref, const SizeLimitsConfig::Record_size_limits_config& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool SizeLimitsConfig::pack(vm::CellBuilder& cb, const SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  return cb.store_long_bool(2, 8)
      && cb.store_ulong_rchk_bool(data.max_msg_bits, 32)
      && cb.store_ulong_rchk_bool(data.max_msg_cells, 32)
      && cb.store_ulong_rchk_bool(data.max_library_cells, 32)
      ...
      && cb.store_ulong_rchk_bool(data.max_ext_msg_size, 32)
      && cb.store_ulong_rchk_bool(data.max_ext_msg_depth, 16)
      && cb.store_ulong_rchk_bool(data.max_acc_state_cells, 32)
      && cb.store_ulong_rchk_bool(data.max_acc_state_bits, 32)
      && cb.store_ulong_rchk_bool(data.max_acc_public_libraries, 32);
}

bool SizeLimitsConfig::cell_pack(Ref<vm::Cell>& cell_ref, const SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool SizeLimitsConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case size_limits_config:
    return cs.fetch_ulong(8) == 1
        && pp.open("size_limits_config")
        && pp.fetch_uint_field(cs, 32, "max_msg_bits")
        && pp.fetch_uint_field(cs, 32, "max_msg_cells")
        && pp.fetch_uint_field(cs, 32, "max_library_cells")
        && pp.fetch_uint_field(cs, 16, "max_vm_data_depth")
        && pp.fetch_uint_field(cs, 32, "max_ext_msg_size")
        && pp.fetch_uint_field(cs, 16, "max_ext_msg_depth")
        && pp.close();
  case size_limits_config_v2:
    return cs.fetch_ulong(8) == 2
        && pp.open("size_limits_config_v2")
        && pp.fetch_uint_field(cs, 32, "max_msg_bits")
        && pp.fetch_uint_field(cs, 32, "max_msg_cells")
        && pp.fetch_uint_field(cs, 32, "max_library_cells")
        && pp.fetch_uint_field(cs, 16, "max_vm_data_depth")
        && pp.fetch_uint_field(cs, 32, "max_ext_msg_size")
        && pp.fetch_uint_field(cs, 16, "max_ext_msg_depth")
        && pp.fetch_uint_field(cs, 32, "max_acc_state_cells")
        && pp.fetch_uint_field(cs, 32, "max_acc_state_bits")
        && pp.fetch_uint_field(cs, 32, "max_acc_public_libraries")
        && pp.close();
  }
  return pp.fail("unknown constructor for SizeLimitsConfig");
}

const SizeLimitsConfig t_SizeLimitsConfig;

//
// code for type `SuspendedAddressList`
//

int SuspendedAddressList::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 0 ? suspended_address_list : -1;
}

bool SuspendedAddressList::skip(vm::CellSlice& cs) const {
  return cs.advance(8)
      && t_HashmapE_288_Unit.skip(cs)
      && cs.advance(32);
}

bool SuspendedAddressList::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(8) == 0
      && t_HashmapE_288_Unit.validate_skip(ops, cs, weak)
      && cs.advance(32);
}

bool SuspendedAddressList::unpack(vm::CellSlice& cs, SuspendedAddressList::Record& data) const {
  return cs.fetch_ulong(8) == 0
      && t_HashmapE_288_Unit.fetch_to(cs, data.addresses)
      && cs.fetch_uint_to(32, data.suspended_until);
}

bool SuspendedAddressList::unpack_suspended_address_list(vm::CellSlice& cs, Ref<CellSlice>& addresses, unsigned& suspended_until) const {
  return cs.fetch_ulong(8) == 0
      && t_HashmapE_288_Unit.fetch_to(cs, addresses)
      && cs.fetch_uint_to(32, suspended_until);
}

bool SuspendedAddressList::cell_unpack(Ref<vm::Cell> cell_ref, SuspendedAddressList::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool SuspendedAddressList::cell_unpack_suspended_address_list(Ref<vm::Cell> cell_ref, Ref<CellSlice>& addresses, unsigned& suspended_until) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_suspended_address_list(cs, addresses, suspended_until) && cs.empty_ext();
}

bool SuspendedAddressList::pack(vm::CellBuilder& cb, const SuspendedAddressList::Record& data) const {
  return cb.store_long_bool(0, 8)
      && t_HashmapE_288_Unit.store_from(cb, data.addresses)
      && cb.store_ulong_rchk_bool(data.suspended_until, 32);
}

bool SuspendedAddressList::pack_suspended_address_list(vm::CellBuilder& cb, Ref<CellSlice> addresses, unsigned suspended_until) const {
  return cb.store_long_bool(0, 8)
      && t_HashmapE_288_Unit.store_from(cb, addresses)
      && cb.store_ulong_rchk_bool(suspended_until, 32);
}

bool SuspendedAddressList::cell_pack(Ref<vm::Cell>& cell_ref, const SuspendedAddressList::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool SuspendedAddressList::cell_pack_suspended_address_list(Ref<vm::Cell>& cell_ref, Ref<CellSlice> addresses, unsigned suspended_until) const {
  vm::CellBuilder cb;
  return pack_suspended_address_list(cb, std::move(addresses), suspended_until) && std::move(cb).finalize_to(cell_ref);
}

bool SuspendedAddressList::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(8) == 0
      && pp.open("suspended_address_list")
      && pp.field("addresses")
      && t_HashmapE_288_Unit.print_skip(pp, cs)
      && pp.fetch_uint_field(cs, 32, "suspended_until")
      && pp.close();
}

const SuspendedAddressList t_SuspendedAddressList;

//
// code for type `OracleBridgeParams`
//

int OracleBridgeParams::check_tag(const vm::CellSlice& cs) const {
  return oracle_bridge_params;
}

bool OracleBridgeParams::skip(vm::CellSlice& cs) const {
  return cs.advance(512)
      && t_HashmapE_256_uint256.skip(cs)
      && cs.advance(256);
}

bool OracleBridgeParams::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.advance(512)
      && t_HashmapE_256_uint256.validate_skip(ops, cs, weak)
      && cs.advance(256);
}

bool OracleBridgeParams::unpack(vm::CellSlice& cs, OracleBridgeParams::Record& data) const {
  return cs.fetch_bits_to(data.bridge_address.bits(), 256)
      && cs.fetch_bits_to(data.oracle_mutlisig_address.bits(), 256)
      && t_HashmapE_256_uint256.fetch_to(cs, data.oracles)
      && cs.fetch_bits_to(data.external_chain_address.bits(), 256);
}

bool OracleBridgeParams::cell_unpack(Ref<vm::Cell> cell_ref, OracleBridgeParams::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool OracleBridgeParams::pack(vm::CellBuilder& cb, const OracleBridgeParams::Record& data) const {
  return cb.store_bits_bool(data.bridge_address.cbits(), 256)
      && cb.store_bits_bool(data.oracle_mutlisig_address.cbits(), 256)
      && t_HashmapE_256_uint256.store_from(cb, data.oracles)
      && cb.store_bits_bool(data.external_chain_address.cbits(), 256);
}

bool OracleBridgeParams::cell_pack(Ref<vm::Cell>& cell_ref, const OracleBridgeParams::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool OracleBridgeParams::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open("oracle_bridge_params")
      && pp.fetch_bits_field(cs, 256, "bridge_address")
      && pp.fetch_bits_field(cs, 256, "oracle_mutlisig_address")
      && pp.field("oracles")
      && t_HashmapE_256_uint256.print_skip(pp, cs)
      && pp.fetch_bits_field(cs, 256, "external_chain_address")
      && pp.close();
}

const OracleBridgeParams t_OracleBridgeParams;

//
// code for type `JettonBridgePrices`
//

int JettonBridgePrices::check_tag(const vm::CellSlice& cs) const {
  return jetton_bridge_prices;
}

bool JettonBridgePrices::skip(vm::CellSlice& cs) const {
  return t_Coins.skip(cs)
      && t_Coins.skip(cs)
      && t_Coins.skip(cs)
      && t_Coins.skip(cs)
      && t_Coins.skip(cs)
...
bool JettonBridgePrices::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_Coins.validate_skip(ops, cs, weak)
      && t_Coins.validate_skip(ops, cs, weak)
      && t_Coins.validate_skip(ops, cs, weak)
      && t_Coins.validate_skip(ops, cs, weak)
      && t_Coins.validate_skip(ops, cs, weak)
      && t_Coins.validate_skip(ops, cs, weak);
...
bool JettonBridgePrices::unpack(vm::CellSlice& cs, JettonBridgePrices::Record& data) const {
  return t_Coins.fetch_to(cs, data.bridge_burn_fee)
      && t_Coins.fetch_to(cs, data.bridge_mint_fee)
      && t_Coins.fetch_to(cs, data.wallet_min_tons_for_storage)
      && t_Coins.fetch_to(cs, data.wallet_gas_consumption)
      && t_Coins.fetch_to(cs, data.minter_min_tons_for_storage)
      && t_Coins.fetch_to(cs, data.discover_gas_consumption);
}

bool JettonBridgePrices::cell_unpack(Ref<vm::Cell> cell_ref, JettonBridgePrices::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool JettonBridgePrices::pack(vm::CellBuilder& cb, const JettonBridgePrices::Record& data) const {
  return t_Coins.store_from(cb, data.bridge_burn_fee)
      && t_Coins.store_from(cb, data.bridge_mint_fee)
      && t_Coins.store_from(cb, data.wallet_min_tons_for_storage)
      && t_Coins.store_from(cb, data.wallet_gas_consumption)
      && t_Coins.store_from(cb, data.minter_min_tons_for_storage)
      && t_Coins.store_from(cb, data.discover_gas_consumption);
}

bool JettonBridgePrices::cell_pack(Ref<vm::Cell>& cell_ref, const JettonBridgePrices::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool JettonBridgePrices::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open("jetton_bridge_prices")
      && pp.field("bridge_burn_fee")
      && t_Coins.print_skip(pp, cs)
      && pp.field("bridge_mint_fee")
      && t_Coins.print_skip(pp, cs)
      && pp.field("wallet_min_tons_for_storage")
      && t_Coins.print_skip(pp, cs)
      && pp.field("wallet_gas_consumption")
      && t_Coins.print_skip(pp, cs)
      && pp.field("minter_min_tons_for_storage")
      && t_Coins.print_skip(pp, cs)
      && pp.field("discover_gas_consumption")
      && t_Coins.print_skip(pp, cs)
      && pp.close();
}

const JettonBridgePrices t_JettonBridgePrices;

//
// code for type `JettonBridgeParams`
//

int JettonBridgeParams::get_tag(const vm::CellSlice& cs) const {
  switch (cs.bselect(6, 3)) {
  case 0:
    return cs.bit_at(7) ? jetton_bridge_params_v1 : jetton_bridge_params_v0;
  default:
    return -1;
  }
}

int JettonBridgeParams::check_tag(const vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case jetton_bridge_params_v0:
    return cs.prefetch_ulong(8) == 0 ? jetton_bridge_params_v0 : -1;
  case jetton_bridge_params_v1:
    return cs.prefetch_ulong(8) == 1 ? jetton_bridge_params_v1 : -1;
  }
  return -1;
}

bool JettonBridgeParams::skip(vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case jetton_bridge_params_v0:
  ...
  case jetton_bridge_params_v1:
    return cs.advance(520)
        && t_HashmapE_256_uint256.skip(cs)
        && cs.advance_ext(0x10108);
  }
  return false;
}

bool JettonBridgeParams::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  switch (get_tag(cs)) {
  case jetton_bridge_params_v0:
    return cs.fetch_ulong(8) == 0
        && cs.advance(512)
  ...
  case jetton_bridge_params_v1:
    return cs.fetch_ulong(8) == 1
        ...
        && t_HashmapE_256_uint256.validate_skip(ops, cs, weak)
        && cs.advance(8)
        && t_JettonBridgePrices.validate_skip_ref(ops, cs, weak)
        && cs.advance(256);
  }
  return false;
}

bool JettonBridgeParams::unpack(vm::CellSlice& cs, JettonBridgeParams::Record_jetton_bridge_params_v0& data) const {
  return cs.fetch_ulong(8) == 0
      && cs.fetch_bits_to(data.bridge_address.bits(), 256)
      && cs.fetch_bits_to(data.oracles_address.bits(), 256)
      && t_HashmapE_256_uint256.fetch_to(cs, data.oracles)
      && cs.fetch_uint_to(8, data.state_flags)
      && t_Coins.fetch_to(cs, data.burn_bridge_fee);
}

bool JettonBridgeParams::cell_unpack(Ref<vm::Cell> cell_ref, JettonBridgeParams::Record_jetton_bridge_params_v0& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool JettonBridgeParams::unpack(vm::CellSlice& cs, JettonBridgeParams::Record_jetton_bridge_params_v1& data) const {
  return cs.fetch_ulong(8) == 1
      && cs.fetch_bits_to(data.bridge_address.bits(), 256)
      && cs.fetch_bits_to(data.oracles_address.bits(), 256)
      && t_HashmapE_256_uint256.fetch_to(cs, data.oracles)
      && cs.fetch_uint_to(8, data.state_flags)
      && cs.fetch_ref_to(data.prices)
      && cs.fetch_bits_to(data.external_chain_address.bits(), 256);
}

bool JettonBridgeParams::cell_unpack(Ref<vm::Cell> cell_ref, JettonBridgeParams::Record_jetton_bridge_params_v1& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool JettonBridgeParams::pack(vm::CellBuilder& cb, const JettonBridgeParams::Record_jetton_bridge_params_v0& data) const {
  return cb.store_long_bool(0, 8)
      && cb.store_bits_bool(data.bridge_address.cbits(), 256)
      && cb.store_bits_bool(data.oracles_address.cbits(), 256)
      && t_HashmapE_256_uint256.store_from(cb, data.oracles)
      && cb.store_ulong_rchk_bool(data.state_flags, 8)
      && t_Coins.store_from(cb, data.burn_bridge_fee);
}

bool JettonBridgeParams::cell_pack(Ref<vm::Cell>& cell_ref, const JettonBridgeParams::Record_jetton_bridge_params_v0& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool JettonBridgeParams::pack(vm::CellBuilder& cb, const JettonBridgeParams::Record_jetton_bridge_params_v1& data) const {
  return cb.store_long_bool(1, 8)
      && cb.store_bits_bool(data.bridge_address.cbits(), 256)
      && cb.store_bits_bool(data.oracles_address.cbits(), 256)
      && t_HashmapE_256_uint256.store_from(cb, data.oracles)
      && cb.store_ulong_rchk_bool(data.state_flags, 8)
      && cb.store_ref_bool(data.prices)
      && cb.store_bits_bool(data.external_chain_address.cbits(), 256);
}

bool JettonBridgeParams::cell_pack(Ref<vm::Cell>& cell_ref, const JettonBridgeParams::Record_jetton_bridge_params_v1& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool JettonBridgeParams::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case jetton_bridge_params_v0:
    return cs.fetch_ulong(8) == 0
        && pp.open("jetton_bridge_params_v0")
        && pp.fetch_bits_field(cs, 256, "bridge_address")
        && pp.fetch_bits_field(cs, 256, "oracles_address")
        && pp.field("oracles")
        && t_HashmapE_256_uint256.print_skip(pp, cs)
        && pp.fetch_uint_field(cs, 8, "state_flags")
        && pp.field("burn_bridge_fee")
        && t_Coins.print_skip(pp, cs)
        && pp.close();
  case jetton_bridge_params_v1:
    return cs.fetch_ulong(8) == 1
        && pp.open("jetton_bridge_params_v1")
        && pp.fetch_bits_field(cs, 256, "bridge_address")
        && pp.fetch_bits_field(cs, 256, "oracles_address")
        && pp.field("oracles")
        && t_HashmapE_256_uint256.print_skip(pp, cs)
        && pp.fetch_uint_field(cs, 8, "state_flags")
        && pp.field("prices")
        && t_JettonBridgePrices.print_ref(pp, cs.fetch_ref())
        && pp.fetch_bits_field(cs, 256, "external_chain_address")
        && pp.close();
  }
  return pp.fail("unknown constructor for JettonBridgeParams");
}

const JettonBridgeParams t_JettonBridgeParams;
...
bool ConfigParam::skip(vm::CellSlice& cs) const {
  ...
  case cons4:
    return cs.advance(256)
        && m_ == 4;
  case cons5:
    return t_BurningConfig.skip(cs)
        && m_ == 5;
  case cons6:
    return t_Grams.skip(cs)
        && t_Grams.skip(cs)
  ...
  case cons39:
    return t_HashmapE_256_ValidatorSignedTempKey.skip(cs)
        && m_ == 39;
  case cons40:
    return t_MisbehaviourPunishmentConfig.skip(cs)
        && m_ == 40;
  case cons43:
    return t_SizeLimitsConfig.skip(cs)
        && m_ == 43;
  case cons44:
    return t_SuspendedAddressList.skip(cs)
        && m_ == 44;
  case cons71:
    return t_OracleBridgeParams.skip(cs)
        && m_ == 71;
  case cons72:
    return t_OracleBridgeParams.skip(cs)
        && m_ == 72;
  case cons73:
    return t_OracleBridgeParams.skip(cs)
        && m_ == 73;
  case cons79:
    return t_JettonBridgeParams.skip(cs)
        && m_ == 79;
  case cons81:
    return t_JettonBridgeParams.skip(cs)
        && m_ == 81;
...
bool ConfigParam::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case cons4:
    return cs.advance(256)
        && m_ == 4;
  case cons5:
    return t_BurningConfig.validate_skip(ops, cs, weak)
        && m_ == 5;
  case cons6:
    return t_Grams.validate_skip(ops, cs, weak)
        && t_Grams.validate_skip(ops, cs, weak)
  ...
  case cons39:
    return t_HashmapE_256_ValidatorSignedTempKey.validate_skip(ops, cs, weak)
        && m_ == 39;
  case cons40:
    return t_MisbehaviourPunishmentConfig.validate_skip(ops, cs, weak)
        && m_ == 40;
  case cons43:
    return t_SizeLimitsConfig.validate_skip(ops, cs, weak)
        && m_ == 43;
  case cons44:
    return t_SuspendedAddressList.validate_skip(ops, cs, weak)
        && m_ == 44;
  case cons71:
    return t_OracleBridgeParams.validate_skip(ops, cs, weak)
        && m_ == 71;
  case cons72:
    return t_OracleBridgeParams.validate_skip(ops, cs, weak)
        && m_ == 72;
  case cons73:
    return t_OracleBridgeParams.validate_skip(ops, cs, weak)
        && m_ == 73;
  case cons79:
    return t_JettonBridgeParams.validate_skip(ops, cs, weak)
        && m_ == 79;
  case cons81:
    return t_JettonBridgeParams.validate_skip(ops, cs, weak)
        && m_ == 81;
...
bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons5& data) const {
  return t_BurningConfig.fetch_to(cs, data.x)
      && m_ == 5;
}

bool ConfigParam::unpack_cons5(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_BurningConfig.fetch_to(cs, x)
      && m_ == 5;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons5& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons5(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons5(cs, x) && cs.empty_ext();
}
...
bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons19& data) const {
  return cs.fetch_int_to(32, data.global_id)
      && m_ == 19;
}

bool ConfigParam::unpack_cons19(vm::CellSlice& cs, int& global_id) const {
  return cs.fetch_int_to(32, global_id)
      && m_ == 19;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons19& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons19(Ref<vm::Cell> cell_ref, int& global_id) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons19(cs, global_id) && cs.empty_ext();
}
...
bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons40& data) const {
  return t_MisbehaviourPunishmentConfig.fetch_to(cs, data.x)
      && m_ == 40;
}

bool ConfigParam::unpack_cons40(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_MisbehaviourPunishmentConfig.fetch_to(cs, x)
      && m_ == 40;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons40& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons40(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons40(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons43& data) const {
  return t_SizeLimitsConfig.fetch_to(cs, data.x)
      && m_ == 43;
}

bool ConfigParam::unpack_cons43(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_SizeLimitsConfig.fetch_to(cs, x)
      && m_ == 43;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons43& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons43(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons43(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons44& data) const {
  return t_SuspendedAddressList.fetch_to(cs, data.x)
      && m_ == 44;
}

bool ConfigParam::unpack_cons44(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_SuspendedAddressList.fetch_to(cs, x)
      && m_ == 44;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons44& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons44(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons44(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons71& data) const {
  return t_OracleBridgeParams.fetch_to(cs, data.x)
      && m_ == 71;
}

bool ConfigParam::unpack_cons71(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_OracleBridgeParams.fetch_to(cs, x)
      && m_ == 71;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons71& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons71(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons71(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons72& data) const {
  return t_OracleBridgeParams.fetch_to(cs, data.x)
      && m_ == 72;
}

bool ConfigParam::unpack_cons72(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_OracleBridgeParams.fetch_to(cs, x)
      && m_ == 72;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons72& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons72(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons72(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons73& data) const {
  return t_OracleBridgeParams.fetch_to(cs, data.x)
      && m_ == 73;
}

bool ConfigParam::unpack_cons73(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_OracleBridgeParams.fetch_to(cs, x)
      && m_ == 73;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons73& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons73(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons73(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons79& data) const {
  return t_JettonBridgeParams.fetch_to(cs, data.x)
      && m_ == 79;
}

bool ConfigParam::unpack_cons79(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_JettonBridgeParams.fetch_to(cs, x)
      && m_ == 79;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons79& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons79(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons79(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons81& data) const {
  return t_JettonBridgeParams.fetch_to(cs, data.x)
      && m_ == 81;
}

bool ConfigParam::unpack_cons81(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_JettonBridgeParams.fetch_to(cs, x)
      && m_ == 81;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons81& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons81(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons81(cs, x) && cs.empty_ext();
}

bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons82& data) const {
  return t_JettonBridgeParams.fetch_to(cs, data.x)
      && m_ == 82;
}

bool ConfigParam::unpack_cons82(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_JettonBridgeParams.fetch_to(cs, x)
      && m_ == 82;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons82& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons82(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons82(cs, x) && cs.empty_ext();
}
...
bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons5& data) const {
  return t_BurningConfig.store_from(cb, data.x)
      && m_ == 5;
}

bool ConfigParam::pack_cons5(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_BurningConfig.store_from(cb, x)
      && m_ == 5;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons5& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons5(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons5(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}
...
bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons19& data) const {
  return cb.store_long_rchk_bool(data.global_id, 32)
      && m_ == 19;
}

bool ConfigParam::pack_cons19(vm::CellBuilder& cb, int global_id) const {
  return cb.store_long_rchk_bool(global_id, 32)
      && m_ == 19;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons19& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons19(Ref<vm::Cell>& cell_ref, int global_id) const {
  vm::CellBuilder cb;
  return pack_cons19(cb, global_id) && std::move(cb).finalize_to(cell_ref);
}
...
bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons40& data) const {
  return t_MisbehaviourPunishmentConfig.store_from(cb, data.x)
      && m_ == 40;
}

bool ConfigParam::pack_cons40(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_MisbehaviourPunishmentConfig.store_from(cb, x)
      && m_ == 40;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons40& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons40(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons40(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons43& data) const {
  return t_SizeLimitsConfig.store_from(cb, data.x)
      && m_ == 43;
}

bool ConfigParam::pack_cons43(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_SizeLimitsConfig.store_from(cb, x)
      && m_ == 43;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons43& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons43(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons43(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons44& data) const {
  return t_SuspendedAddressList.store_from(cb, data.x)
      && m_ == 44;
}

bool ConfigParam::pack_cons44(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_SuspendedAddressList.store_from(cb, x)
      && m_ == 44;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons44& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons44(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons44(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons71& data) const {
  return t_OracleBridgeParams.store_from(cb, data.x)
      && m_ == 71;
}

bool ConfigParam::pack_cons71(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_OracleBridgeParams.store_from(cb, x)
      && m_ == 71;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons71& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons71(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons71(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons72& data) const {
  return t_OracleBridgeParams.store_from(cb, data.x)
      && m_ == 72;
}

bool ConfigParam::pack_cons72(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_OracleBridgeParams.store_from(cb, x)
      && m_ == 72;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons72& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons72(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons72(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons73& data) const {
  return t_OracleBridgeParams.store_from(cb, data.x)
      && m_ == 73;
}

bool ConfigParam::pack_cons73(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_OracleBridgeParams.store_from(cb, x)
      && m_ == 73;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons73& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons73(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons73(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons79& data) const {
  return t_JettonBridgeParams.store_from(cb, data.x)
      && m_ == 79;
}

bool ConfigParam::pack_cons79(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_JettonBridgeParams.store_from(cb, x)
      && m_ == 79;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons79& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons79(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons79(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons81& data) const {
  return t_JettonBridgeParams.store_from(cb, data.x)
      && m_ == 81;
}

bool ConfigParam::pack_cons81(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_JettonBridgeParams.store_from(cb, x)
      && m_ == 81;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons81& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons81(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons81(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons82& data) const {
  return t_JettonBridgeParams.store_from(cb, data.x)
      && m_ == 82;
}

bool ConfigParam::pack_cons82(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_JettonBridgeParams.store_from(cb, x)
      && m_ == 82;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons82& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons82(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons82(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}
...
bool ConfigParam::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case cons5:
    return pp.open()
        && pp.field()
        && t_BurningConfig.print_skip(pp, cs)
        && m_ == 5
        && pp.close();
  case cons6:
    return pp.open()
  ...
  case cons40:
    return pp.open()
        && pp.field()
        && t_MisbehaviourPunishmentConfig.print_skip(pp, cs)
        && m_ == 40
        && pp.close();
  case cons43:
    return pp.open()
        && pp.field()
        && t_SizeLimitsConfig.print_skip(pp, cs)
        && m_ == 43
        && pp.close();
  case cons44:
    return pp.open()
        && pp.field()
        && t_SuspendedAddressList.print_skip(pp, cs)
        && m_ == 44
        && pp.close();
  case cons71:
    return pp.open()
        && pp.field()
        && t_OracleBridgeParams.print_skip(pp, cs)
        && m_ == 71
        && pp.close();
  case cons72:
    return pp.open()
  ...
  case cons79:
    return pp.open()
        && pp.field()
        && t_JettonBridgeParams.print_skip(pp, cs)
        && m_ == 79
        && pp.close();
  case cons81:
    return pp.open()
...
bool ValidatorComplaint::unpack(vm::CellSlice& cs, ValidatorComplaint::Record& data) const {
  return cs.fetch_ulong(8) == 0xbc
      && cs.fetch_bits_to(data.validator_pubkey.bits(), 256)
      && cs.fetch_ref_to(data.description)
      && cs.fetch_uint_to(32, data.created_at)
...
bool ValidatorComplaint::pack(vm::CellBuilder& cb, const ValidatorComplaint::Record& data) const {
  return cb.store_long_bool(0xbc, 8)
      && cb.store_bits_bool(data.validator_pubkey.cbits(), 256)
      && cb.store_ref_bool(data.description)
      && cb.store_ulong_rchk_bool(data.created_at, 32)
...
bool ValidatorComplaint::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(8) == 0xbc
      ...
      && pp.fetch_bits_field(cs, 256, "validator_pubkey")
      && pp.field("description")
...
//
constexpr unsigned short DNSRecord::cons_tag[5];
...
bool ChanConfig::skip(vm::CellSlice& cs) const {
...
bool ChanConfig::unpack(vm::CellSlice& cs, ChanConfig::Record& data) const {
  return cs.fetch_uint_to(32, data.init_timeout)
      ...
      && t_Grams.fetch_to(cs, data.min_A_extra);
}
...
bool ChanConfig::pack(vm::CellBuilder& cb, const ChanConfig::Record& data) const {
  return cb.store_ulong_rchk_bool(data.init_timeout, 32)
      ...
      && t_Grams.store_from(cb, data.min_A_extra);
}
...
//
constexpr unsigned ChanMsg::cons_tag[4];
...
int ChanMsg::check_tag(const vm::CellSlice& cs) const {
  ...
  case chan_msg_payout:
    return cs.prefetch_ulong(32) == 0x37fe7810 ? chan_msg_payout : -1;
  }
  return -1;
}
...
bool ChanMsg::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case chan_msg_payout:
    return cs.fetch_ulong(32) == 0x37fe7810;
  }
  return false;
}
...
bool ChanMsg::unpack(vm::CellSlice& cs, ChanMsg::Record_chan_msg_payout& data) const {
  return cs.fetch_ulong(32) == 0x37fe7810;
}

bool ChanMsg::unpack_chan_msg_payout(vm::CellSlice& cs) const {
  return cs.fetch_ulong(32) == 0x37fe7810;
}

bool ChanMsg::cell_unpack(Ref<vm::Cell> cell_ref, ChanMsg::Record_chan_msg_payout& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ChanMsg::cell_unpack_chan_msg_payout(Ref<vm::Cell> cell_ref) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_chan_msg_payout(cs) && cs.empty_ext();
}
...
bool ChanMsg::pack(vm::CellBuilder& cb, const ChanMsg::Record_chan_msg_payout& data) const {
  return cb.store_long_bool(0x37fe7810, 32);
}

bool ChanMsg::pack_chan_msg_payout(vm::CellBuilder& cb) const {
  return cb.store_long_bool(0x37fe7810, 32);
}

bool ChanMsg::cell_pack(Ref<vm::Cell>& cell_ref, const ChanMsg::Record_chan_msg_payout& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ChanMsg::cell_pack_chan_msg_payout(Ref<vm::Cell>& cell_ref) const {
  vm::CellBuilder cb;
  return pack_chan_msg_payout(cb) && std::move(cb).finalize_to(cell_ref);
}
...
//
// code for type `ChanOp`
//
constexpr unsigned ChanOp::cons_tag[1];

int ChanOp::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(32) == 0x912838d1U ? chan_op_cmd : -1;
}

bool ChanOp::skip(vm::CellSlice& cs) const {
  return cs.advance(32)
      && t_ChanSignedMsg.skip(cs);
}

bool ChanOp::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(32) == 0x912838d1U
      && t_ChanSignedMsg.validate_skip(ops, cs, weak);
}

bool ChanOp::unpack(vm::CellSlice& cs, ChanOp::Record& data) const {
  return cs.fetch_ulong(32) == 0x912838d1U
      && t_ChanSignedMsg.fetch_to(cs, data.msg);
}

bool ChanOp::unpack_chan_op_cmd(vm::CellSlice& cs, Ref<CellSlice>& msg) const {
  return cs.fetch_ulong(32) == 0x912838d1U
      && t_ChanSignedMsg.fetch_to(cs, msg);
}

bool ChanOp::cell_unpack(Ref<vm::Cell> cell_ref, ChanOp::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ChanOp::cell_unpack_chan_op_cmd(Ref<vm::Cell> cell_ref, Ref<CellSlice>& msg) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_chan_op_cmd(cs, msg) && cs.empty_ext();
}

bool ChanOp::pack(vm::CellBuilder& cb, const ChanOp::Record& data) const {
  return cb.store_long_bool(0x912838d1U, 32)
      && t_ChanSignedMsg.store_from(cb, data.msg);
}

bool ChanOp::pack_chan_op_cmd(vm::CellBuilder& cb, Ref<CellSlice> msg) const {
  return cb.store_long_bool(0x912838d1U, 32)
      && t_ChanSignedMsg.store_from(cb, msg);
}

bool ChanOp::cell_pack(Ref<vm::Cell>& cell_ref, const ChanOp::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ChanOp::cell_pack_chan_op_cmd(Ref<vm::Cell>& cell_ref, Ref<CellSlice> msg) const {
  vm::CellBuilder cb;
  return pack_chan_op_cmd(cb, std::move(msg)) && std::move(cb).finalize_to(cell_ref);
}

bool ChanOp::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(32) == 0x912838d1U
      && pp.open("chan_op_cmd")
      && pp.field("msg")
      && t_ChanSignedMsg.print_skip(pp, cs)
      && pp.close();
}

const ChanOp t_ChanOp;
...
const RefT t_Ref_TYPE_1616{t_Transaction_aux};
...
const RefT t_Ref_TYPE_1628{t_TrComputePhase_aux};
...
const Maybe t_Maybe_Cell{t_Anything};
...
const RefT t_Ref_TYPE_1642{t_ShardStateUnsplit_aux};
...
const RefT t_Ref_TYPE_1653{t_TYPE_1653};
const RefT t_Ref_TYPE_1654{t_TYPE_1654};
const NatWidth t_natwidth_3{3};
const RefT t_Ref_TYPE_1658{t_ShardDescr_aux};
...
const RefT t_Ref_TYPE_1672{t_McStateExtra_aux};
...
const RefT t_Ref_TYPE_1680{t_McBlockExtra_aux};
...
const Maybe t_Maybe_bits256{t_bits256};
...
const HashmapE t_HashmapE_288_Unit{288, t_Unit};
const HashmapE t_HashmapE_256_uint256{256, t_uint256};
const RefT t_Ref_JettonBridgePrices{t_JettonBridgePrices};
...
const RefT t_Ref_TYPE_1727{t_VmGasLimits_aux};
...
bool register_simple_types(std::function<bool(const char*, const TLB*)> func) {
  return func("Unit", &t_Unit)
      ...
      && func("StateInitWithLibs", &t_StateInitWithLibs)
      ...
      && func("BurningConfig", &t_BurningConfig)
      ...
      && func("WcSplitMergeTimings", &t_WcSplitMergeTimings)
      ...
      && func("MisbehaviourPunishmentConfig", &t_MisbehaviourPunishmentConfig)
      && func("SizeLimitsConfig", &t_SizeLimitsConfig)
      && func("SuspendedAddressList", &t_SuspendedAddressList)
      && func("OracleBridgeParams", &t_OracleBridgeParams)
      && func("JettonBridgePrices", &t_JettonBridgePrices)
      && func("JettonBridgeParams", &t_JettonBridgeParams)
